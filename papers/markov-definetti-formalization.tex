...
surface if it admits an extension $P$ to infinite sequences satisfying
...
The corresponding theorem surface is:
...
Surface and extension helpers & 8 files & 4,461 \\
\midrule
...
specialized constructors expose internal theorem surfaces for callers that
