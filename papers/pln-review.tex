...
For the completed strength/confidence characterization itself, the current
public endpoint is \codepath{Mettapedia/PLN/Core/PLNCanonicalAPI.lean} under
\code{confidenceCharacterizationEndpointProfile}; the companion paper is
\codepath{papers/pln-credal-degrees-of-freedom.tex}.  This review points to
that endpoint rather than re-deriving it here.
...
\item One-call WM rewrite $\to$ OSLF truth transport $\to$ threshold
  acceptance --- \codepath{Mettapedia/PLN/Core/PLNCanonicalAPI.lean}
...
\item Finite-model quantifier semantics with weakness connection ---
  \codepath{Mettapedia/PLN/RuleFamilies/FirstOrder/Quantifiers/QuantifierSemantics.lean}
...
\begin{itemize}
\item \codepath{Mettapedia/PLN/Core/PLNCore.lean} --- umbrella module
\item \codepath{Mettapedia/PLN/Core/PLNCanonicalAPI.lean} --- canonical API (3806 lines)
