...
\end{tabular}
\end{scriptsize}
\caption{xiPLN rule set used for selector composition.
...
\lpath{Mettapedia/PLN/InferenceControl/PremiseSelection/Fusion.lean}, normalized selector stages \\
...
\lid{stagedFamilyPosterior_regrade_roundtrip_commute}
(\lpath{Mettapedia/PLN/InferenceControl/PremiseSelection/ExternalBayesianity.lean}).
...
Abbreviation: \texttt{EB} = \lpath{ExternalBayesianity.lean}.
...
\paragraph{Normalization and fusion (in \lpath{Fusion.lean}).}
...
(\lpath{LocalMixtureBridge.lean});
\lid{fusion_ranking_after_normalization_toReal}
(\lpath{Optimality.lean});
...
\lpath{Mettapedia/PLN/InferenceControl/PremiseSelection/BestPLNDraft.lean}.
...
\lpath{M/PLN/Core/PLNCore.lean}
  & Curated top-level import path for the theorem-complete PLN stack \\
\lpath{M/PLN/InferenceControl/PremiseSelection/KNN.lean}
  & General k-NN definitions; MaSh instance \\
\lpath{M/PLN/InferenceControl/PremiseSelection/KNN_PLNBridge.lean}
  & PLN--k-NN bridge; paper-form equivalence \\
\lpath{M/L/PLNBayesNetInference.lean}
  & PLN NB bridge; strength = NB posterior \\
\lpath{M/PLN/InferenceControl/PremiseSelection/Fusion.lean}
  & Fusion via revision; normalization \\
\lpath{M/PLN/InferenceControl/PremiseSelection/Optimality.lean}
  & Optimality transfer lemmas (NB, k-NN, PLN, fusion, ranking) \\
\lpath{M/PLN/InferenceControl/PremiseSelection/ExternalBayesianity.lean}
  & Counterexample + corrected uniqueness; regraduation invariance;
    staged commutation canaries \\
\lpath{M/PLN/InferenceControl/PremiseSelection/OperatorRoles.lean}
  & Role discipline structures \\
\lpath{M/PLN/InferenceControl/PremiseSelection/PriorNB.lean}
  & Prior-NB composition; canonical aliases \\
\lpath{M/PLN/InferenceControl/PremiseSelection/LocalMixtureBridge.lean}
  & Finite local-mixture TV bounds \\
\lpath{M/L/DiaconisFreedmanFinite.lean}
  & Base collision bound \\
\lpath{M/PLN/InferenceControl/PremiseSelection/Coverage.lean}
  & Submodular coverage \\
\lpath{M/PLN/InferenceControl/PremiseSelection/PUCalibration.lean}
  & PU weak-negative calibration \\
\lpath{M/PLN/InferenceControl/PremiseSelection/RankingStability.lean}
  & Ranking stability \\
\lpath{M/PLN/InferenceControl/PremiseSelection/SelectorSpec.lean}
  & Selector spec defaults/checklist \\
\lpath{M/PLN/InferenceControl/PremiseSelection/PartitionedPriorNB.lean}
