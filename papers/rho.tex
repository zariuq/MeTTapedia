...
written \code{ReferenceCostLayers} --- which is the intended domain of the
strict reference cost-layer construction. \formalized
...
\section{Cost layers: the object-closure programme}
...
programme
(\leanfile{GSLT/LanguageDef/Cost/Construction.lean}{Cost/Construction.lean})
...
Proof-relevant elaboration; typed normalization soundness &
  \S\ref{sec:typednorm} & formalized \\
Exact canonical laws; \code{ReferenceCostLayers} subcategory &
  \S\ref{sec:typednorm} & formalized \\
Layer construction: one Cost application as a continued object &
  \S\ref{sec:endofunctor} & formalized \\
Layer iteration: closure of the exact laws themselves &
