...
\begin{enumerate}
\item \textbf{NormClause}: canonicalizes linearization variation.
...
inductive RGLView where
  ...
  | copularForm (origin : CopulaOrigin) (lhs rhs : RGLView)
\end{lstlisting}
...
\item[\code{project\_core}.] A larger bilingual abstract grammar exported
  ...
  Lean as a kernel-reducible constructor interface.
...
\item exact structural export into the Rust \code{language!} notation for both
...
(25~modules), RGLView/NormClause canonicalize linearization variation, the
