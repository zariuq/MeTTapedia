...
four previously reported ``alien'' programs: the Hofstadter--Conway sequence and its
centered transform, the Kolakoski sequence, and a cyclotomic-polynomial sequence.
\end{abstract}
...
and the
\href{https://github.com/zariuq/MeTTapedia/blob/main/lean/mettapedia/Mettapedia/GSLT/LanguageDef/Gauthier/ReportedSequencePrograms.lean}{reported-program correctness module},
as well as the
...
or a moving branch location. Links into the newly added reported-program module follow
\code{main} until its first tagged formal release.
...
\end{lstlisting}
\noindent Full machine-checked statement and proof:
\href{https://github.com/zariuq/MeTTapedia/blob/main/lean/mettapedia/Mettapedia/GSLT/LanguageDef/Gauthier/ReportedSequencePrograms.lean\#L371-L386}{\nolinkurl{reportedA004001_correct}}.
...
\end{lstlisting}
\noindent Full machine-checked statement and proof:
\href{https://github.com/zariuq/MeTTapedia/blob/main/lean/mettapedia/Mettapedia/GSLT/LanguageDef/Gauthier/ReportedSequencePrograms.lean\#L388-L415}{\nolinkurl{reportedA004074_correct}}.
...
\end{lstlisting}
\noindent Full machine-checked statement and proof:
\href{https://github.com/zariuq/MeTTapedia/blob/main/lean/mettapedia/Mettapedia/GSLT/LanguageDef/Gauthier/ReportedSequencePrograms.lean\#L639-L675}{\nolinkurl{reportedA000002_correct}}.
...
\end{lstlisting}
\noindent Full machine-checked statement and proof:
\href{https://github.com/zariuq/MeTTapedia/blob/main/lean/mettapedia/Mettapedia/GSLT/LanguageDef/Gauthier/ReportedSequencePrograms.lean\#L938-L974}{\nolinkurl{reportedA070526_correct}}.
