...
\codepath{Mettapedia/PLN/Bridges/ProbabilityTheory/EvidenceDirichletQuantale.lean}
...
\footnote{Formalized in
\codepath{Mettapedia/PLN/WorldModel/Semitopology/PLNSemitopology.lean}
(241~lines, 23~theorems) and
\codepath{Mettapedia/PLN/WorldModel/Semitopology/PLNSemitopologyProvenanceBridge.lean}
...
\footnote{Formalized in
\codepath{Mettapedia/PLN/WorldModel/WMCalculusSoundness.lean}
(5~theorems, 0~sorry).}
\end{theorem}
...
choice of separate predictive models over retrofitting additive carriers.
...
The controlled HMM theorem set provides exact filtering and smoothing
...
\footnote{Formalized in
\codepath{Mettapedia/ProbabilityTheory/HiddenMarkovModels/ControlledFiniteHiddenMarkovObservedInference.lean}.}
...
theorem set with a \emph{credal} one: lower and upper latent-state
...
semicomputable.%
\footnote{Formalized in
\codepath{Mettapedia/UniversalAI/UniversalPrediction/FiniteAlphabet/ControlledPrefixMeasure.lean},
\codepath{Mettapedia/UniversalAI/UniversalPrediction/FiniteAlphabet/ControlledSolomonoffBridge.lean},
and
\codepath{Mettapedia/UniversalAI/ControlledFiniteHiddenMarkovUniversalPredictionBridge.lean}.}
...
(\codepath{Mettapedia/PLN/Bridges/ProbabilityTheory/EvidenceNormalGammaLattice.lean},
...
and \codepath{Mettapedia/PLN/Bridges/ProbabilityTheory/EvidenceBeta.lean}.}
...
$\alpha_n = \alpha_0 + n/2$.%
\footnote{Formalized in \codepath{Mettapedia/PLN/Bridges/ProbabilityTheory/EvidenceNormalGamma.lean}.}
...
\codepath{Mettapedia/Examples/PLN/MapleCourtDemo.lean}; and
...
Dirichlet evidence: \codepath{Mettapedia/PLN/Bridges/ProbabilityTheory/EvidenceDirichletQuantale.lean}
...
\footnote{Formalized in
\codepath{Mettapedia/PLN/RuleFamilies/QuantaleSemantics/PLNQuantaleDivergence.lean}
(3~theorems, 0~sorry).}
...
richer operations (here, targeted forgetting), and the theorem set
...
labels.%
\footnote{Formalized in
\codepath{Mettapedia/PLN/WorldModel/Provenance/PLNProvenanceTrackedState.lean}
.}%
...
\footnote{Formalized in
\codepath{Mettapedia/PLN/WorldModel/Provenance/PLNProvenanceInference.lean} (general
theory) and
...
\codepath{Mettapedia/Examples/PLN/WMDerivationTrackingDemo.lean}.}
...
\footnote{Formalized in
\codepath{Mettapedia/PLN/Evidence/SourceReliability.lean}
(14~items, 0~sorry).}
...
formalization, a complex phase factor is identified with $\exp(i\theta)$, a
...
\codepath{Mettapedia/PLN/WorldModel/UniversalEnsembleWM.lean}
(7~items, 0~sorry).}
\end{theorem}
...
axiom-free, in \codepath{Mettapedia/PLN/RuleFamilies/FirstOrder/RavenAsymmetricInduction.lean}.
...
\codepath{Mettapedia/PLN/RuleFamilies/FirstOrder/RavenAbduction.lean}.  With the unnormalized
...
in \codepath{Mettapedia/PLN/InferenceControl/ProtocolDynamics/PLNTrailFreeDynamicsCounterexample.lean}
...
in \codepath{Mettapedia/PLN/InferenceControl/ProtocolDynamics/PLNTrailFreeDampedConvergence.lean}
}
\end{theorem}
...
in \codepath{Mettapedia/PLN/WorldModel/OrderCost/PLNWorldModelOrderCostBounds.lean}
}
\end{theorem}
...
in \codepath{Mettapedia/PLN/WorldModel/OrderCost/PLNWorldModelOrderCostAuditCertificate.lean}
}
\end{theorem}
...
\footnote{Formalized in
\codepath{Mettapedia/PLN/WorldModel/OrderCost/PLNWorldModelOrderCostWeightedDemo.lean} and
\codepath{Mettapedia/PLN/WorldModel/OrderCost/PLNWorldModelOrderCostGasPolicyDemo.lean}.}
...
\footnote{Formalized in
\codepath{Mettapedia/PLN/WorldModel/OrderCost/PLNWorldModelOrderCostProvenanceDemo.lean}
(5~theorems, 0~sorry).}
...
evidence algebra.%
\footnote{Formalized in
\codepath{Mettapedia/Examples/PLN/WMDemandDemo.lean}
...
\footnote{Formalized in
\codepath{Mettapedia/Examples/PLN/WMForkDemandDemo.lean}
(23~theorems, 0~sorry).}
...
in \codepath{Mettapedia/PLN/Core/PLNCanonicalAPI.lean}}
\end{theorem}
...
\footnote{Formalized in
\codepath{Mettapedia/PLN/InferenceControl/PremiseSelection/KNN.lean} and
...
is needed.  The corrected model is a typed three-channel mixed
...
\]%
\footnote{Formalized in
\codepath{Mettapedia/PLN/RuleFamilies/Temporal/PLNTemporalCausalInference.lean} and
...
\footnote{Formalized in
\codepath{Mettapedia/Examples/PLN/WMUWCSEGateDemo.lean}
...
\footnote{Formalized in
\codepath{Mettapedia/UniversalAI/UniversalPredictionApproximation.lean} and
\codepath{Mettapedia/UniversalAI/UniversalPredictionApproximationWMBridge.lean}
(0~sorry).}
\begin{enumerate}
...
\footnote{Formalized in
\codepath{Mettapedia/UniversalAI/UniversalPredictionConditionalWMBridge.lean}
(0~sorry).}
...
\footnote{Formalized in
\codepath{Mettapedia/UniversalAI/UniversalPredictionConditionalApproximation.lean}
...
public WM-grounding API now covers three lanes, not just one: Gewirth PGC,
...
theorem is \code{source\_equivalence\_of\_structured}; and the
...
kernel-checked theorems, and the structured/AD translation is included
...
\footnote{Formalized in
\codepath{Mettapedia/PLN/Comparisons/NARS/NARSInductionWeakness.lean}
and
...
\begin{flushleft}
\footnotesize
\codepath{Mettapedia/Examples/PLN/TemporalChainingExample.lean}\\
...
controlled-HMM export API reuses it.  What remains open is the
...
context.%
\footnote{Formalized in
\codepath{Mettapedia/Examples/PLN/GJPForecastDemo.lean}
...
\codepath{Mettapedia/Examples/PLN/BioHypothesisGeneration.lean}
(635~lines, 0~sorry).}
...
$I$ is the incident/harm component, $U$ is the benefit-side
capability component, and $F$ is the forecast-target/reliability
...
\codepath{Mettapedia/Examples/PLN/AIOutcomesDemo.lean}
...
\code{PLN/Bridges/ProbabilityTheory/EvidenceNormalGammaLattice} & $\sim$150 & 10 & Ch~4 \\
\code{Examples/PLN/MapleCourtDemo} & 906 & 47 & Ch~2--6 \\
\code{Examples/PLN/WMDerivationTrackingDemo} & 453 & 31 & Ch~5 \\
...
\code{Examples/PLN/WMGasSensorDriftDemo} & 652 & 58 & Ch~20 \\
\code{Examples/PLN/WMSteelFaultDemo} & 568 & 46 & Ch~20 \\
\code{Examples/PLN/WMNABSleepDemo} & 344 & 30 & Ch~20 \\
\code{Examples/PLN/GJPForecastDemo} & 255 & 14 & Ch~20 \\
\compactcodepath{PLN/WorldModel/OrderCost}{PLNWorldModelOrderCostGasPolicyDemo} & 155 & 6 & Ch~20 \\
\code{Examples/PLN/BioHypothesisGeneration} & 635 & 36 & Ch~22 \\
\code{Logic/PLNGWASHigherOrderBridge} & 310 & 17 & Ch~22 \\
\code{Examples/PLN/WMDemandDemo} & 258 & 27 & Ch~12 \\
\code{Examples/PLN/WMForkDemandDemo} & $\sim$300 & 23 & Ch~12 \\
\code{Examples/PLN/WMUWCSEGateDemo} & 177 & 12 & Ch~16 \\
\code{PLN/Bridges/ProbabilityTheory/EvidenceDirichletQuantale} & $\sim$200 & 13 & Ch~2, 4 \\
\code{Logic/PLNProbGuardedAdmissibilityDemo} & $\sim$200 & 13 & Ch~21 \\
\compactcodepath{PLN/WorldModel/OrderCost}{PLNWorldModelOrderCostProvenanceDemo} & 255 & 5 & Ch~12 \\
\code{Logic/PLNQuantaleDivergence} & 121 & 3 & Ch~4 \\
\code{Logic/BooleanHeytingBridge} & $\sim$100 & 4 & Ch~4 \\
\code{Examples/PLN/AIOutcomesDemo} & 280 & 13 & Ch~24 \\
\midrule
...
\code{Mettapedia/lean/mettapedia/}, built with Lean~4.28.0 and
