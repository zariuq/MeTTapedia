...
new unnamespaced standard-library surface.
...
\item \textbf{Zero NIK closure:} generate the native checker from the one
  ...
  or on-demand surface, absent from the ordinary runtime hot path.
...
registration surface remain deferred; individual machines already carry
...
\item[Choice and continuation ownership.]
  ...
  projection.  Its host callback surface supplies language services but does
