...
The exact (precise) concept-formation API in our framework is given by the
\lid{ObservationEncoder} machinery and its
...
\lid{BinaryFcaBenchmarkContext} from \lpath{BenchmarkControl.lean}.
...
two supporting tokens. This is the controlled benchmark fixture against which the
...
\lid{BinaryFcaBenchmarkContext} on the extracted \lid{conlat\_1} context.
