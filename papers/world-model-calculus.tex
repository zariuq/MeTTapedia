...
\code{PLN/WorldModel/BayesNet/PLNBayesNetWorldModel.lean} & BN sublayer: CPT evidence,
  marginalization \\
\code{PLN/Bridges/ProbabilityTheory/BayesNet/PLNBNCompilation.lean} & Screening-off rewrites for BN \\
...
\code{Mettapedia/PLN/Bridges/CategoryTheory/WorldModel/PLNWorldModelHyperdoctrine.lean} & Hyperdoctrine-style typed
  query fibers, change-of-base, Beck-Chevalley transport \\
\code{Mettapedia/PLN/Bridges/CategoryTheory/WorldModel/PLNWorldModelCategoricalBridge.lean} & Unified endpoint
...
\code{Logic/PLNWorldModelITVHypercube.lean} & Interval-selector layer,
  typed ITV transport \\
\code{PLN/Core/PLNCanonicalAPI.lean} & One-call end-to-end endpoints \\
\code{PLN/RuleFamilies/FirstOrder/Quantifiers/QuantifierSemantics.lean} & Extensional vs
  typicality quantifiers \\
\code{PLN/RuleFamilies/FirstOrder/Quantifiers/QuantifierAlgorithmTheorems.lean} &
  Ch.~11 algorithmic quantifier monotonicity, crisp endpoints, rule-4
  discrepancy bounds (361 lines) \\
\code{PLN/RuleFamilies/FirstOrder/Quantifiers/ThirdOrderQuantifierSemantics.lean} &
...
\code{OSLF/Framework/QuantaleCoherence.lean} & Quantale
  transport/coherence \\
\code{Mettapedia/PLN/Bridges/Logic/WorldModel/PLNWorldModelKripke.lean} & Kripke WM instance,
  singleton adequacy \\
\code{Mettapedia/PLN/Bridges/Logic/WorldModel/PLNWorldModelKripkeConsequence.lean} & Deontic Kripke
  consequence rules \\
\code{Mettapedia/PLN/Bridges/Logic/WorldModel/PLNWorldModelKripkeCompleteness.lean} & Kripke
  sound/complete proof-theoretic bridge \\
\code{Mettapedia/PLN/Bridges/Logic/WorldModel/PLNWorldModelNeighborhood.lean} & Neighborhood WM instance,
  singleton adequacy \\
\code{Mettapedia/PLN/Bridges/Logic/WorldModel/PLNWorldModelNeighborhoodCompleteness.lean} &
  Sound/complete proof-theoretic bridge \\
\code{Mettapedia/PLN/Bridges/Logic/WorldModel/PLNWorldModelNeighborhoodConsequence.lean} & Governance
  translation, modal families \\
\code{Mettapedia/PLN/Bridges/Logic/WorldModel/PLNWorldModelKripkeNeighborhoodEmbedding.lean} &
  Generic Kripke-to-neighborhood embedding \\
\code{Mettapedia/PLN/Bridges/Logic/WorldModel/PLNWorldModelKripkeNeighborhoodCanonical.lean} &
  Canonical representation bridge \\
\code{Mettapedia/PLN/Bridges/Logic/WorldModel/PLNWorldModelKripkeWeighted.lean} &
...
\code{Mettapedia/PLN/Bridges/Logic/WorldModel/PLNWorldModelFOLCompleteness.lean} &
  FOL consequence transfer +
  provable $\Leftrightarrow$ singleton consequence on $T$-models \\
\code{Mettapedia/PLN/Bridges/Logic/WorldModel/PLNWorldModelSetTheoryBridge.lean} &
  Set-theory specialization (\code{Z/ZF/ZC/ZFC}) of the FOL
  implication bridge + categorical wrappers \\
\code{Mettapedia/PLN/Bridges/Logic/WorldModel/PLNWorldModelSetTheoryBridgeRegression.lean} &
...
\code{PLN/WorldModel/Experiment/PLNWorldModelExperiment.lean} &
  Deterministic experiment/channel WM interface + Blackwell consequence wrapper \\
\code{PLN/WorldModel/Experiment/PLNWorldModelExperimentRegression.lean} &
  Finite deterministic experiment fixture regression \\
\code{PLN/WorldModel/Experiment/PLNWorldModelExperimentStochastic.lean} &
  Stochastic-channel Blackwell utility layer + weighted/trusted-source transfer \\
\code{PLN/WorldModel/Experiment/PLNWorldModelExperimentStochasticRegression.lean} &
  Finite stochastic Blackwell/weighted-policy fixture regression \\
\code{PLN/WorldModel/Fixpoint/PLNWorldModelFixpointClosure.lean} &
  Monotone WM consequence operator, least-fixpoint closure, and
  threshold-soundness transport \\
\code{PLN/WorldModel/Fixpoint/PLNWorldModelFixpointClosureRegression.lean} &
...
\code{Mettapedia/PLN/Bridges/Logic/WorldModel/PLNWorldModelFOLInfinitary.lean} &
  Countable $\bigwedge$/$\bigvee$ FOL WM instance, singleton adequacy,
  pointwise-implication strength transfer (297 lines) \\
\code{Mettapedia/PLN/Bridges/Logic/WorldModel/PLNWorldModelFOLInfinitaryCompleteness.lean} &
  Implication consequence-transfer wrappers: \code{WMConsequenceRule} from
  pointwise/singleton-strength (93 lines) \\
\code{Mettapedia/PLN/Bridges/Logic/WorldModel/PLNWorldModelInfinitaryRegression.lean} &
...
\item \textbf{Aligned consequence-transfer wrappers}:
  categorical-contract variants are exposed for the PureKernel$\rightarrow$WM
...
\item \textbf{Set-theory specialization}: the FOL bridge is now instantiated for
  ...
  multiset consequence transport, and categorical-contract wrappers.
...
\item \textbf{GF$\rightarrow$WM obligation adapters}:
  ...
  \code{PureJudgmentWMInterface} used by Pure-kernel bridge wrappers,
  via
