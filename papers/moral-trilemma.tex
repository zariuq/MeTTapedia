...
{\small A computable extensional judgment of program behavior must be
constant. A nontrivial extensional moral judgment therefore cannot be
computably audited for every program. Likewise, deciding whether an
arbitrary computation will respond encounters the halting obstruction.}%
};
\end{tikzpicture}
\end{center}
