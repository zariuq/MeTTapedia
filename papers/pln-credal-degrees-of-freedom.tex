...
\lid{CredalProjectionTower} in \lpath{Mettapedia/Logic/PLNTruthTower.lean};
...
\lpath{Mettapedia/Logic/PLNDistinctionCredalBridge.lean}; and the OSLF specialization
\lid{indistObs\_indicatorGamble\_has\_strict\_width} /
\lid{indistObs\_indicatorGamble\_collapses\_of\_class\_subsingleton} in
\lpath{Mettapedia/Logic/PLNDistinctionCredalOSLFBridge.lean}.} Two spreads can agree on one
