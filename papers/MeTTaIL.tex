...
Metamath statement surface---\code{Database}, \code{Stmt}, \code{MathString},
...
\code{language!} surface syntax with kernel-checked guards on the exported
text.  (A Rust \code{metamath.rs} twin existed historically; the render
surface is now checked directly, with no in-tree Rust consumer.)
