...
structure RhoCrossColorCollapsingLeafExposuresCanary
...
def RhoCollapsingCrossColorViewsLeafExposuresInDomainCanary
    ...
    canonicalize
      ...
      canonicalize
        (costStaticReflectivePresentationDecl rhoCIGSLT declarationColor
          rhoReflectivePresentation.toReflectivePresentationDecl)
        rightPattern →
    RhoCrossColorCollapsingLeafExposuresCanary
      (declarationColor := declarationColor) leftView rightView

theorem rhoCrossColor_collapsingLeafExposuresInDomain_canary :
    ∀ declarationColor,
      RhoCollapsingCrossColorViewsLeafExposuresInDomainCanary
        declarationColor := by
...
theorem nonempty_rhoCanonicalStaticPairSemanticCut_leftCollapsing_of_exposureRoutes_canary
...
theorem nonempty_rhoCanonicalStaticPairSemanticCut_rightCollapsing_of_exposureRoutes_canary
    {declarationColor : CostStaticColor}
    {targetFree : FreeTypeContext} {available outer : List TypeExpr}
    {leftPattern rightPattern : Pattern} {type : TypeExpr}
    {left : CostRegionTree rhoCIGSLT targetFree available outer leftPattern
...
theorem rhoCanonicalStaticPairSemanticCutProviderInDomain_of_exposureA2x_canary
    {declarationColor : CostStaticColor}
  ...
  | leftCollapsing leftColor leftView collapsing =>
      exact
        nonempty_rhoCanonicalStaticPairSemanticCut_leftCollapsing_of_exposureRoutes_canary
  ...
  | rightCollapsing rightColor rightView collapsing =>
      exact
        nonempty_rhoCanonicalStaticPairSemanticCut_rightCollapsing_of_exposureRoutes_canary
