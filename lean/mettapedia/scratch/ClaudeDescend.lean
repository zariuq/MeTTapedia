      ...
      | collection choice selected children =>
          ...
          | none =>
              ...
              · rw [parallelType] at canonical
                ...
                -- GAP B': sibling-unit lift.  Every sibling element
                -- canonicalizes under the colour decl to the unit value
                -- (the copy of `exists_member_of_parallel_collapse`'s
                -- singleton-normalization), and those siblings' abstract
                -- patterns canonicalize under the authored decl to the
                -- authored unit value, so the collection frame leaves the
                -- contributor's collapsed fill untouched.  This is the
                -- abstract-coherence quarter of the descent, parametric in
                -- the sibling set; unproved here, with the genuine content
                -- localized exactly at this step.
                sorry
