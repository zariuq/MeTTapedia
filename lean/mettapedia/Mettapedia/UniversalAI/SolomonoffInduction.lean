...
namespace Mettapedia.UniversalAI.SolomonoffInduction
...
`Mettapedia/UniversalAI/UniversalPrediction.lean`, and Chapter‑2 imports re-export the “obvious”
dominance lemmas needed to state Theorem 2.23 once the enumeration bridge is added.
-/

end Mettapedia.UniversalAI.SolomonoffInduction
