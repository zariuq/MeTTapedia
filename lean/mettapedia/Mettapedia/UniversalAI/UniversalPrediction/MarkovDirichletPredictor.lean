...
This file generalizes `Mettapedia.UniversalAI.UniversalPrediction.MarkovBetaPredictor` from `Bool` to a
...
`Mettapedia.UniversalAI.UniversalPrediction.FiniteAlphabet.PrefixMeasure`, so downstream results (finite
