...
import Mettapedia.UniversalAI.UniversalPrediction.LossBounds
import Mettapedia.UniversalAI.UniversalPrediction.ErrorBounds
...
import Mettapedia.UniversalAI.UniversalPrediction.HutterEnumerationTheoremSemimeasure
...
theorem relEntropy_le_log_inv_M₁ (μ : PrefixMeasure)
  ...
  simpa [M₁] using
    (Mettapedia.UniversalAI.UniversalPrediction.relEntropy_le_log_inv_of_LSC_concrete (μ := μ) hμ n)
...
theorem relEntropy_le_log_inv_M₂ (μ : PrefixMeasure)
    ...
    ∃ c : ENNReal, c ≠ 0 ∧ Dominates M₂ μ c ∧ relEntropy μ M₂ n ≤ Real.log (1 / c.toReal) := by
  simpa [M₂] using
    (Mettapedia.UniversalAI.UniversalPrediction.relEntropy_le_log_inv_of_LSC_semimeasure_concrete
      (μ := μ) hμ n)
...
theorem relEntropy_le_codeLength_log2_M₂ (μ : PrefixMeasure)
  ...
  have hμ_sem :
      Mettapedia.UniversalAI.UniversalPrediction.HutterEnumeration.LowerSemicomputableSemimeasure
        μ.toSemimeasure := by
    simpa [Mettapedia.UniversalAI.UniversalPrediction.HutterEnumeration.LowerSemicomputableSemimeasure,
      Mettapedia.UniversalAI.UniversalPrediction.HutterEnumeration.LowerSemicomputablePrefixMeasure] using hμ
  obtain ⟨code, hcode⟩ :=
  ...
  have hdom : Dominates M₂ μ (encodeWeight code) := by
    ...
    have hdom' :
      ...
      simpa [M₂, HutterEnumerationTheoremSemimeasure.lscSemimeasureEnumeration,
        Mettapedia.UniversalAI.UniversalPrediction.HutterEnumeration.LSCSemimeasureEnumeration.xi] using
...
-/
theorem semimeasure_le_one (M : Mettapedia.UniversalAI.SolomonoffInduction.Semimeasure)
...
* `Mettapedia/UniversalAI/UniversalPrediction/FiniteHorizon.lean`
* `Mettapedia/UniversalAI/UniversalPrediction/ErrorBounds.lean`
* `Mettapedia/UniversalAI/UniversalPrediction/LossBounds.lean`
-/
