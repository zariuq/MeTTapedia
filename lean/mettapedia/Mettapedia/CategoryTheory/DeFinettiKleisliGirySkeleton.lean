...
theorem thetaBernoulliKernel_singleton_apply
    ...
    thetaBernoulliKernel θ ({b} : Set Bool) =
      ENNReal.ofReal (Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) b) := by
  ...
  simp [Mettapedia.ProbabilityTheory.HigherOrderProbability.DeFinettiConnection.kernel,
    ...
    Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliProductPMF, Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF]
...
theorem iidPrefixKernel_singleton_eq_pi_thetaBernoulli
  ...
  have hnonneg : ∀ i : Fin n, 0 ≤ Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) (xs i) := by
    intro i
    cases xs i <;> simp [Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF, sub_nonneg.2 θ.2.2, θ.2.1]
  calc
    (Measure.pi (fun _ : Fin n => thetaBernoulliKernel θ)) ({xs} : Set (Fin n → Bool))
        = ∏ i : Fin n, thetaBernoulliKernel θ ({xs i} : Set Bool) := by
            simp
    _ = ∏ i : Fin n, ENNReal.ofReal (Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) (xs i)) := by
          simp [thetaBernoulliKernel_singleton_apply]
    _ = ENNReal.ofReal (∏ i : Fin n, Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) (xs i)) := by
          symm
          exact ENNReal.ofReal_prod_of_nonneg (fun i _ => hnonneg i)
    _ = ENNReal.ofReal (Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliProductPMF (θ : ℝ) xs) := by
          simp [Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliProductPMF]
...
theorem iidPrefixKernel_singleton_snoc
  ...
  have hprod_snoc :
      (∏ i : Fin (n + 1), Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) (fs i)) =
        (∏ i : Fin n, Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) (xs i)) *
          Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) b := by
    calc
      (∏ i : Fin (n + 1), Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) (fs i))
          = (∏ i : Fin n, Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) (fs i.castSucc)) *
              Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) (fs (Fin.last n)) := by
                simpa using (Fin.prod_univ_castSucc
                  (f := fun i : Fin (n + 1) =>
                    Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) (fs i)))
      _ = (∏ i : Fin n, Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) (xs i)) *
            Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) b := by
              simp [fs, Fin.snoc_castSucc, Fin.snoc_last]
  have hnonnegProd :
      0 ≤ (∏ i : Fin n, Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) (xs i)) := by
    exact Finset.prod_nonneg (fun i _ => by
      cases xs i <;>
        simp [Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF, sub_nonneg.2 θ.2.2, θ.2.1])
  calc
    (iidPrefixKernel (n + 1) θ) ({Fin.snoc xs b} : Set (Fin (n + 1) → Bool))
        = ENNReal.ofReal
            (∏ i : Fin (n + 1), Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) (fs i)) := by
              simp [iidPrefixKernel,
                Mettapedia.ProbabilityTheory.HigherOrderProbability.DeFinettiConnection.kernel,
                Mettapedia.ProbabilityTheory.HigherOrderProbability.DeFinettiConnection.weight,
                Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliProductPMF, fs]
    _ = ENNReal.ofReal
          ((∏ i : Fin n, Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) (xs i)) *
            Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) b) := by
              simp [hprod_snoc]
    _ = ENNReal.ofReal
        ...
        ENNReal.ofReal (Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) b) := by
          simpa using (ENNReal.ofReal_mul
            (p := (∏ i : Fin n, Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) (xs i)))
            (q := Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliPMF (θ : ℝ) b) hnonnegProd)
    _ = (iidPrefixKernel n θ) ({xs} : Set (Fin n → Bool)) *
          thetaBernoulliKernel θ ({b} : Set Bool) := by
            simp [iidPrefixKernel,
              Mettapedia.ProbabilityTheory.HigherOrderProbability.DeFinettiConnection.kernel,
              Mettapedia.ProbabilityTheory.HigherOrderProbability.DeFinettiConnection.weight,
              Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.bernoulliProductPMF,
...
theorem coordPrefixInvariance_imp_globalFinitarySeqConeCommutes
  ...
  have hexchExt : Exchangeability.Exchangeable μ (fun i ω => ω i) := by
    ...
    intro xs
    have hseg :
        Mettapedia.ProbabilityTheory.Exchangeability.FiniteExchangeable n
...
private lemma countFalse_allTrue (n : ℕ) :
  ...
  simp [Mettapedia.ProbabilityTheory.Exchangeability.countFalse, allTruePrefix]
...
private lemma iidPrefixKernel_allTrue_apply (n : ℕ) (θ : LatentTheta) :
  ...
  have hfalse : Mettapedia.ProbabilityTheory.Exchangeability.countFalse (allTruePrefix n) = 0 :=
    countFalse_allTrue n
  have htrue : Mettapedia.ProbabilityTheory.Exchangeability.countTrue (allTruePrefix n) = n := by
    simp [Mettapedia.ProbabilityTheory.Exchangeability.countTrue, allTruePrefix]
  simp [iidPrefixKernel,
    Mettapedia.ProbabilityTheory.HigherOrderProbability.DeFinettiConnection.kernel,
    Mettapedia.ProbabilityTheory.HigherOrderProbability.DeFinettiConnection.weight,
...
private theorem thetaMomentSeq_injective : Function.Injective thetaMomentSeq := by
  ...
  apply Mettapedia.ProbabilityTheory.Moments.HausdorffMoment.probMeasure_unitInterval_eq_of_moments_eq
  intro n
