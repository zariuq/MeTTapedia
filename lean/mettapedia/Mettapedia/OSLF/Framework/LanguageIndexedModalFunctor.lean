...
abbrev NativeTypeEssentialImage :=
  Mettapedia.OSLF.PresheafNativeType.nativeTypeFunctor.EssImageSubcategory
...
theorem nativeType_obj_mem_essentialImage
    ...
    Mettapedia.OSLF.PresheafNativeType.nativeTypeFunctor.essImage
      (Mettapedia.OSLF.PresheafNativeType.nativeTypeFunctor.obj theory) :=
  CategoryTheory.Functor.obj_mem_essImage
    Mettapedia.OSLF.PresheafNativeType.nativeTypeFunctor theory
...
abbrev ProofRelevantRequirement :=
  Mettapedia.GSLT.ProofRelevant.ExactTranslation
