...
/-!
# LP RelationEnv Bridge for MeTTaIL

Port of the retired standalone Datalog OSLF bridge onto LP types.
...
namespace Mettapedia.OSLF.MeTTaIL.LPRelationEnvBridge
...
end Mettapedia.OSLF.MeTTaIL.LPRelationEnvBridge
