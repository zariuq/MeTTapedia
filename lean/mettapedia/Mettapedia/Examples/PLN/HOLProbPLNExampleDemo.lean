...
namespace Mettapedia.Examples.PLN.HOLProbPLNExampleDemo
...
abbrev plannerCarriedValueRung :=
  @Mettapedia.PLN.RuleFamilies.HigherOrder.benchmarkPlannerShadow_carried_value_eq_benchmarkBeliefPrice
...
end Mettapedia.Examples.PLN.HOLProbPLNExampleDemo
