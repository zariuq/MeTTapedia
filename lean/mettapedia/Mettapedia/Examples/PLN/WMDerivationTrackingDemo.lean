...
import Mettapedia.PLN.WorldModel.Provenance.PLNScopedTrackedWhichState
...
namespace Mettapedia.Examples.PLN.WMDerivationTrackingDemo

open Mettapedia.PLN.WorldModel.Provenance
...
theorem pipeClosure_moldRisk : pipeClosure moldRisk₁ = pipeProv := by
  simp only [pipeClosure, closure2, T_P_K_LP_seeded_moldRisk, T_P_K_LP_seeded_wallHumidity]; simp
...
theorem showerClosure_moldRisk_zero : showerClosure moldRisk₁ = 0 := by
  simp only [showerClosure, closure2, T_P_K_LP_seeded_moldRisk, T_P_K_LP_seeded_wallHumidity]; simp
...
end Mettapedia.Examples.PLN.WMDerivationTrackingDemo
