...
noncomputable def exactConceptFamily
  ...
  Mettapedia.KR.ConceptGeometry.AbstractInheritance.finiteConceptFamily (Q := BinaryEvidence) exactGate B.evidence
...
noncomputable def exactOrderIso
    (B : BinaryFcaBenchmarkContext Obj Attr) :
    Mettapedia.KR.ConceptGeometry.AbstractInheritance.FormedConcept exactGate B.evidence ≃o exactCrispConcept B :=
...
theorem flyingFamilyConcept_mem_upper :
  ...
  change ∃ b : Bool,
      flyingFamilyConcept ∈
        Mettapedia.KR.ConceptGeometry.AbstractInheritance.finiteConceptFamily (gateFamily b) context.evidence
  refine ⟨false, ?_⟩
...
theorem flyingFamilyConcept_not_mem_lower :
  ...
  have hLower' :
      ∀ b : Bool,
        flyingFamilyConcept ∈
          Mettapedia.KR.ConceptGeometry.AbstractInheritance.finiteConceptFamily (gateFamily b) context.evidence := by
    simpa [BinaryFcaBenchmarkContext.lowerThresholdConceptFamily,
      lowerConceptFamily, gateFamily] using hLower
  have hStrict :
      flyingFamilyConcept ∈
        Mettapedia.KR.ConceptGeometry.AbstractInheritance.finiteConceptFamily (gateFamily true) context.evidence :=
    hLower' true
  have hNot :
      flyingFamilyConcept ∉
...
theorem batOnlyFlyingConcept_not_mem_upper :
  ...
  change ∃ b : Bool,
      batOnlyFlyingConcept ∈
        Mettapedia.KR.ConceptGeometry.AbstractInheritance.finiteConceptFamily (gateFamily b) context.evidence at hUpper
