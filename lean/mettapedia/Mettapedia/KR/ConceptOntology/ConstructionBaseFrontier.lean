...
noncomputable def conceptCredalFrontierHeight
    ...
    (A : Mettapedia.KR.ConceptGeometry.AbstractInheritance.DualConcept Obj Attr) : NNReal :=
...
abbrev conceptCredalFrontierOrder
    (Γ : Gate → EvidenceGate Q) (M : Obj → Attr → Q)
    (A : Mettapedia.KR.ConceptGeometry.AbstractInheritance.DualConcept Obj Attr) : Type _ :=
