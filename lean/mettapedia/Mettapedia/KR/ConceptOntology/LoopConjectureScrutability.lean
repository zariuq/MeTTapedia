...
def credalScrutabilityGap
    ...
    Set (Mettapedia.KR.ConceptGeometry.AbstractInheritance.DualConcept Obj Attr) :=
...
def controlCredalScrutabilityGap : Set (Mettapedia.KR.ConceptGeometry.AbstractInheritance.DualConcept Animal Trait) :=
