...
- `_root_.Mettapedia.KR.ConceptOntology.EvidenceMembershipContext` for graded/additive membership evidence
...
abbrev DualConcept (Obj : Type*) (Attr : Type*) :=
  Mettapedia.KR.ConceptGeometry.AbstractInheritance.DualConcept Obj Attr
...
abbrev Interpretation (Carrier : Type*) (Obj : Type*) (Attr : Type*) :=
  Mettapedia.KR.ConceptGeometry.AbstractInheritance.Interpretation Carrier Obj Attr
...
abbrev EvidenceMembershipContext
    ...
    [Mettapedia.PLN.Evidence.EvidenceClass.EvidenceType State] [AddCommMonoid Ev] :=
  Mettapedia.KR.ConceptOntology.EvidenceMembershipContext State Obj Con Ev
...
abbrev EvidenceConcept {Obj : Type*} {Con : Type*} {Q : Type*}
    ...
    (M : Obj → Con → Q) :=
  Mettapedia.KR.ConceptOntology.EvidenceConcept M
...
noncomputable def crispInterpretationAt
    ...
    (W : State) :
    Mettapedia.KR.ConceptGeometry.AbstractInheritance.Interpretation Con Obj Con :=
  Mettapedia.KR.ConceptGeometry.AbstractInheritance.crispInterpretation G (M.memberEvidence W)
...
theorem extensionalInheritsAt_iff
    ...
    ExtensionalInheritsAt M G W c d ↔
      Mettapedia.KR.ConceptOntology.crispExtensionalInherits G (M.memberEvidence W) c d := by
  simpa [ExtensionalInheritsAt, crispInterpretationAt] using
    (Mettapedia.KR.ConceptGeometry.AbstractInheritance.crispInterpretation_extensionalInherits_iff
...
def unaryAttributeConcept (name : String) (holds : α → Prop) :
    Mettapedia.KR.ConceptGeometry.AbstractInheritance.DualConcept α String where
  extent := {x | holds x}
  intent := {label | label = name}

/-- Example: "creatures with hearts" as a semantic extent/intent object. -/
def heartConcept (hasHeart : α → Prop) :
    Mettapedia.KR.ConceptGeometry.AbstractInheritance.DualConcept α String :=
