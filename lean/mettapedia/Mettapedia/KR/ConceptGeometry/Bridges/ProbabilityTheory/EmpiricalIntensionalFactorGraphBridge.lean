...
namespace Mettapedia.KR.ConceptGeometry.IntensionalInheritance
...
theorem extentCount_witness_eq_toFiniteWitnessFeatureTable
    (I : Mettapedia.KR.ConceptGeometry.AbstractInheritance.Interpretation Carrier Obj Attr)
    (feature witness : Carrier) :
    Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.extentCount I witness =
      (toFiniteWitnessFeatureTable I feature witness).witnessOnly +
        (toFiniteWitnessFeatureTable I feature witness).both := by
  classical
  unfold Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.extentCount
...
theorem extentCount_feature_eq_toFiniteWitnessFeatureTable
    (I : Mettapedia.KR.ConceptGeometry.AbstractInheritance.Interpretation Carrier Obj Attr)
    (feature witness : Carrier) :
    Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.extentCount I feature =
      (toFiniteWitnessFeatureTable I feature witness).featureOnly +
        (toFiniteWitnessFeatureTable I feature witness).both := by
  classical
  unfold Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.extentCount
...
@[simp] theorem jointExtentCount_eq_toFiniteWitnessFeatureTable
    (I : Mettapedia.KR.ConceptGeometry.AbstractInheritance.Interpretation Carrier Obj Attr)
    (feature witness : Carrier) :
    Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.jointExtentCount I feature witness =
      (toFiniteWitnessFeatureTable I feature witness).both := by
  rfl
...
theorem finitePriorProb_eq_toFiniteWitnessFeatureTable_witnessPrior
    (I : Mettapedia.KR.ConceptGeometry.AbstractInheritance.Interpretation Carrier Obj Attr)
    (feature witness : Carrier) :
    Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.finitePriorProb I witness =
      FiniteWitnessFeatureTable.witnessPrior
        (toFiniteWitnessFeatureTable I feature witness) := by
  rw [Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.finitePriorProb]
...
theorem finiteExtensionalProb_eq_toFiniteWitnessFeatureTable_strength
    (I : Mettapedia.KR.ConceptGeometry.AbstractInheritance.Interpretation Carrier Obj Attr)
    (feature witness : Carrier) :
    Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.finiteExtensionalProb I feature witness =
      FiniteWitnessFeatureTable.featureToWitnessStrength
        (toFiniteWitnessFeatureTable I feature witness) := by
  rw [Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.finiteExtensionalProb]
...
theorem finitePointwiseLogRatioBits_eq_toFiniteWitnessFeatureTable
    (I : Mettapedia.KR.ConceptGeometry.AbstractInheritance.Interpretation Carrier Obj Attr)
    (feature witness : Carrier) :
    Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.finitePointwiseLogRatioBits
        I feature witness =
      FiniteWitnessFeatureTable.logRatioBits
        (toFiniteWitnessFeatureTable I feature witness) := by
  rw [Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.finitePointwiseLogRatioBits]
...
noncomputable def formedConceptInheritanceTable
    ...
    (M : Obj → Attr → Q)
    (subConcept superConcept : Mettapedia.KR.ConceptGeometry.AbstractInheritance.FormedConcept G M) :
...
theorem finitePriorProb_formedConceptInterpretation_eq_toFiniteWitnessFeatureTable_witnessPrior
    ...
    Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.finitePriorProb
        (Mettapedia.KR.ConceptGeometry.AbstractInheritance.formedConceptInterpretation G M) witness =
      FiniteWitnessFeatureTable.witnessPrior
        (Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.toFiniteWitnessFeatureTable
          (Mettapedia.KR.ConceptGeometry.AbstractInheritance.formedConceptInterpretation G M) feature witness) := by
  simpa using
...
theorem finiteExtensionalProb_formedConceptInterpretation_eq_toFiniteWitnessFeatureTable_strength
    ...
    (M : Obj → Attr → Q)
    (feature witness : Mettapedia.KR.ConceptGeometry.AbstractInheritance.FormedConcept G M) :
    Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.finiteExtensionalProb
        (Mettapedia.KR.ConceptGeometry.AbstractInheritance.formedConceptInterpretation G M) feature witness =
      FiniteWitnessFeatureTable.featureToWitnessStrength
        (Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.toFiniteWitnessFeatureTable
          (Mettapedia.KR.ConceptGeometry.AbstractInheritance.formedConceptInterpretation G M) feature witness) := by
  simpa using
...
theorem finitePriorProb_formedConceptInterpretation_eq_bp_ratio
    ...
    Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.finitePriorProb
      ...
      (FiniteWitnessFeatureTable.witnessMessage
        (Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.toFiniteWitnessFeatureTable
          (Mettapedia.KR.ConceptGeometry.AbstractInheritance.formedConceptInterpretation G M) feature witness) true : ℝ) /
        FiniteWitnessFeatureTable.veWeight
          (Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.toFiniteWitnessFeatureTable
            (Mettapedia.KR.ConceptGeometry.AbstractInheritance.formedConceptInterpretation G M) feature witness) [] := by
  simpa using
...
theorem finiteExtensionalProb_formedConceptInterpretation_eq_bp_ratio
    ...
    Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.finiteExtensionalProb
      ...
      if FiniteWitnessFeatureTable.featureMessage
          (Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.toFiniteWitnessFeatureTable
            (Mettapedia.KR.ConceptGeometry.AbstractInheritance.formedConceptInterpretation G M) feature witness) true = 0 then
        0
      else
        (FiniteWitnessFeatureTable.jointFactorBelief
          (Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.toFiniteWitnessFeatureTable
          ...
          (FiniteWitnessFeatureTable.ttJointAssign
            (Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.toFiniteWitnessFeatureTable
              (Mettapedia.KR.ConceptGeometry.AbstractInheritance.formedConceptInterpretation G M) feature witness)) : ℝ) /
          FiniteWitnessFeatureTable.featureMessage
            (Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.toFiniteWitnessFeatureTable
              (Mettapedia.KR.ConceptGeometry.AbstractInheritance.formedConceptInterpretation G M) feature witness) true := by
  simpa using
...
theorem finiteInheritancePrior_formedConceptInterpretation_eq_veWeight_ratio
    ...
    (M : Obj → Attr → Q)
    (subConcept superConcept : Mettapedia.KR.ConceptGeometry.AbstractInheritance.FormedConcept G M) :
    Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.finiteInheritancePrior
        (Mettapedia.KR.ConceptGeometry.AbstractInheritance.formedConceptInterpretation G M) superConcept =
      (FiniteWitnessFeatureTable.veWeight
        (Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.toFiniteWitnessFeatureTable
          (Mettapedia.KR.ConceptGeometry.AbstractInheritance.formedConceptInterpretation G M)
          subConcept superConcept)
...
theorem finiteInheritanceStrength_formedConceptInterpretation_eq_veWeight_ratio
    ...
    (M : Obj → Attr → Q)
    (subConcept superConcept : Mettapedia.KR.ConceptGeometry.AbstractInheritance.FormedConcept G M) :
    Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.finiteInheritanceStrength
        (Mettapedia.KR.ConceptGeometry.AbstractInheritance.formedConceptInterpretation G M)
        subConcept superConcept =
      if FiniteWitnessFeatureTable.veWeight
          (Mettapedia.KR.ConceptGeometry.IntensionalInheritance.Interpretation.toFiniteWitnessFeatureTable
...
theorem finiteInheritancePrior_lowerFormedConceptInterpretation_eq_veWeight_ratio
    ...
    Interpretation.finiteInheritancePrior
        (_root_.Mettapedia.KR.ConceptOntology.lowerFormedConceptInterpretation Γ M) superConcept =
      (FiniteWitnessFeatureTable.veWeight
        (Interpretation.toFiniteWitnessFeatureTable
  ...
  simpa [Interpretation.finiteInheritancePrior_eq] using
    Interpretation.finitePriorProb_eq_veWeight_ratio
      (I := _root_.Mettapedia.KR.ConceptOntology.lowerFormedConceptInterpretation Γ M)
...
theorem finiteInheritancePrior_lowerFormedConceptInterpretation_eq_bpRatio
    (Γ : Gate → Mettapedia.KR.ConceptOntology.EvidenceGate Q)
    (M : Obj → Attr → Q)
    (subConcept superConcept :
      Mettapedia.KR.ConceptOntology.LowerFormedConcept Γ M) :
    Interpretation.finiteInheritancePrior
        (Mettapedia.KR.ConceptOntology.lowerFormedConceptInterpretation Γ M) superConcept =
      (FiniteWitnessFeatureTable.witnessMessage
        (Interpretation.toFiniteWitnessFeatureTable
          (Mettapedia.KR.ConceptOntology.lowerFormedConceptInterpretation Γ M)
          subConcept superConcept) true : ℝ) /
        FiniteWitnessFeatureTable.veWeight
          (Interpretation.toFiniteWitnessFeatureTable
            (Mettapedia.KR.ConceptOntology.lowerFormedConceptInterpretation Γ M)
  ...
  simpa [Interpretation.finiteInheritancePrior_eq] using
    Interpretation.finitePriorProb_eq_bp_ratio
      (I := Mettapedia.KR.ConceptOntology.lowerFormedConceptInterpretation Γ M)
      (feature := subConcept) (witness := superConcept)
...
theorem lowerCredalConceptInheritanceTable_singleton_eq
    ...
    (M : Obj → Attr → Q)
    (subConcept superConcept :
      Mettapedia.KR.ConceptOntology.LowerFormedConcept (Gate := PUnit) (fun _ => G) M) :
    lowerCredalConceptInheritanceTable (Gate := PUnit) (fun _ => G) M subConcept superConcept =
      AbstractInheritance.formedConceptInheritanceTable G M
        (Mettapedia.KR.ConceptOntology.lowerFormedConceptSingletonEquiv G M subConcept)
        (Mettapedia.KR.ConceptOntology.lowerFormedConceptSingletonEquiv G M superConcept) := by
  rfl
...
theorem finiteInheritanceStrength_lowerFormedConceptInterpretation_singleton_eq
    ...
    (subConcept superConcept :
      Mettapedia.KR.ConceptOntology.LowerFormedConcept (Gate := PUnit) (fun _ => G) M) :
    Interpretation.finiteInheritanceStrength
        (Mettapedia.KR.ConceptOntology.lowerFormedConceptInterpretation
...
theorem lowerFormedConceptInheritance_exact_via_table_singleton
    ...
    let subExact :=
      Mettapedia.KR.ConceptOntology.lowerFormedConceptSingletonEquiv G M subConcept
    let superExact :=
      Mettapedia.KR.ConceptOntology.lowerFormedConceptSingletonEquiv G M superConcept
    Interpretation.finiteInheritancePrior
        (Mettapedia.KR.ConceptOntology.lowerFormedConceptInterpretation
          (Gate := PUnit) (fun _ => G) M)
        superConcept =
...
theorem finitePriorProb_crispInterpretationAt_eq_veWeight_ratio
    (M : Mettapedia.KR.ConceptOntology.EvidenceMembershipContext State Obj Con Q)
    (G : Mettapedia.KR.ConceptOntology.EvidenceGate Q)
...
variable [Mettapedia.PLN.WorldModel.PLNWorldModel.WorldModelSigma State Srt Query]
variable [Fintype Obj] [Nonempty Obj]

theorem finitePriorProb_toEvidenceMembershipContext_eq_veWeight_ratio
    (enc : Mettapedia.KR.ConceptOntology.MembershipQueryBuilder Obj Con Srt Query)
  ...
  simpa using
    EvidenceMembershipContext.finitePriorProb_crispInterpretationAt_eq_veWeight_ratio
      (M := Mettapedia.KR.ConceptOntology.MembershipQueryBuilder.toEvidenceMembershipContext
        (State := State) enc)
