...
namespace Mettapedia.NARS.Bridges.PLN.InformationAdjunction

open scoped ENNReal
open Mettapedia.PLN.Evidence.EvidenceQuantale
open Mettapedia.PLN.Evidence.EvidenceClass
open Mettapedia.NARS.TruthFunctions
open Mettapedia.NARS.Bridges.PLN.EvidenceTranslation
open Mettapedia.NARS.Bridges.PLN.SecondOrderProbability
...
/-!
The finite-evidence adjunction above does not assert an asymptotic
identification between uniform-prior PLN strength and NARS frequency. Such a
result requires a separately selected Beta-family prior and an explicit
`Filter.Tendsto` theorem; neither premise belongs to this information-order
bridge.
-/

end Mettapedia.NARS.Bridges.PLN.InformationAdjunction
