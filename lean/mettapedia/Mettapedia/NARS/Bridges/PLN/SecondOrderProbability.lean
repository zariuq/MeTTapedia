...
We intentionally keep `Mettapedia.NARS.TruthFunctions` as a faithful mirror of
...
namespace Mettapedia.NARS.Bridges.PLN.SecondOrderProbability
...
theorem toEvidenceWithK_one_eq_bridge_toEvidence (t : TV) (ht : IsProbTV t) :
    TV.toEvidenceWithK 1 t ht.c_lt_one = Mettapedia.NARS.Bridges.PLN.EvidenceTranslation.TV.toEvidence t := by
  ...
  ext <;>
    simp [TV.toEvidenceWithK, Mettapedia.NARS.Bridges.PLN.EvidenceTranslation.TV.toEvidence, BinaryEvidence.ofSTV,
      hdiv, ENNReal.ofReal_mul ht.f_nonneg, ENNReal.ofReal_mul h1mf]

theorem toNARSTVWithK_one_eq_bridge_toNARSTV (e : BinaryEvidence) :
    BinaryEvidence.toNARSTVWithK 1 e = Mettapedia.NARS.Bridges.PLN.EvidenceTranslation.BinaryEvidence.toNARSTV e := by
  rfl

/-! ## Core revision and evidence aggregation -/
...
end Mettapedia.NARS.Bridges.PLN.SecondOrderProbability
