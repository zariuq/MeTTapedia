...
namespace Mettapedia.NARS.TruthFunctions
...
/-- The evidence-additive core of revision before implementation guards.
Wang derives this weighted average from addition of distinct evidence bodies.
The guarded runtime formula below caps the resulting values. -/
...
end Mettapedia.NARS.TruthFunctions
