...
import Mettapedia.PLN.TruthValues.PLNForcedQueries
...
namespace Mettapedia.PLN.TruthValues.PLNTruthTower
...
@[simp] theorem posteriorMeanStrength_improper_eq_mle
    (e : BinaryCounts) :
    posteriorMeanStrength Mettapedia.PLN.Evidence.EvidenceClass.BinaryContext.improper e =
      e.mleStrength := by
  simp [posteriorMeanStrength, posteriorDenom, mleStrength, strength,
    total, Mettapedia.PLN.Evidence.EvidenceClass.BinaryContext.improper]
...
theorem singlePositive_uniform_prior_changes_strength :
    singlePositive.mleStrength = 1 ∧
      posteriorMeanStrength
          Mettapedia.PLN.Evidence.EvidenceClass.BinaryContext.uniform singlePositive =
        (2 / 3 : ℝ) ∧
        singlePositive.mleStrength ≠
          posteriorMeanStrength
            Mettapedia.PLN.Evidence.EvidenceClass.BinaryContext.uniform singlePositive := by
  norm_num [singlePositive, mleStrength, strength, posteriorMeanStrength,
    posteriorDenom, total, Mettapedia.PLN.Evidence.EvidenceClass.BinaryContext.uniform]
...
theorem ofNatCounts_mleStrength_eq_predHaldane
    ...
    (ofNatCounts nPos nNeg).mleStrength =
      Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.predHaldane nPos nNeg := by
  ...
  · have hPos : nPos = 0 := Nat.eq_zero_of_add_eq_zero_right h
    ...
    simp [ofNatCounts, mleStrength, strength, total,
      Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.predHaldane,
      Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.plnStrength,
      Mettapedia.PLN.Evidence.EvidenceCounts.plnStrength, hPos, hNeg]
  · have hTower :
        (ofNatCounts nPos nNeg).mleStrength =
    ...
    have hLedger :
        Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.predHaldane nPos nNeg =
          (nPos : ℝ) / ((nPos + nNeg : ℕ) : ℝ) := by
      simpa [Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.predHaldane] using
        Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.plnStrength_eq_improper_mean nPos nNeg h
    rw [hTower, hLedger]
...
theorem ofNatCounts_uniformPosterior_eq_predLaplace
    ...
    posteriorMeanStrength
      ...
      Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.predLaplace nPos nNeg := by
  simp [posteriorMeanStrength, posteriorDenom, ofNatCounts, total,
    Mettapedia.PLN.Evidence.EvidenceClass.BinaryContext.uniform,
    Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.predLaplace,
    Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.uniformPosteriorMean,
...
theorem ofNatCounts_jeffreysPosterior_eq_predJeffreys
    ...
    posteriorMeanStrength
        ...
        (ofNatCounts nPos nNeg) =
      Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.predJeffreys nPos nNeg := by
  ...
  simp [posteriorMeanStrength, posteriorDenom, ofNatCounts, total,
    Mettapedia.PLN.Evidence.EvidenceClass.BinaryContext.jeffreys,
    Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.predJeffreys,
    Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.jeffreysPosteriorMean,
    Mettapedia.PLN.Evidence.EvidenceCounts.jeffreysPosteriorMean, hhalf]
  ring_nf
...
theorem ofNatCounts_haldane_vs_laplace_difference
  ...
  rw [ofNatCounts_mleStrength_eq_predHaldane,
    ofNatCounts_uniformPosterior_eq_predLaplace]
  exact Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.haldane_vs_laplace_difference nPos nNeg h
...
theorem ofNatCounts_haldane_vs_jeffreys_difference
  ...
  rw [ofNatCounts_mleStrength_eq_predHaldane,
    ofNatCounts_jeffreysPosterior_eq_predJeffreys]
  exact Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.haldane_vs_jeffreys_difference nPos nNeg h
...
theorem ofNatCounts_mle_converges_to_symmetric_posterior_mean :
  ...
  obtain ⟨N, hN⟩ :=
    Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.strength_converges_to_mean
      ε hε priorParam hprior
  refine ⟨N, ?_⟩
  intro nPos nNeg hn hne
  have h := hN nPos nNeg hn hne
  rw [ofNatCounts_mleStrength_eq_predHaldane]
  simpa [Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.predHaldane] using h
...
structure BayesCredibleITVSource (level : ℝ) where
  evidence : Mettapedia.PLN.Evidence.EvidenceQuantale.BinaryEvidence
...
structure WalleyCategoricalITVSource (k : ℕ) where
  evidence : Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.MultiEvidence k
  category : Fin k
...
noncomputable def walleyCategoricalITV {k : ℕ}
    ...
    ITV where
  lower := Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmLower ctx e i
  upper := Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmUpper ctx e i
  credibility := (e.total : ℝ) /
    Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmDenom ctx e
  lower_le_upper :=
    Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmLower_le_idmUpper ctx e i
  lower_in_unit := by
    exact ⟨
      Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmLower_nonneg ctx e i,
      le_trans
        (Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmLower_le_idmUpper ctx e i)
        (Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmUpper_le_one ctx e i)⟩
  upper_in_unit := by
    exact ⟨
      Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmUpper_nonneg ctx e i,
      Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmUpper_le_one ctx e i⟩
  credibility_in_unit := by
    constructor
    · exact div_nonneg
        (by exact_mod_cast (Nat.zero_le e.total))
        (le_of_lt (Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmDenom_pos ctx e))
    · apply (div_le_one
        (Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmDenom_pos ctx e)).2
...
theorem walleyCategoricalITV_width_eq {k : ℕ}
    ...
    (walleyCategoricalITV ctx e i).width =
      Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmWidth ctx e := by
  simpa [walleyCategoricalITV, ITV.width] using
    (Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmWidth_eq_upper_sub_lower
      ctx e i).symm
...
theorem walleyCategoricalITV_width_add_credibility {k : ℕ}
  ...
  unfold Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmWidth
  have hden :
      Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmDenom ctx e ≠ 0 :=
    ne_of_gt (Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.idmDenom_pos ctx e)
  field_simp [hden]
  ring
    ...
    (walleyCategoricalITV ctx e i).width =
      Mettapedia.ProbabilityTheory.ImpreciseProbability.DesirableGambles.upperProb
        ...
        Mettapedia.ProbabilityTheory.ImpreciseProbability.DesirableGambles.lowerProb
          (Mettapedia.ProbabilityTheory.ImpreciseProbability.WalleyMultinomialIDM.credalSet e ctx.s ctx.s_pos)
          (Mettapedia.ProbabilityTheory.ImpreciseProbability.WalleyMultinomialIDM.categoryGamble i) := by
  rw [Mettapedia.ProbabilityTheory.ImpreciseProbability.WalleyMultinomialIDM.category_width_eq_EvidenceDirichlet_idmWidth_of_other
...
theorem forcedQuery_same_statistic_same_value
    {World Stat Val : Type*}
    (F : Mettapedia.PLN.TruthValues.PLNForcedQueries.ForcedByStatistic World Stat Val)
    {W₁ W₂ : World} (h : F.stat W₁ = F.stat W₂) :
    F.eval W₁ = F.eval W₂ :=
  Mettapedia.PLN.TruthValues.PLNForcedQueries.ForcedByStatistic.eval_eq_of_same_stat F h
    ...
    ∃ itv : ITV,
      Mettapedia.PLN.TruthValues.PLNForcedQueries.ITVSelector.eval .lower itv ≠
        ...
        Mettapedia.PLN.TruthValues.PLNForcedQueries.ITVSelector.eval .midpoint itv ≠
          ...
          Mettapedia.PLN.TruthValues.PLNForcedQueries.ITVSelector.eval .lower itv ≠
            Mettapedia.PLN.TruthValues.PLNForcedQueries.ITVSelector.eval .upper itv :=
  Mettapedia.PLN.TruthValues.PLNForcedQueries.sameITV_has_three_distinct_selector_values
...
theorem walleyCredalEnvelope_matches_ITV_bounds
    (e : Mettapedia.PLN.Evidence.EvidenceQuantale.BinaryEvidence) (s : ℝ) (hs : 0 < s) :
    Mettapedia.ProbabilityTheory.ImpreciseProbability.DesirableGambles.lowerProb
        (Mettapedia.ProbabilityTheory.ImpreciseProbability.WalleyBinaryIDM.credalSetOfEvidence e s hs)
  ...
  Mettapedia.ProbabilityTheory.ImpreciseProbability.WalleyBinaryIDM.credal_envelope_matches_Walley_ITV_bounds e s hs
...
theorem walleyMultinomial_category_width
    ...
    Mettapedia.ProbabilityTheory.ImpreciseProbability.DesirableGambles.upperProb
        (Mettapedia.ProbabilityTheory.ImpreciseProbability.WalleyMultinomialIDM.credalSet e s hs)
        (Mettapedia.ProbabilityTheory.ImpreciseProbability.WalleyMultinomialIDM.categoryGamble i) -
      Mettapedia.ProbabilityTheory.ImpreciseProbability.DesirableGambles.lowerProb
        (Mettapedia.ProbabilityTheory.ImpreciseProbability.WalleyMultinomialIDM.credalSet e s hs)
        (Mettapedia.ProbabilityTheory.ImpreciseProbability.WalleyMultinomialIDM.categoryGamble i) =
      s / ((e.total : ℝ) + s) :=
  Mettapedia.ProbabilityTheory.ImpreciseProbability.WalleyMultinomialIDM.category_width_eq_idmWidth_of_other
    e s hs i j hji
...
theorem walleyMultinomial_category_envelope_matches_EvidenceDirichlet
  ...
  ⟨Mettapedia.ProbabilityTheory.ImpreciseProbability.WalleyMultinomialIDM.lowerProb_categoryGamble_eq_idmLower_of_other
      ctx e i j hji,
    Mettapedia.ProbabilityTheory.ImpreciseProbability.WalleyMultinomialIDM.upperProb_categoryGamble_eq_idmUpper
      ctx e i,
    Mettapedia.ProbabilityTheory.ImpreciseProbability.WalleyMultinomialIDM.category_width_eq_EvidenceDirichlet_idmWidth_of_other
      ctx e i j hji⟩
