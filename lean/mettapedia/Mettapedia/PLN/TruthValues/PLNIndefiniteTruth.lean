...
namespace Mettapedia.PLN.TruthValues.PLNIndefiniteTruth
...
theorem fromWalleyIDMPredictive_credibility_eq_plnOddsCoordinate
    (e : BinaryEvidence) (s : ℝ) (hs : 0 < s) :
    (fromWalleyIDMPredictive e s hs).credibility =
      (Mettapedia.PLN.TruthValues.PLNConfidenceWeight.EvidenceWeightCoordinate.plnOddsCoordinate s hs).encode
        (e.pos.toReal + e.neg.toReal) := by
  rw [fromWalleyIDMPredictive_credibility]
  simp [Mettapedia.PLN.TruthValues.PLNConfidenceWeight.EvidenceWeightCoordinate.plnOddsCoordinate]
  ...
  credibility_in_unit := by
    ...
    have hw : 0 ≤ c2w itv1.credibility * c2w itv2.credibility := by
      ...
      · by_cases h1 : itv1.credibility < 1
        · exact Mettapedia.PLN.TruthValues.PLNWeightTV.WTV.c2w_nonneg itv1.credibility itv1.credibility_in_unit.1 h1
        · unfold c2w; simp only [h1, ↓reduceIte]; norm_num
      · by_cases h2 : itv2.credibility < 1
        · exact Mettapedia.PLN.TruthValues.PLNWeightTV.WTV.c2w_nonneg itv2.credibility itv2.credibility_in_unit.1 h2
        · unfold c2w; simp only [h2, ↓reduceIte]; norm_num
    exact Mettapedia.PLN.TruthValues.PLNWeightTV.WTV.w2c_bounds _ hw
...
end Mettapedia.PLN.TruthValues.PLNIndefiniteTruth
