...
namespace Mettapedia.PLN.TruthValues.Distributional
...
abbrev SimpleTruthValue := Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.STV
...
end Mettapedia.PLN.TruthValues.Distributional
