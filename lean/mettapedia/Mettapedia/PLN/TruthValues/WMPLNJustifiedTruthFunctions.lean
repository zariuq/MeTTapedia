...
namespace Mettapedia.PLN.TruthValues.WMPLNJustifiedTruthFunctions
...
`Mettapedia.PLN.TruthValues.PLNBugAnalysis`; it double-damps by treating a
confidence as if it were already an evidence weight.
-/

abbrev TV := Mettapedia.PLN.TruthValues.PeTTaLibPLNTruthFunctions.TV
abbrev MettaTV := Mettapedia.PLN.TruthValues.PeTTaLibPLNTruthFunctions.TV
...
noncomputable def truthRevision (t1 t2 : TV) : TV :=
  let w1 := Mettapedia.PLN.TruthValues.PeTTaLibPLNTruthFunctions.c2w t1.c
  let w2 := Mettapedia.PLN.TruthValues.PeTTaLibPLNTruthFunctions.c2w t2.c
  let w := w1 + w2
  let f := Mettapedia.PLN.TruthValues.PeTTaLibPLNTruthFunctions.safeDiv (w1 * t1.s + w2 * t2.s) w
  let c := Mettapedia.PLN.TruthValues.PeTTaLibPLNTruthFunctions.w2c w
  ⟨min 1 f, min 1 c⟩
...
theorem truthRevision_eq_toTV_hplus
    ...
    toMettaTV (truthRevision t1 t2) =
      Mettapedia.PLN.Evidence.NuEvidenceQuantaleBridge.Bridge.BinaryEvidence.toTV κ
        (Mettapedia.PLN.Evidence.NuEvidenceQuantaleBridge.Bridge.TV.toEvidence κ (toMettaTV t1) +
         Mettapedia.PLN.Evidence.NuEvidenceQuantaleBridge.Bridge.TV.toEvidence κ (toMettaTV t2)) := by
  let rhs :=
    Mettapedia.PLN.Evidence.NuEvidenceQuantaleBridge.Bridge.BinaryEvidence.toTV κ
      (Mettapedia.PLN.Evidence.NuEvidenceQuantaleBridge.Bridge.TV.toEvidence κ (toMettaTV t1) +
       Mettapedia.PLN.Evidence.NuEvidenceQuantaleBridge.Bridge.TV.toEvidence κ (toMettaTV t2))
...
theorem truthInduction_conf_eq_min_capped (a b c ba bc : TV) :
  ...
  simpa [truthInduction, Mettapedia.PLN.TruthValues.PeTTaLibPLNTruthFunctions.truthInduction] using
    Mettapedia.PLN.Evidence.NuEvidenceQuantaleBridge.InductionAbductionBridge.inductionAbduction_conf_eq_min_capped
      ba.c bc.c
...
theorem truthInduction_conf_le_inputs
  ...
  simpa [truthInduction] using
    Mettapedia.PLN.Evidence.NuEvidenceQuantaleBridge.InductionAbductionBridge.inductionAbduction_conf_le_min
      ba.c bc.c hba hbc
...
theorem truthAbduction_conf_eq_min_capped (a b c ab cb : TV) :
  ...
  simpa [truthAbduction, Mettapedia.PLN.TruthValues.PeTTaLibPLNTruthFunctions.truthAbduction] using
    Mettapedia.PLN.Evidence.NuEvidenceQuantaleBridge.InductionAbductionBridge.inductionAbduction_conf_eq_min_capped
      ab.c cb.c
...
noncomputable abbrev truthNegation := Mettapedia.PLN.TruthValues.PeTTaLibPLNTruthFunctions.truthNegation
...
theorem truthDeduction_conf_le_inputs
  ...
  · have hc :
        ...
        simp [truthDeductionConservative, Mettapedia.PLN.TruthValues.PeTTaLibPLNTruthFunctions.truthDeduction, h]
    rw [hc]
    exact Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.min_confidence_is_lower_bound
...
noncomputable abbrev truthSymmetricModusPonensConservative :=
  Mettapedia.PLN.TruthValues.PeTTaLibPLNTruthFunctions.truthSymmetricModusPonens
...
theorem truthSymmetricModusPonens_conf_le_inputs
  ...
  unfold Mettapedia.PLN.TruthValues.PeTTaLibPLNTruthFunctions.truthSymmetricModusPonens
  constructor
...
@[simp] theorem truthConjunctionIndependent_conf_eq (a b : TV) :
    (truthConjunctionIndependentEvidenceStyle a b).c =
      Mettapedia.PLN.TruthValues.PeTTaLibPLNTruthFunctions.w2c
        (Mettapedia.PLN.TruthValues.PeTTaLibPLNTruthFunctions.c2w a.c *
         Mettapedia.PLN.TruthValues.PeTTaLibPLNTruthFunctions.c2w b.c) := rfl
...
noncomputable def truthConjunctionHypergeometric (n a b : ℕ) : TV :=
  if n = 0 then
    ...
    let k := Mettapedia.PLN.RuleFamilies.FirstOrder.PLNConjunction.hypergeometricMode n a b
    ⟨(k : ℝ) / n,
      ENNReal.toReal (Mettapedia.PLN.RuleFamilies.FirstOrder.PLNConjunction.hypergeometricPMF n a b k)⟩
...
theorem truthConjunctionHypergeometric_strength_le_min_fraction
  ...
  have hmode : Mettapedia.PLN.RuleFamilies.FirstOrder.PLNConjunction.hypergeometricMode n a b ≤ min a b :=
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNConjunction.hypergeometricMode_in_range n a b ha hb
  have hmodeR :
      (Mettapedia.PLN.RuleFamilies.FirstOrder.PLNConjunction.hypergeometricMode n a b : ℝ) ≤ (min a b : ℝ) := by
...
theorem truthConjunctionConditional_strength_lifts_to_wm
  ...
  simpa [truthConjunctionConditionalConservative,
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNConjunction.conjunctionConditional] using
...
noncomputable def truthInversionBayesStrength (a b ab : TV) : ℝ :=
  Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDerivation.bayesInversion ab.s a.s b.s
...
noncomputable def truthEquivalenceToImplicationStrength (a b ab : TV) : ℝ :=
  Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.sim2inh ab.s a.s b.s
...
noncomputable def truthTransitiveSimilarityStrength (a b c ab bc : TV) : ℝ :=
  Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.transitiveSimilarity ab.s bc.s a.s b.s c.s
...
noncomputable def truthEvaluationImplicationStrength (a b c ab ac : TV) : ℝ :=
  Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.simpleDeductionStrengthFormula b.s a.s c.s ab.s ac.s
...
@[simp] theorem truthInversionBayesStrength_eq (a b ab : TV) :
    truthInversionBayesStrength a b ab = Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDerivation.bayesInversion ab.s a.s b.s := rfl

@[simp] theorem truthEquivalenceToImplicationStrength_eq (a b ab : TV) :
    truthEquivalenceToImplicationStrength a b ab =
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.sim2inh ab.s a.s b.s := rfl

@[simp] theorem truthTransitiveSimilarityStrength_eq (a b c ab bc : TV) :
    truthTransitiveSimilarityStrength a b c ab bc =
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.transitiveSimilarity ab.s bc.s a.s b.s c.s := rfl

@[simp] theorem truthEvaluationImplicationStrength_eq (a b c ab ac : TV) :
    truthEvaluationImplicationStrength a b c ab ac =
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.simpleDeductionStrengthFormula b.s a.s c.s ab.s ac.s := rfl

end Mettapedia.PLN.TruthValues.WMPLNJustifiedTruthFunctions
