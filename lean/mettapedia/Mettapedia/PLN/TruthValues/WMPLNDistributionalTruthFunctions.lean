...
import Mettapedia.PLN.Evidence.PLNJointEvidence
import Mettapedia.Logic.WMMarkovCanonical
import Mettapedia.PLN.TruthValues.WMPLNJustifiedTruthFunctions
import Mettapedia.PLN.WorldModel.WorldModelITV
import Mathlib.Data.Finset.Interval

noncomputable section

namespace Mettapedia.PLN.TruthValues.WMPLNDistributionalTruthFunctions
...
abbrev WTV := Mettapedia.PLN.TruthValues.PLNWeightTV.WTV
abbrev ITV := Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV
abbrev TV := Mettapedia.PLN.TruthValues.WMPLNJustifiedTruthFunctions.TV
abbrev BinaryContext := Mettapedia.PLN.Evidence.EvidenceClass.BinaryContext
abbrev IDMPredictiveContext := Mettapedia.PLN.WorldModel.PLNWorldModel.IDMPredictiveContext

abbrev JointEvidence (n : ℕ) := Mettapedia.PLN.Evidence.PLNJointEvidence.JointEvidence n
...
noncomputable def truthDirichletOverWorldsPropSTV
  ...
  Mettapedia.PLN.Evidence.EvidenceSTVBridge.evidenceToDeductionSTV κ
    (Mettapedia.PLN.Evidence.PLNJointEvidence.JointEvidence.propEvidence (n := n) (E := E) A)
...
noncomputable def truthDirichletOverWorldsLinkSTV
  ...
  Mettapedia.PLN.Evidence.EvidenceSTVBridge.evidenceToDeductionSTV κ
    (Mettapedia.PLN.Evidence.PLNJointEvidence.JointEvidence.linkEvidence (n := n) (E := E) A B)
...
noncomputable def truthDirichletOverWorldsPropWTV
  ...
  Mettapedia.PLN.Evidence.PLNJointEvidence.JointEvidence.propWTV κ E A
...
noncomputable def truthDirichletOverWorldsLinkWTV
  ...
  Mettapedia.PLN.Evidence.PLNJointEvidence.JointEvidence.linkWTV κ E A B
...
noncomputable def truthDirichletOverWorldsPropITVBayesExact95
  ...
  Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV.fromBayesCredible95ExactInvCDF
    (Mettapedia.PLN.Evidence.PLNJointEvidence.JointEvidence.propEvidence (n := n) (E := E) A) ctx
...
noncomputable def truthDirichletOverWorldsLinkITVBayesExact95
  ...
  Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV.fromBayesCredible95ExactInvCDF
    (Mettapedia.PLN.Evidence.PLNJointEvidence.JointEvidence.linkEvidence (n := n) (E := E) A B) ctx
...
@[simp] theorem truthDirichletOverWorldsPropWTV_eq_propWTV
    ...
    truthDirichletOverWorldsPropWTV κ E A =
      Mettapedia.PLN.Evidence.PLNJointEvidence.JointEvidence.propWTV κ E A := rfl
...
@[simp] theorem truthDirichletOverWorldsLinkWTV_eq_linkWTV
    ...
    truthDirichletOverWorldsLinkWTV κ E A B =
      Mettapedia.PLN.Evidence.PLNJointEvidence.JointEvidence.linkWTV κ E A B := rfl
...
@[simp] theorem truthDirichletOverWorldsPropITVBayesExact95_eq
    ...
    truthDirichletOverWorldsPropITVBayesExact95 ctx E A =
      Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV.fromBayesCredible95ExactInvCDF
        (Mettapedia.PLN.Evidence.PLNJointEvidence.JointEvidence.propEvidence (n := n) (E := E) A) ctx := rfl
...
@[simp] theorem truthDirichletOverWorldsLinkITVBayesExact95_eq
    ...
    truthDirichletOverWorldsLinkITVBayesExact95 ctx E A B =
      Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV.fromBayesCredible95ExactInvCDF
        (Mettapedia.PLN.Evidence.PLNJointEvidence.JointEvidence.linkEvidence (n := n) (E := E) A B) ctx := rfl
...
noncomputable def truthMarkovDirichletTransitionWTV
  ...
  Mettapedia.PLN.WorldModel.PLNWorldModel.BinaryWorldModel.queryWTV
...
noncomputable def truthMarkovDirichletTransitionITVBayesExact95
  ...
  Mettapedia.PLN.WorldModel.PLNWorldModel.BinaryWorldModel.queryITV
    (State := MarkovTransitionWMState k) (Query := MarkovTransitionQuery k)
    Mettapedia.PLN.WorldModel.PLNWorldModel.ITVSemantics.bayesCredibleExact95 ctx W q
...
noncomputable def truthMarkovDirichletPredictiveChainMass
    {k : ℕ} (hk : 0 < k)
    (prior : Fin k → Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.DirichletParams k)
    (prev : Fin k) (c : Mettapedia.UniversalAI.UniversalPrediction.TransCounts k)
    (ys : List (Fin k)) : ℝ≥0∞ :=
...
theorem truthMarkovDirichletPredictiveChainMass_le_one
    {k : ℕ} (hk : 0 < k) (prior : Fin k → Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet.DirichletParams k)
    (prev : Fin k) (c : Mettapedia.UniversalAI.UniversalPrediction.TransCounts k)
    (ys : List (Fin k)) :
...
noncomputable def truthConjunctionHypergeometricInterval (n a b : ℕ) : ITV :=
  ...
  let cred :=
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.clamp01
  ...
  Mettapedia.PLN.TruthValues.PLNIndefiniteTruthBridge.ofBoundsAndCredibility
    ...
    (by
      constructor
      · exact Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.clamp01_nonneg _
      · exact Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.clamp01_le_one _)
...
noncomputable def hypergeometricClippedCountMass (n a b : ℕ) : ℝ≥0∞ :=
  (hypergeometricClippedCountWindow n a b).sum (fun k => Mettapedia.PLN.RuleFamilies.FirstOrder.PLNConjunction.hypergeometricPMF n a b k)
...
noncomputable def hypergeometricClippedCountCDFMass (n a b k : ℕ) : ℝ≥0∞ :=
  ((hypergeometricClippedCountWindow n a b).filter (fun i => i ≤ k)).sum
    (fun i => Mettapedia.PLN.RuleFamilies.FirstOrder.PLNConjunction.hypergeometricPMF n a b i)
...
theorem hypergeometricPMF_ne_top (n a b k : ℕ) :
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNConjunction.hypergeometricPMF n a b k ≠ ⊤ := by
  unfold Mettapedia.PLN.RuleFamilies.FirstOrder.PLNConjunction.hypergeometricPMF
...
end Mettapedia.PLN.TruthValues.WMPLNDistributionalTruthFunctions
