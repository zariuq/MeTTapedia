...
namespace Mettapedia.PLN.InferenceControl.Counterexamples.PLNLargeScaleInferenceCounterexamples

open Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInclusionExclusionIdentifiability
...
theorem ch9_poolingUnique_of_externalBayes_totalAdd
    (poolE : Mettapedia.PLN.Evidence.EvidenceQuantale.BinaryEvidence →
...
end Mettapedia.PLN.InferenceControl.Counterexamples.PLNLargeScaleInferenceCounterexamples
