...
namespace Mettapedia.PLN.Core.PLNEndToEnd
...
variable [_root_.Mettapedia.PLN.Evidence.EvidenceClass.EvidenceType State]
variable [PLNWorldModel.BinaryWorldModel State Query]
...
end Mettapedia.PLN.Core.PLNEndToEnd
