...
import Mettapedia.PLN.Evidence.PLNJointEvidenceProbability
...
- Distributional-to-Kyburg higher-order reduction bridge
  (`PLN/Bridges/ProbabilityTheory/PLNKyburgReduction`)
...
- **k-NN bridge**: `PLN_hplusPos_eq_knnRelevance` (`KNN_PLNBridge:111`)
- **Ranking transfer**: `pln_inherits_nb_optimal`, `pln_inherits_nb_ranking`,
  `pln_inherits_knn_ranking`, `pln_knn_ranking_eq` (`Optimality:333–369`)
...
namespace Mettapedia.PLN.Core.PLNCore

open Mettapedia.PLN.WorldModel

end Mettapedia.PLN.Core.PLNCore
