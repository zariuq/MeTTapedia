...
- `PLNDeduction.STV`
- `Mettapedia.PLN.TruthValues.Distributional.SimpleTruthValue`
...
namespace Mettapedia.PLN.Evidence.EvidenceSTVBridge
...
end Mettapedia.PLN.Evidence.EvidenceSTVBridge
