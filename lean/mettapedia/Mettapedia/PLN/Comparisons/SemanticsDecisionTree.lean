...
import Mettapedia.NARS.Bridges.PLN.SecondOrderProbability
...
namespace Mettapedia.PLN.Comparisons.SemanticsDecisionTree
...
def keyReferenceSymbols : List String :=
  ...
  , "Mettapedia.NARS.Bridges.PLN.SecondOrderProbability.truthRevisionCore_toEvidence"
  , "Mettapedia.NARS.Bridges.PLN.EvidenceTranslation.nars_revision_is_evidence_aggregation"
  , "Mettapedia.NARS.TruthFunctions.truthRevision"
  ]

/-- Operational note: NARS mirror revision adds explicit clamp guards. -/
theorem nars_revision_has_clamps
    (t1 t2 : Mettapedia.NARS.TruthFunctions.TV) :
    (Mettapedia.NARS.TruthFunctions.truthRevision t1 t2).f ≤ 1 ∧
    (Mettapedia.NARS.TruthFunctions.truthRevision t1 t2).c ≤ 0.99 := by
  unfold Mettapedia.NARS.TruthFunctions.truthRevision
  constructor <;> simp
...
end Mettapedia.PLN.Comparisons.SemanticsDecisionTree
