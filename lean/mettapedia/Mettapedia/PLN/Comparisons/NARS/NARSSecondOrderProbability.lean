...
We intentionally keep `Mettapedia.PLN.Comparisons.NARS.NARSMettaTruthFunctions` as a faithful mirror of
...
namespace Mettapedia.PLN.Comparisons.NARS.NARSSecondOrderProbability
...
theorem toEvidenceWithK_one_eq_bridge_toEvidence (t : TV) (ht : IsProbTV t) :
    TV.toEvidenceWithK 1 t ht.c_lt_one = Mettapedia.PLN.Comparisons.NARS.NARSEvidenceBridge.TV.toEvidence t := by
  ...
  ext <;>
    simp [TV.toEvidenceWithK, Mettapedia.PLN.Comparisons.NARS.NARSEvidenceBridge.TV.toEvidence, BinaryEvidence.ofSTV,
      hdiv, ENNReal.ofReal_mul ht.f_nonneg, ENNReal.ofReal_mul h1mf]

theorem toNARSTVWithK_one_eq_bridge_toNARSTV (e : BinaryEvidence) :
    BinaryEvidence.toNARSTVWithK 1 e = Mettapedia.PLN.Comparisons.NARS.NARSEvidenceBridge.BinaryEvidence.toNARSTV e := by
  rfl
...
end Mettapedia.PLN.Comparisons.NARS.NARSSecondOrderProbability
