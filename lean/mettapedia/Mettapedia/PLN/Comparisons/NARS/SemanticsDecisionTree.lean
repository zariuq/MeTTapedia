...
import Mettapedia.PLN.Comparisons.NARS.NARSSecondOrderProbability
...
namespace Mettapedia.PLN.Comparisons.NARS.SemanticsDecisionTree
...
def keyReferenceSymbols : List String :=
  ...
  , "Mettapedia.ProbabilityTheory.Hypercube.dempsterShafer_quantale"
  , "Mettapedia.ProbabilityTheory.Hypercube.dempsterShafer_has_interval_pln"
  , "Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDerivation.pln_deduction_from_total_probability"
  , "Mettapedia.PLN.RuleFamilies.FirstOrder.PLNBayesNetFastRules.chainBN_plnDeductionStrength_exact"
  , "Mettapedia.PLN.RuleFamilies.FirstOrder.PLNXiDerivedBNRules.xi_deduction_queryStrength_eq_plnDeduction_of_chainBN"
  , "Mettapedia.PLN.Comparisons.NARS.NARSSecondOrderProbability.truthRevisionCore_toEvidence"
  , "Mettapedia.PLN.Comparisons.NARS.NARSEvidenceBridge.nars_revision_is_evidence_aggregation"
  , "Mettapedia.PLN.Comparisons.NARS.NARSMettaTruthFunctions.truthRevision"
  ]

/-- Operational note: NARS mirror revision adds explicit clamp guards. -/
theorem nars_revision_has_clamps
    (t1 t2 : Mettapedia.PLN.Comparisons.NARS.NARSMettaTruthFunctions.TV) :
    (Mettapedia.PLN.Comparisons.NARS.NARSMettaTruthFunctions.truthRevision t1 t2).f ≤ 1 ∧
    (Mettapedia.PLN.Comparisons.NARS.NARSMettaTruthFunctions.truthRevision t1 t2).c ≤ 0.99 := by
  unfold Mettapedia.PLN.Comparisons.NARS.NARSMettaTruthFunctions.truthRevision
  constructor <;> simp
...
end Mettapedia.PLN.Comparisons.NARS.SemanticsDecisionTree
