...
namespace Mettapedia.PLN.RuleFamilies.FirstOrder.PLNXiDerivedBNRules
...
open Mettapedia.PLN.Bridges.ProbabilityTheory.BayesNet.PLNBNCompilation.ChainExample
...
open Mettapedia.PLN.RuleFamilies.FirstOrder.PLNBayesNetFastRules
open Mettapedia.PLN.RuleFamilies.FirstOrder.PLNBayesNetFastRules.ChainBN
open Mettapedia.PLN.RuleFamilies.FirstOrder.PLNBayesNetFastRules.ChainBN.Deduction
open MeasureTheory
...
theorem plnStrength_lt_one (n_pos n_neg : ℕ) (hNeg : n_neg ≠ 0) :
  ...
  unfold plnStrength Mettapedia.PLN.Evidence.EvidenceCounts.plnStrength
  split
  · exact zero_lt_one
  · rename_i hTotal
...
open Mettapedia.PLN.Bridges.ProbabilityTheory.BayesNet.PLNBNCompilation.ForkExample
...
open Mettapedia.PLN.Bridges.ProbabilityTheory.BayesNet.PLNBNCompilation.ColliderExample
...
theorem plnAbductionStrength_not_exact_collider :
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDerivation.plnAbductionStrength 1 1 (1/2 : ℝ) (3/4 : ℝ) (1/2 : ℝ) ≠ (1/2 : ℝ) := by
  unfold Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDerivation.plnAbductionStrength Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDerivation.bayesInversion Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDerivation.plnDeductionStrength
  norm_num
...
theorem plnAbductionStrength_exact_of_screeningOff
  ...
  unfold Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDerivation.plnAbductionStrength Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDerivation.bayesInversion
  ...
  exact Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDerivation.pln_deduction_from_total_probability μ hA hB hC
    hA_pos hB_pos hB_lt1 hAB_pos hABc_pos h_pos_indep h_neg_indep

end Mettapedia.PLN.RuleFamilies.FirstOrder.PLNXiDerivedBNRules


namespace Mettapedia.PLN.RuleFamilies.FirstOrder.PLNXiDerivedBNRules.Typed
...
abbrev MeTTaSortTag := Mettapedia.PLN.Bridges.Languages.PLNWMOSLFBridgeTyped.MeTTaTypeOf.SortTag
...
noncomputable def xi_deduction_rewrite_of_chainBN_sigma_concrete
  ...
  xi_deduction_rewrite_of_chainBN_sigma
    (Mettapedia.PLN.RuleFamilies.FirstOrder.PLNXiDerivedBNRules.xi_deduction_rewrite_of_chainBN
...
noncomputable def xi_sourceRule_rewrite_of_forkBN_sigma_concrete
  ...
  xi_sourceRule_rewrite_of_forkBN_sigma
    (Mettapedia.PLN.RuleFamilies.FirstOrder.PLNXiDerivedBNRules.xi_sourceRule_rewrite_of_forkBN
      (valA := valA) (valB := valB) (valC := valC) hLMarkov)
...
noncomputable def xi_sinkRule_rewrite_of_colliderBN_sigma_concrete
  ...
  xi_sinkRule_rewrite_of_colliderBN_sigma
    (Mettapedia.PLN.RuleFamilies.FirstOrder.PLNXiDerivedBNRules.xi_sinkRule_rewrite_of_colliderBN
...
end Mettapedia.PLN.RuleFamilies.FirstOrder.PLNXiDerivedBNRules.Typed
