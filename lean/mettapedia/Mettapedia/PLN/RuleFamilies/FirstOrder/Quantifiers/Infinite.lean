...
namespace Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.Infinite
...
theorem diagonal_constantTrue :
  ...
  unfold pTrue Mettapedia.PLN.RuleFamilies.QuantaleSemantics.PBit.isTrue
...
theorem diagonal_constantFalse :
  ...
  intro ⟨h1, _⟩
  unfold Mettapedia.PLN.RuleFamilies.QuantaleSemantics.PBit.isTrue at h1
...
def SatisfyingSetInf.ofFinitary {U : Type*} [Fintype U]
    (S : Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.SatisfyingSet U) : SatisfyingSetInf U :=
  ⟨S.pred⟩
...
end Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.Infinite
