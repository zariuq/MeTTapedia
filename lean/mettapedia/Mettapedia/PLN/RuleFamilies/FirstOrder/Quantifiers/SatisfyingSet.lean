...
theorem diagonal_constantTrue :
  ...
  · intro _
    rw [mem_diagonal]
    constructor
    · unfold constantTrue pTrue Mettapedia.PLN.RuleFamilies.QuantaleSemantics.PBit.isTrue
...
theorem diagonal_constantFalse :
  ...
  constructor
  · intro h
    unfold Mettapedia.PLN.RuleFamilies.QuantaleSemantics.PBit.isTrue at h
