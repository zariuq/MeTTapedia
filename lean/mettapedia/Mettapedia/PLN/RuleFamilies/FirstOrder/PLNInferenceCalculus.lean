...
namespace Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceCalculus
...
/-- Alias for clarity -/
abbrev TV := Mettapedia.PLN.Evidence.EvidenceSTVBridge.DeductionSTV
...
end Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceCalculus
