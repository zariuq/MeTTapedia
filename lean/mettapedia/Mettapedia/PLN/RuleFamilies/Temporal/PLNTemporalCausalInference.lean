import Mettapedia.PLN.RuleFamilies.Temporal.PLNTemporal
...
namespace Mettapedia.PLN.RuleFamilies.Temporal.PLNTemporalCausalInference

open Mettapedia.PLN.RuleFamilies.Temporal.TemporalPredicate

def TemporalPred (Domain : Type u) (Time : Type v) :=
  Mettapedia.PLN.RuleFamilies.Temporal.TemporalPredicate Domain Time
...
open Mettapedia.PLN.RuleFamilies.Temporal.PLNProbabilisticEventCalculus
...
end Mettapedia.PLN.RuleFamilies.Temporal.PLNTemporalCausalInference
