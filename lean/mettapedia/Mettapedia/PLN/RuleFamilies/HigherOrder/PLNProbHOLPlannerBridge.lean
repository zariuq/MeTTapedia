...
import Mettapedia.PLN.Bridges.HOL.Probabilistic.BenchmarkBeliefBridge
...
- `PLN/Bridges/HOL/Probabilistic/BenchmarkBridge.lean`: semantic hierarchical benchmark state
- `PLN/Bridges/HOL/Probabilistic/BenchmarkBeliefBridge.lean`: derived LI-style belief view
...
namespace Mettapedia.PLN.RuleFamilies.HigherOrder


open Mettapedia.PLN.RuleFamilies.HigherOrder.PLNGuardedHigherOrderSemantics
open Mettapedia.PLN.RuleFamilies.HigherOrder.PLNMixedModeChainComposition
open Mettapedia.PLN.RuleFamilies.HigherOrder.PLNProbGuardedAdmissibilityDemo
open Mettapedia.PLN.RuleFamilies.HigherOrder.PLNProofCarryingContractionDemo
...
open Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge
...
noncomputable def HODeductionPlannerShadow.jointInterval
    ...
    Mettapedia.PLN.TruthValues.PLNTruthTower.TypedITV
      (Mettapedia.PLN.TruthValues.PLNTruthTower.credalEnvelopeITVSemantics
        Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.DeductionAtom) :=
...
end Mettapedia.PLN.RuleFamilies.HigherOrder
