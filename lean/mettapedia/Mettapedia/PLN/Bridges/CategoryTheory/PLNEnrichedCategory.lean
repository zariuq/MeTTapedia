...
namespace Mettapedia.PLN.Bridges.CategoryTheory.PLNEnrichedCategory
...
theorem enriched_composition_inequality
  ...
  -- strength-level packaging (`PLNQuantaleConnectionLegacy`).
...
end Mettapedia.PLN.Bridges.CategoryTheory.PLNEnrichedCategory
