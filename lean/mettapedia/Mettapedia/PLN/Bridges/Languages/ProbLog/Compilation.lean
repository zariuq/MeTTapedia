...
- worldToAssignment is in Mettapedia.PLN.Core.CompletePLN
-/
...
namespace Mettapedia.PLN.Bridges.Languages.ProbLog.Compilation
...
end Mettapedia.PLN.Bridges.Languages.ProbLog.Compilation
