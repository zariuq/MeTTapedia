...
namespace Mettapedia.PLN.Bridges.Languages.PLNWMOSLFBridgeITVTyped
...
abbrev ITVCoord := Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV → ℝ
...
noncomputable def wmITVAtomSemQSigma
    ...
    String → Pattern → Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV :=
  fun a p =>
...
end Mettapedia.PLN.Bridges.Languages.PLNWMOSLFBridgeITVTyped
