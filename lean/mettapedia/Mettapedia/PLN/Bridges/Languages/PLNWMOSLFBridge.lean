...
`Mettapedia.PLN.Evidence.EvidenceQuantale`; `OSLFEvidenceSemantics` provides the
...
namespace Mettapedia.PLN.Bridges.Languages.PLNWMOSLFBridge
...
end Mettapedia.PLN.Bridges.Languages.PLNWMOSLFBridge
...
namespace Mettapedia.PLN.Bridges.Languages.PLNWMOSLFBridgeTyped
...
end Mettapedia.PLN.Bridges.Languages.PLNWMOSLFBridgeTyped
