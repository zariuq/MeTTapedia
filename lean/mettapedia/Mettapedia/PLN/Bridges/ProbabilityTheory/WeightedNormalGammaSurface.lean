...
namespace Mettapedia.PLN.Bridges.ProbabilityTheory.WeightedNormalGammaSurface
...
def weightedGaussianStatistic
    ...
    (value : Obs → Query → ℝ) :
    Mettapedia.PLN.WorldModel.SufficientStatisticSurface Obs Query WeightedNormalGammaEvidence where
...
end Mettapedia.PLN.Bridges.ProbabilityTheory.WeightedNormalGammaSurface
