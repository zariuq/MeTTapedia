...
@[simp] theorem ofDiscrete_zero :
    ofDiscrete Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.NormalGammaEvidence.zero = zero := by
  ext
  · simp [ofDiscrete, zero, Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.NormalGammaEvidence.zero]
  · simp [ofDiscrete, zero, Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.NormalGammaEvidence.zero]
  · simp [ofDiscrete, zero, Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.NormalGammaEvidence.zero]

@[simp] theorem ofDiscrete_single (x : ℝ) :
    ofDiscrete (Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.NormalGammaEvidence.single x) = single (1 : NNReal) x := by
  ext
  · norm_num [ofDiscrete, Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.NormalGammaEvidence.single, single]
  · norm_num [ofDiscrete, Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.NormalGammaEvidence.single, single]
  · norm_num [ofDiscrete, Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.NormalGammaEvidence.single, single]
...
theorem realizable_ofDiscrete (e : DiscreteNormalGammaEvidence)
    (h : Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.NormalGammaEvidence.Realizable e) :
...
theorem toMean_ofDiscrete (e : DiscreteNormalGammaEvidence) :
    (ofDiscrete e).toMean =
      Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.NormalGammaEvidence.toMean e := by
  unfold toMean Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.NormalGammaEvidence.toMean
  by_cases hn : e.n = 0
  · simp [ofDiscrete, hn]
  · have hnr : (e.n : ℝ) ≠ 0 := by
      exact_mod_cast hn
...
theorem sumSquaredDeviations_ofDiscrete (e : DiscreteNormalGammaEvidence) :
    (ofDiscrete e).sumSquaredDeviations =
      Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.NormalGammaEvidence.sumSquaredDeviations e := by
  unfold sumSquaredDeviations
  unfold Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.NormalGammaEvidence.sumSquaredDeviations
  by_cases hn : e.n = 0
  · simp [ofDiscrete, hn]
  · have hnr : (e.n : ℝ) ≠ 0 := by
      exact_mod_cast hn
...
theorem toConfidence_ofDiscrete (e : DiscreteNormalGammaEvidence) (κ : ℝ) :
    (ofDiscrete e).toConfidence κ =
      Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.NormalGammaEvidence.toConfidence e κ := by
  unfold toConfidence
  unfold Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.NormalGammaEvidence.toConfidence
  simp [ofDiscrete]
...
theorem posterior_ofDiscrete_eq (prior : NormalGammaPrior) (e : DiscreteNormalGammaEvidence) :
    posterior prior (ofDiscrete e) = Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.posterior prior e := by
  ext
  · by_cases hn : e.n = 0
    · simp [posterior, ofDiscrete, Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.posterior, hn]
    · have hnr : (e.n : ℝ) ≠ 0 := by
        exact_mod_cast hn
      simp [posterior, ofDiscrete, Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.posterior, hn, hnr]
  · simp [posterior, ofDiscrete, Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.posterior]
  · simp [posterior, ofDiscrete, Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.posterior]
  · by_cases hn : e.n = 0
    · simp [posterior, ofDiscrete, Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceNormalGamma.posterior,
        hn]
...
end Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceWeightedNormalGamma
