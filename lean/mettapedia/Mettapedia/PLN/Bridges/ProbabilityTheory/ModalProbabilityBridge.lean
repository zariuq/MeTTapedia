...
namespace Mettapedia.PLN.Bridges.ProbabilityTheory.ModalProbabilityBridge

open Mettapedia.ProbabilityTheory.Hypercube
open Mettapedia.PLN.WorldModel.WMHypercubeClassification
...
-- total order as `Mettapedia.PLN.Bridges.GSLT.WeightMapBridge.regimeWeaker`:
...
end Mettapedia.PLN.Bridges.ProbabilityTheory.ModalProbabilityBridge
