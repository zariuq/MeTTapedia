...
noncomputable abbrev uniformPosteriorMean (n_pos n_neg : ℕ) : ℝ :=
  Mettapedia.PLN.Evidence.EvidenceCounts.uniformPosteriorMean n_pos n_neg

/-- Jeffreys prior posterior mean -/
noncomputable abbrev jeffreysPosteriorMean (n_pos n_neg : ℕ) : ℝ :=
  Mettapedia.PLN.Evidence.EvidenceCounts.jeffreysPosteriorMean n_pos n_neg
...
theorem plnStrength_eq_improper_mean (n_pos n_neg : ℕ) (h : n_pos + n_neg ≠ 0) :
  ...
  exact Mettapedia.PLN.Evidence.EvidenceCounts.plnStrength_eq_improper_mean n_pos n_neg h
...
theorem strength_vs_uniform_difference (n_pos n_neg : ℕ) (h : n_pos + n_neg ≠ 0) :
  ...
  have habs_repr :
    ...
    have huniform :
      ...
      simp [uniformPosteriorMean, Mettapedia.PLN.Evidence.EvidenceCounts.uniformPosteriorMean, nR, add_assoc]
...
theorem strength_vs_jeffreys_difference (n_pos n_neg : ℕ) (h : n_pos + n_neg ≠ 0) :
  ...
  have hmean : jeffreysPosteriorMean n_pos n_neg = ((n_pos : ℝ) + (1 / 2 : ℝ)) / (nR + 1) := by
    ...
    simp [jeffreysPosteriorMean, Mettapedia.PLN.Evidence.EvidenceCounts.jeffreysPosteriorMean, nR, hhalf, add_assoc]
...
theorem prior_matters_example :
  ...
  constructor
  · simp [predHaldane, plnStrength, Mettapedia.PLN.Evidence.EvidenceCounts.plnStrength]
  constructor
  · simp [predJeffreys, jeffreysPosteriorMean,
      Mettapedia.PLN.Evidence.EvidenceCounts.jeffreysPosteriorMean]
    norm_num
...
end Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta
