...
namespace Mettapedia.PLN.Bridges.ProbabilityTheory.BayesNet.PLNForkBNLocalMarkovPackage
...
theorem forkBNLocalMarkovPackage_of_xiAlias
    ...
    [∀ v : Three, StandardBorelSpace (forkBN.stateSpace v)]
    [StandardBorelSpace forkBN.JointSpace]
    (hLM : Mettapedia.PLN.RuleFamilies.FirstOrder.PLNXiDerivedBNRules.ForkBNLocalMarkovAll) :
...
theorem xiAlias_of_forkBNLocalMarkovPackage
    ...
    [StandardBorelSpace forkBN.JointSpace]
    [ForkBNLocalMarkovPackage] :
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNXiDerivedBNRules.ForkBNLocalMarkovAll :=
  ForkBNLocalMarkovPackage.allLocalMarkov

end Mettapedia.PLN.Bridges.ProbabilityTheory.BayesNet.PLNForkBNLocalMarkovPackage
