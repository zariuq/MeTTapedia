...
namespace Mettapedia.PLN.Bridges.ProbabilityTheory.BayesNet.PLNColliderBNLocalMarkovPackage
...
theorem colliderBNLocalMarkovPackage_of_xiAlias
    ...
    [∀ v : Three, StandardBorelSpace (colliderBN.stateSpace v)]
    [StandardBorelSpace colliderBN.JointSpace]
    (hLM : Mettapedia.PLN.RuleFamilies.FirstOrder.PLNXiDerivedBNRules.ColliderBNLocalMarkovAll) :
...
theorem xiAlias_of_colliderBNLocalMarkovPackage
    ...
    [StandardBorelSpace colliderBN.JointSpace]
    [ColliderBNLocalMarkovPackage] :
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNXiDerivedBNRules.ColliderBNLocalMarkovAll :=
  ColliderBNLocalMarkovPackage.allLocalMarkov

end Mettapedia.PLN.Bridges.ProbabilityTheory.BayesNet.PLNColliderBNLocalMarkovPackage
