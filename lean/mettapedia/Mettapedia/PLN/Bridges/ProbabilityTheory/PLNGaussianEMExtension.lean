...
- `WeightedNormalGammaAdapter` connects that carrier to the generic WM layer
...
- `GaussianMStepResult`
- `SufficientStatisticEncoder.weightedGaussianStatistic`
- `SufficientStatisticEncoder.indicatorGaussianStatistic_aggregate_eq_ofDiscrete_filter`
- `SufficientStatisticEncoder.indicatorGaussianStatistic_posterior_eq_gaussian_filter`
