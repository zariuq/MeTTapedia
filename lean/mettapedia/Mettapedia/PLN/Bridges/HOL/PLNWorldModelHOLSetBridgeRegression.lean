...
namespace Mettapedia.PLN.Bridges.HOL.PLNWorldModelHOLSetBridgeRegression
...
open Mettapedia.PLN.Bridges.HOL.PLNWorldModelHOLSetBridge
open scoped ENNReal
...
theorem hol_native_and_comm_queryEq_fixture :
  ...
  intro S
  have hpoint :=
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSoundness.holProvIff_implies_pointwise
      (Base := SetBaseTy) (Const := SetConst)
...
theorem hol_native_not_and_comm_queryEq_fixture :
  ...
  have hpoint :=
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSoundness.holProvIff_implies_pointwise
      ...
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLRules.holProvIff_not
        (Base := SetBaseTy) (Const := SetConst)
        (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLRules.holProvIff_and_comm
          (Base := SetBaseTy) (Const := SetConst)
          holNativeHigherOrderRefl (.top : SetHOLQuery)))
...
theorem hol_native_and_left_multiset_fixture
  ...
  have himp :
    ...
    intro S
    have hpoint :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSoundness.holProvImp_implies_pointwise
        (Base := SetBaseTy) (Const := SetConst)
        (φ := .and holNativeHigherOrderRefl (.top : SetHOLQuery))
        (ψ := holNativeHigherOrderRefl)
        (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLRules.holProvImp_and_left
          (Base := SetBaseTy) (Const := SetConst)
  ...
  have himp :
    ...
    have hpoint :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSoundness.holProvImp_implies_pointwise
        ...
        (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLRules.holProvImp_or_intro_left
          (Base := SetBaseTy) (Const := SetConst)
          holNativeHigherOrderRefl (.top : SetHOLQuery))
        (Mettapedia.Logic.HOL.Semantics.SetBased.ofPointed S)
    change
...
end Mettapedia.PLN.Bridges.HOL.PLNWorldModelHOLSetBridgeRegression
