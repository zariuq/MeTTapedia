...
This PLN/HOL bridge module relates the logical-induction-ready day interface
back to the existing static HOL world-model semantics.
...
namespace Mettapedia.PLN.Bridges.HOL.LogicalInduction
...
end Mettapedia.PLN.Bridges.HOL.LogicalInduction
