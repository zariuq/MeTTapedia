...
namespace Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge
...
theorem predicateFullInheritanceStrength_nonneg
  ...
  exact
    Mettapedia.KR.ConceptGeometry.ExtensionalIntensionalDivergence.fullInheritanceStrength_nonneg
      (predicateInterpretation (Base := Base) (Const := Const) M σ) p q
...
theorem predicateFullInheritanceStrength_le_one
  ...
  exact
    Mettapedia.KR.ConceptGeometry.ExtensionalIntensionalDivergence.fullInheritanceStrength_le_one
      (predicateInterpretation (Base := Base) (Const := Const) M σ) p q
...
theorem predicateFullInheritanceStrength_eq_one_iff
  ...
  exact
    Mettapedia.KR.ConceptGeometry.ExtensionalIntensionalDivergence.fullInheritanceStrength_eq_one_iff
...
end Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge
