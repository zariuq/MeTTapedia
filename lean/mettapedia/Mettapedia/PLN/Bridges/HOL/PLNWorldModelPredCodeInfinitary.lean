...
namespace Mettapedia.PLN.Bridges.HOL.PLNWorldModelPredCodeInfinitary
...
abbrev BasePredCodeQuery (U : Type*) := Mettapedia.PLN.Bridges.HOL.PLNWorldModelPredCode.PredCodeQuery U
abbrev PointedPredCode (U : Type*) := Mettapedia.PLN.Bridges.HOL.PLNWorldModelPredCode.PointedPredCode U
...
end Mettapedia.PLN.Bridges.HOL.PLNWorldModelPredCodeInfinitary
