...
namespace Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCanary

open Mettapedia.Logic.HOL
open Mettapedia.Logic.HOL.Probabilistic
open Mettapedia.PLN.Bridges.HOL.Probabilistic
...
def fixturePredicateObjectEquivPUnit :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.PredicateObject
...
theorem canary_hol_higherOrderRefl_provable :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCore.HOLProvable
      (Const := FixtureConst) fixtureHigherOrderRefl :=
  .allI (.eqRefl (.var .vz))

theorem canary_hol_higherOrderRefl_singleton_strength_one :
    BinaryWorldModel.queryStrength
        (State := Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCore.HOLState FixtureBase FixtureConst)
        (Query := Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCore.HOLQuery
          (Base := FixtureBase) FixtureConst)
        ({fixtureModel} :
          Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCore.HOLState FixtureBase FixtureConst)
  ...
  exact
    Mettapedia.PLN.Bridges.HOL.PLNWorldModelHOL.queryStrength_singleton_of_satisfies
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureModel fixtureHigherOrderRefl hsatisfies

theorem canary_hol_id_eta_eq :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLRules.HOLProvEq
      (Base := FixtureBase) (Const := FixtureConst)
      (.lam (.app (weaken (Base := FixtureBase) (σ := FixtureObjTy) fixtureId) (.var .vz)))
      fixtureId :=
  Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLRules.holProvEq_eta
    (Base := FixtureBase) (Const := FixtureConst) fixtureId

theorem canary_hol_top_imp_top_link
    (W : Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCore.HOLState FixtureBase FixtureConst) :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLLinkBridge.holdsLinkWM
      (Base := FixtureBase) (Const := FixtureConst) W (.top : ClosedFormula FixtureConst) .top :=
  Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLLinkBridge.holdsLinkWM_mono_of_holProvImp
    (Base := FixtureBase) (Const := FixtureConst)
    (φ := (.top : ClosedFormula FixtureConst))
    (ψ := (.top : ClosedFormula FixtureConst))
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCore.holProvImp_refl (.top : ClosedFormula FixtureConst))
    W

theorem canary_hol_top_iff_top_queryEq :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLConsequence.HOLWMQueryEq
      (Base := FixtureBase) (Const := FixtureConst)
      (.top : ClosedFormula FixtureConst) .top :=
  Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLConsequence.holProvIff_to_WMQueryEq
    (Base := FixtureBase) (Const := FixtureConst)
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLRules.holProvIff_refl
      (Base := FixtureBase) (Const := FixtureConst)
...
theorem canary_hol_and_comm_queryEq :
  ...
  Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLConsequence.holProvIff_to_WMQueryEq
    (Base := FixtureBase) (Const := FixtureConst)
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLRules.holProvIff_and_comm
      (Base := FixtureBase) (Const := FixtureConst)
...
theorem canary_hol_or_comm_queryEq :
  ...
  Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLConsequence.holProvIff_to_WMQueryEq
    (Base := FixtureBase) (Const := FixtureConst)
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLRules.holProvIff_or_comm
      (Base := FixtureBase) (Const := FixtureConst)
      (.top : ClosedFormula FixtureConst) .bot)
...
theorem canary_hol_imp_mono_link
  ...
  Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLLinkBridge.holdsLinkWM_mono_of_holProvImp
    ...
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLRules.holProvImp_imp_mono
      (Base := FixtureBase) (Const := FixtureConst)
      (φ := (.top : ClosedFormula FixtureConst))
      (ψ := (.bot : ClosedFormula FixtureConst))
      (χ := (.top : ClosedFormula FixtureConst))
      (δ := (.top : ClosedFormula FixtureConst))
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCore.holProvImp_top
        (.bot : ClosedFormula FixtureConst))
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCore.holProvImp_refl
        (.top : ClosedFormula FixtureConst)))
    W
...
theorem canary_hol_not_queryEq_top_bot :
  ...
  have hbot :
    ...
    Mettapedia.PLN.Bridges.HOL.PLNWorldModelHOL.queryStrength_singleton_of_not_satisfies
...
theorem canary_hol_not_singletonConsequence_top_bot :
    ¬ ∀ M : HenkinModel FixtureBase FixtureConst,
      BinaryWorldModel.queryStrength
          ...
          (Query := Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCore.HOLQuery
            (Base := FixtureBase) FixtureConst)
          ({M} : Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCore.HOLState FixtureBase FixtureConst)
          (.top : ClosedFormula FixtureConst) ≤
        BinaryWorldModel.queryStrength
          (State := Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCore.HOLState FixtureBase FixtureConst)
          (Query := Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCore.HOLQuery
...
def fixturePredTopBotIff : ClosedFormula FixtureConst :=
  Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateIffFormula
    (Base := FixtureBase) (Const := FixtureConst)
    FixtureObjTy fixturePredTop fixturePredBot

def fixturePredTopBotImp : ClosedFormula FixtureConst :=
  Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateImpFormula
    (Base := FixtureBase) (Const := FixtureConst)
    FixtureObjTy fixturePredTop fixturePredBot
...
theorem canary_hol_predicateTop_inherits_predicateTop :
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateInterpretation
      (Base := FixtureBase) (Const := FixtureConst) fixtureModel FixtureObjTy).Inherits
        fixturePredTop fixturePredTop := by
  exact
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.holProvable_predicateImpFormula_implies_inherits
      (Base := FixtureBase) (Const := FixtureConst)
      FixtureObjTy fixturePredTop fixturePredTop
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.holProvable_predicateImpFormula_refl
  ...
  have hModel :
      HenkinModel.models fixtureModel
        (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateImpFormula
          (Base := FixtureBase) (Const := FixtureConst)
          FixtureObjTy fixturePredTop fixturePredBot) :=
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateInterpretation_inherits_iff_models_predicateImpFormula
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureModel FixtureObjTy fixturePredTop fixturePredBot).1 hInh
  have hPointwise :=
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.models_predicateImpFormula_iff
      (Base := FixtureBase) (Const := FixtureConst)
...
theorem canary_hol_predicateTop_mutualInherits_predicateTop :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateMutualInheritsAt
      (Base := FixtureBase) (Const := FixtureConst)
...
theorem canary_hol_empty_predicateTop_mutualInherits_predicateBot :
  ...
  rw [Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateMutualInheritsAt_iff_models_predicateIffFormula]
...
theorem canary_hol_predicateForAllTop_models :
    HenkinModel.models fixtureModel
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateForAllFormula
        (Base := FixtureBase) (Const := FixtureConst)
        FixtureObjTy fixturePredTop) := by
  exact
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.models_predicateForAllFormula_iff
      (Base := FixtureBase) (Const := FixtureConst)
...
theorem canary_hol_predicateExistsTop_models :
    HenkinModel.models fixtureModel
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateExistsFormula
        (Base := FixtureBase) (Const := FixtureConst)
        FixtureObjTy fixturePredTop) := by
  exact
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.models_predicateExistsFormula_iff
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureModel FixtureObjTy fixturePredTop).2
...
theorem canary_hol_predicateSimilarityTopTop_strength_one :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateSimilarityStrength
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureModel FixtureObjTy fixturePredTop fixturePredTop = 1 :=
  Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateSimilarityStrength_eq_one_of_mutualInherits
    (Base := FixtureBase) (Const := FixtureConst)
...
theorem canary_hol_predicateSimilarityTopBot_strength_zero :
  ...
  Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateSimilarityStrength_eq_zero_of_not_inherits_left
    (Base := FixtureBase) (Const := FixtureConst)
...
noncomputable def fixtureSharpFourFifthsParams :
    Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.FuzzyQuantifierParams where
  ε := 0
  LPC := 0
  UPC := 1
  PCL := 4 / 5
...
noncomputable def fixtureSingletonFourFifthsCapacity :
    Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.FuzzyCapacity FixtureSingletonPredObj where
  cap := by
    classical
    intro A
...
theorem canary_hol_singleton_nearOneCut_top_eq_univ :
    Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.nearOneCutInf
        fixtureSharpFourFifthsParams.toInf
        (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLQuantifierBridge.predicateCrispProfileInf
          (Base := FixtureBase) (Const := FixtureConst)
  ...
  simp [Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.nearOneCutInf,
    Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.nearOneInf,
    fixtureSharpFourFifthsParams,
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLQuantifierBridge.predicateCrispProfileInf,
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLQuantifierBridge.predicateCrispProfile,
    hxTop',
    fixturePredTop]
...
theorem canary_hol_singleton_weightedNearOne_top_eq_four_fifths :
  ...
  unfold Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.nearOneMassInf
...
theorem canary_hol_singleton_weightedQFMForAll_top :
  ...
  unfold Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.fuzzyForAllHoldsInf
...
theorem canary_hol_singleton_not_weightedQFMForAll_bot :
  ...
  intro hBot
  unfold Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.fuzzyForAllHoldsInf at hBot
  rw [canary_hol_singleton_weightedNearOne_bot_eq_zero] at hBot
  norm_num [fixtureSharpFourFifthsParams,
    Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.FuzzyQuantifierParams.toInf] at hBot
...
noncomputable def fixtureTwoWeightedCapacity :
    Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.FuzzyCapacity FixtureTwoPredObj where
  cap := by
    classical
    intro A
    exact
...
theorem canary_hol_two_weightedCapacity_normalized :
    Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.FuzzyCapacity.IsNormalized
...
theorem canary_hol_two_predLeft_holds_iff (x : FixtureTwoPredObj) :
  ...
  | mk x hx =>
      ...
      | up b =>
          cases b <;>
            simp [Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateHoldsAt,
...
theorem canary_hol_two_not_weightedQFMForAll_right :
  ...
  intro hRight
  unfold Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.fuzzyForAllHoldsInf at hRight
  rw [canary_hol_two_nearOneMass_right_eq_one_fifth] at hRight
  norm_num [fixtureTwoWeightedQFMParams,
    Mettapedia.PLN.RuleFamilies.FirstOrder.Quantifiers.FuzzyQuantifierParams.toInf] at hRight
...
theorem canary_hol_two_weightedQFMTwoInh2Sim_value :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityFiniteRuleValue
      (endpoint :=
        fun _ : Unit => fun j : Fin 2 =>
          if j = 0 then (4 / 5 : ℝ) else 1 / 5)
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.binaryRuleAsFinite2
        Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim)
      () = 4 / 21 := by
  norm_num [
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityFiniteRuleValue,
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.binaryRuleAsFinite2,
...
theorem canary_hol_two_weightedQFMModusPonens_value :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityFiniteRuleValue
      (endpoint :=
        fun _ : Unit => fun j : Fin 2 =>
          if j = 0 then (4 / 5 : ℝ) else 1 / 5)
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.modusPonensAsFinite2
        (1 / 10 : ℝ))
      () = 6 / 25 := by
  norm_num [
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityFiniteRuleValue,
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.modusPonensAsFinite2,
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.modusPonens]
...
theorem canary_hol_two_weightedQFMSymmetricModusPonens_value :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityFiniteRuleValue
      (endpoint :=
        fun _ : Unit => fun j : Fin 2 =>
          if j = 0 then (4 / 5 : ℝ) else 1 / 5)
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.symmetricModusPonensAsFinite2
        (1 / 10 : ℝ))
      () = 38 / 125 := by
  norm_num [
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityFiniteRuleValue,
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.symmetricModusPonensAsFinite2,
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.symmetricModusPonens]
...
theorem canary_hol_two_weightedQFMSim2Inh_value :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityFiniteRuleValue
      ...
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.sim2inhAsFinite3
      () = 5 / 9 := by
  ...
  norm_num [
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityFiniteRuleValue,
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.sim2inhAsFinite3,
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.sim2inh, h20, h21]

theorem canary_hol_two_weightedQFMSim2Inh_mixed_endpoint_order :
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.sim2inh
        (2 / 5 : ℝ) (4 / 5 : ℝ) (1 / 5 : ℝ) ≤
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.sim2inh
        (4 / 5 : ℝ) (3 / 5 : ℝ) (2 / 5 : ℝ) := by
  norm_num [Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.sim2inh]

theorem canary_hol_two_weightedQFMFiniteRule_singleton_multiJoin_width_zero :
    let I :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityFiniteRuleInterval
        (endpoint :=
          fun _ : Unit => fun j : Fin 2 =>
            if j = 0 then (4 / 5 : ℝ) else 1 / 5)
        (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.binaryRuleAsFinite2
          Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim)
        (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.binaryRuleAsFinite2_monotone_on_unit
          Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim
          Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.twoInh2Sim_binaryRuleMonotoneOnUnit)
        (by
          intro k j
  ...
  dsimp
  rw [
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityFiniteRuleInterval_eq_const_of_subsingleton
      (endpoint :=
        fun _ : Unit => fun j : Fin 2 =>
          if j = 0 then (4 / 5 : ℝ) else 1 / 5)
      ()
...
theorem canary_hol_two_weightedQFMProductMultiJoin_singleton_width_zero :
    let I :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityProductMultiJoinInterval
        (endpoint :=
          fun _ : Unit => fun j : Fin 2 =>
            if j = 0 then (4 / 5 : ℝ) else 1 / 5)
        (by
    ...
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityFiniteRuleInterval_eq_const_of_subsingleton
      (endpoint :=
        fun _ : Unit => fun j : Fin 2 =>
          if j = 0 then (4 / 5 : ℝ) else 1 / 5)
      ()
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.productMultiJoin)
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.productMultiJoin_monotone_on_unit
      (by
        intro k j
        fin_cases j <;> norm_num)
      (by
...
theorem canary_hol_two_weightedQFMNoisyOrMultiJoin_value :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityFiniteRuleValue
      (endpoint :=
        fun _ : Unit => fun j : Fin 2 =>
          if j = 0 then (4 / 5 : ℝ) else 1 / 5)
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.noisyOrMultiJoin
      () = 21 / 25 := by
  norm_num [
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityFiniteRuleValue,
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.noisyOrMultiJoin]
...
theorem canary_hol_two_weightedQFMNoisyOrMultiJoin_singleton_width_zero :
    let I :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityNoisyOrMultiJoinInterval
        (endpoint :=
          fun _ : Unit => fun j : Fin 2 =>
            if j = 0 then (4 / 5 : ℝ) else 1 / 5)
        (by
  ...
  rw [
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityFiniteRuleInterval_eq_const_of_subsingleton
      ...
      ()
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.noisyOrMultiJoin)
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.noisyOrMultiJoin_monotone_on_unit
      (by
        intro k j
        fin_cases j <;> norm_num)
      (by
...
theorem canary_hol_two_weightedQFMNoisyOr_complement_product_sum_one :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.productMultiJoin
      ...
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.noisyOrMultiJoin
        ...
        1 := by
  simpa using
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.productMultiJoin_compl_add_noisyOrMultiJoin
      (fun j : Fin 2 => if j = 0 then (4 / 5 : ℝ) else 1 / 5)
...
theorem canary_hol_two_weightedQFMNoisyOr_complement_dual :
  ...
  simpa using
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.noisyOrMultiJoin_compl_eq_one_sub_productMultiJoin
      (fun j : Fin 2 => if j = 0 then (4 / 5 : ℝ) else 1 / 5)
...
theorem canary_hol_two_weightedQFMNoisyOr_capacity_value_dual :
  ...
  simpa using
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityFiniteRuleValue_noisyOr_eq_one_sub_productMultiJoin_compl
      (endpoint :=
        fun _ : Unit => fun j : Fin 2 =>
          if j = 0 then (4 / 5 : ℝ) else 1 / 5)
      ()
...
theorem canary_hol_two_weightedQFMNoisyOr_hull_containment :
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityNoisyOrMultiJoinInterval
      ...
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityNoisyOrMultiJoinHull
        (endpoint :=
          fun _ : Unit => fun j : Fin 2 =>
            if j = 0 then (4 / 5 : ℝ) else 1 / 5)
        (by
  ...
  exact
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityNoisyOrMultiJoinInterval_containedIn_hull
      (endpoint :=
        fun _ : Unit => fun j : Fin 2 =>
          if j = 0 then (4 / 5 : ℝ) else 1 / 5)
      (by
    ...
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityNoisyOrMultiJoinHull
      ...
      1 -
        Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.productMultiJoin
          (fun j =>
            1 -
              (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityEndpointInterval
                (endpoint :=
                  fun _ : Unit => fun j : Fin 2 =>
                    if j = 0 then (4 / 5 : ℝ) else 1 / 5)
                (by
                ...
                j).lower) := by
  exact
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalQFMCapacityNoisyOrMultiJoinHull_lower_eq_one_sub_product_compl
      (endpoint :=
        fun _ : Unit => fun j : Fin 2 =>
          if j = 0 then (4 / 5 : ℝ) else 1 / 5)
      (by
...
def fixtureSingletonModelSpace (M : HenkinModel FixtureBase FixtureConst) :
  ...
  measurable_sentence_event := by
    ...
    classical
    have hEvent :
        {i : Unit | Mettapedia.Logic.HOL.holSatisfies M φ} =
          if Mettapedia.Logic.HOL.holSatisfies M φ then Set.univ else ∅ := by
      by_cases h : Mettapedia.Logic.HOL.holSatisfies M φ
      · rw [if_pos h]
        ext i
        constructor
        · intro _hp
...
theorem canary_hol_hierarchicalPredicateSimilarityTopTop_strength_one :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLProbabilisticBridge.hierarchicalPredicateSimilarityStrength
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureHierarchicalState FixtureObjTy fixturePredTop fixturePredTop = 1 :=
  Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLProbabilisticBridge.hierarchicalPredicateSimilarityStrength_eq_one_of_pointwiseMutualInherits
    (Base := FixtureBase) (Const := FixtureConst)
...
theorem canary_hol_hierarchicalPredicateSimilarityTopBot_strength_zero :
  ...
  Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLProbabilisticBridge.hierarchicalPredicateSimilarityStrength_eq_zero_of_pointwiseNotMutualInherits
    (Base := FixtureBase) (Const := FixtureConst)
...
theorem canary_hol_twoModelSpace_topBotIff_event :
  ...
  · constructor
    · intro h
      ...
      have hMutual :=
        (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateMutualInheritsAt_iff_models_predicateIffFormula
          (Base := FixtureBase) (Const := FixtureConst)
...
theorem canary_hol_twoModelUniform_topBotIff_value_half :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaValue
...
theorem canary_hol_credalPredicateSimilarityTopTop_interval_one :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateSimilarityInterval
      (Base := FixtureBase) (Const := FixtureConst)
  ...
  rw [Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateSimilarityInterval_eq_const_of_subsingleton
    (Base := FixtureBase) (Const := FixtureConst)
    fixtureCredalFamily () FixtureObjTy fixturePredTop fixturePredTop]
  change
    Mettapedia.ProbabilityTheory.ImpreciseProbability.CredalSets.constInterval
  ...
  have hRange :
    ...
    · intro hr
      ...
      · exact ⟨true, by
          ...
          rw [hTrue, ← h1]⟩
  constructor
  · unfold Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateSimilarityInterval
    change
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaInterval
        fixtureTwoCompletionCredalFamily φ).lower = 0
    unfold Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaInterval
...
theorem canary_hol_credalPredicateSimilarityTopBot_two_completion_ITV :
    let tv :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateSimilarityITV
        (Base := FixtureBase) (Const := FixtureConst)
        fixtureTwoCompletionCredalFamily FixtureObjTy fixturePredTop fixturePredBot
...
theorem canary_hol_topBotSimilarityDeductionCoordinates_eq_open :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.hierarchicalPredicateSimilarityDeductionCoordinates
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureTwoModelUniformState FixtureObjTy fixtureTopBotSimilarityDeductionLinks =
        Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.openDeductionCanaryCoordinates := by
  funext j
  fin_cases j <;>
    simp [
      fixtureTopBotSimilarityDeductionLinks,
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.hierarchicalPredicateSimilarityDeductionCoordinates,
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.openDeductionCanaryCoordinates]
  all_goals
...
theorem canary_hol_topBotSimilarityDeduction_admissible :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.DeductionCoordinateAdmissibility
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.hierarchicalPredicateSimilarityDeductionCoordinates
        (Base := FixtureBase) (Const := FixtureConst)
  ...
  refine ⟨?_, ?_,
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.openDeductionCanary_feasible,
    ?_, ?_, ?_, ?_, ?_⟩ <;>
    norm_num [
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.openDeductionCanaryCoordinates,
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.conditionalProbabilityConsistency,
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.deductionBBranchLower,
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.deductionBBranchUpper,
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.deductionNotBBranchLower,
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.deductionNotBBranchUpper,
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.deductionJointAB,
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.deductionJointBC,
      ...
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.complementConditionalFromMarginal]

theorem canary_hol_topBotSimilarityDeductionPointValue_open :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.hierarchicalPredicateSimilarityDeductionPointValue
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureTwoModelUniformState FixtureObjTy fixtureTopBotSimilarityDeductionLinks =
        1 / 2 := by
  change
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.deductionAsFinite5
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.hierarchicalPredicateSimilarityDeductionCoordinates
        (Base := FixtureBase) (Const := FixtureConst)
        fixtureTwoModelUniformState FixtureObjTy fixtureTopBotSimilarityDeductionLinks) =
      1 / 2
  rw [canary_hol_topBotSimilarityDeductionCoordinates_eq_open]
  exact Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.openDeductionCanary_pointValue

theorem canary_hol_topBotSimilarityDeductionPointValue_mem_openITV :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.openDeductionCanaryITV.lower ≤
        Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.hierarchicalPredicateSimilarityDeductionPointValue
          (Base := FixtureBase) (Const := FixtureConst)
          fixtureTwoModelUniformState FixtureObjTy fixtureTopBotSimilarityDeductionLinks ∧
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.hierarchicalPredicateSimilarityDeductionPointValue
          (Base := FixtureBase) (Const := FixtureConst)
          fixtureTwoModelUniformState FixtureObjTy fixtureTopBotSimilarityDeductionLinks ≤
        Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.openDeductionCanaryITV.upper := by
  constructor
  · rw [
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.openDeductionCanaryITV_lower,
      canary_hol_topBotSimilarityDeductionPointValue_open]
    norm_num
  · rw [
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge.openDeductionCanaryITV_upper,
      canary_hol_topBotSimilarityDeductionPointValue_open]
    norm_num
...
theorem canary_hol_twoInh2SimPredicateSimilarityTopBot_two_completion_bounds :
    let I :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateTwoInh2SimInterval
        (Base := FixtureBase) (Const := FixtureConst)
        fixtureTwoCompletionCredalFamily FixtureObjTy fixturePredTop fixturePredBot
    I.lower = 0 ∧ I.upper = 1 := by
  have hRuleFalse :
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaBinaryRuleValue
        (fixtureTwoCompletionCredalFamily false)
        fixturePredTopBotImp fixturePredBotTopImp
        Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim = 0 := by
    unfold Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaBinaryRuleValue
    change
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim
        (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaValue
    ...
    norm_num [Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim]
  have hRuleTrue :
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaBinaryRuleValue
        (fixtureTwoCompletionCredalFamily true)
        fixturePredTopBotImp fixturePredBotTopImp
        Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim = 1 := by
    unfold Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaBinaryRuleValue
    change
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim
        (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaValue
      ...
      · exact ⟨false, by
          change
            Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaBinaryRuleValue
              (fixtureTwoCompletionCredalFamily false)
              fixturePredTopBotImp fixturePredBotTopImp
              Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim = r
          rw [hRuleFalse, ← h0]⟩
      · exact ⟨true, by
          change
            Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaBinaryRuleValue
          ...
          rw [hRuleTrue, ← h1]⟩
  constructor
  · unfold Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateTwoInh2SimInterval
    unfold Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaBinaryRuleInterval
    dsimp [Mettapedia.ProbabilityTheory.ImpreciseProbability.CredalSets.IntervalAddSemantics.intervalOf]
    change
      sInf
          (Set.range fun i =>
...
theorem canary_hol_twoInh2SimPredicateSimilarityTopBot_two_completion_ITV :
    let tv :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateTwoInh2SimITV
        (Base := FixtureBase) (Const := FixtureConst)
        fixtureTwoCompletionCredalFamily FixtureObjTy fixturePredTop fixturePredBot
        (1 / 2 : ℝ) fixtureHalfCredibility
...
theorem canary_hol_predicateVocabularyTop_extent_nonzero :
    ((Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyInterpretation
      (Base := FixtureBase) (Const := FixtureConst)
  ...
  have hholds :
    ...
    trivial
  have haccept :
      Mettapedia.KR.ConceptOntology.EvidenceGate.positiveSupport.accept
        (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyEvidence
          (Base := FixtureBase) (Const := FixtureConst)
          fixtureModel FixtureObjTy fixtureOnePredDecode ⟨PUnit.unit, trivial⟩ ()) :=
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.positiveSupport_accept_predicateVocabularyEvidence_iff
        (Base := FixtureBase) (Const := FixtureConst)
  ...
  simpa [
    ...
    Mettapedia.KR.ConceptGeometry.AbstractInheritance.crispBaseConcept,
    Mettapedia.KR.ConceptOntology.mem_crispExtent_iff] using haccept
...
theorem canary_hol_predicateVocabularyTop_intent_nonzero :
  ...
  exact
    Mettapedia.KR.ConceptGeometry.AbstractInheritance.self_mem_intent_ofCrispBaseConcept
      Mettapedia.KR.ConceptOntology.EvidenceGate.positiveSupport
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyEvidence
        (Base := FixtureBase) (Const := FixtureConst)
...
theorem canary_hol_predicateVocabularyIntensionalPairSubsetRel_self :
    Mettapedia.PLN.ConceptGeometry.AssocPat.PLNHigherOrderHOLAssocPatBridge.predicateVocabularyIntensionalPairSubsetRel
      ...
      fixtureModel FixtureObjTy fixtureOnePredDecode () () () () () := by
  exact
    Mettapedia.PLN.ConceptGeometry.AssocPat.PLNHigherOrderHOLAssocPatBridge.predicateVocabularyIntensionalPairSubsetRel_of_sameIntent
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureModel FixtureObjTy fixtureOnePredDecode ()
...
theorem canary_hol_predicateVocabularyFullInheritanceTopTop_strength_one :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyFullInheritanceStrength
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureModel FixtureObjTy fixtureOnePredDecode () () = 1 := by
  apply
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyFullInheritanceStrength_eq_one_iff_models_predicateImpFormula
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureModel FixtureObjTy fixtureOnePredDecode () ()
...
theorem canary_hol_predicateVocabularyFullInheritanceTopTop_chain_strength_one :
  ...
  Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyFullInheritanceStrength_eq_one_of_chain
    (Base := FixtureBase) (Const := FixtureConst)
    fixtureModel FixtureObjTy fixtureOnePredDecode () () ()
    canary_hol_predicateVocabularyTop_extent_nonzero
...
theorem canary_hol_predicateVocabularySimilarityTopTop_strength_one :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularySimilarityStrength
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureModel FixtureObjTy fixtureOnePredDecode () () = 1 := by
  apply
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularySimilarityStrength_eq_one_of_models_predicateIffFormula
...
theorem canary_hol_predicateVocabularySourceSimilarityTransfer_strength_one :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyFullInheritanceStrength
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureModel FixtureObjTy fixtureOnePredDecode () () = 1 :=
  Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularyFullInheritanceStrength_eq_one_of_source_similarity
    (Base := FixtureBase) (Const := FixtureConst)
    fixtureModel FixtureObjTy fixtureOnePredDecode () () ()
    canary_hol_predicateVocabularyTop_extent_nonzero
    canary_hol_predicateVocabularyTop_intent_nonzero
...
theorem canary_hol_predicateVocabularyTargetSimilarityTransfer_strength_one :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyFullInheritanceStrength
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureModel FixtureObjTy fixtureOnePredDecode () () = 1 :=
  Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularyFullInheritanceStrength_eq_one_of_target_similarity
    (Base := FixtureBase) (Const := FixtureConst)
    fixtureModel FixtureObjTy fixtureOnePredDecode () () ()
    canary_hol_predicateVocabularyTop_extent_nonzero
    canary_hol_predicateVocabularyTop_intent_nonzero
...
theorem canary_hol_predicateVocabularyPureExtensionalSimilarityTopTop_strength_one :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularyPureExtensionalSimilarityStrength
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureModel FixtureObjTy fixtureOnePredDecode () () = 1 := by
  apply
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularyPureExtensionalSimilarityStrength_eq_one_of_mutualExtensional
  · exact canary_hol_predicateVocabularyTop_extent_nonzero
  · exact canary_hol_predicateVocabularyTop_extent_nonzero
  · intro _obj hobj
    exact hobj
...
theorem canary_hol_predicateVocabularyPureIntensionalSimilarityTopTop_strength_one :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularyPureIntensionalSimilarityStrength
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureModel FixtureObjTy fixtureOnePredDecode () () = 1 := by
  apply
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularyPureIntensionalSimilarityStrength_eq_one_of_mutualIntensional
  · exact canary_hol_predicateVocabularyTop_intent_nonzero
  · exact canary_hol_predicateVocabularyTop_intent_nonzero
  · intro _attr hattr
    exact hattr
...
theorem canary_hol_predicateVocabularyPureIntensionalSimilarityTopTop_strength_one_of_sameIntent :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularyPureIntensionalSimilarityStrength
      ...
      fixtureModel FixtureObjTy fixtureOnePredDecode () () = 1 := by
  exact
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularyPureIntensionalSimilarityStrength_eq_one_of_sameIntent
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureModel FixtureObjTy fixtureOnePredDecode () ()
      canary_hol_predicateVocabularyTop_intent_nonzero
      canary_hol_predicateVocabularyTop_intent_nonzero
...
theorem canary_hol_credalPredicateVocabularySimilarityTopTop_interval_one :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularySimilarityInterval
        (Base := FixtureBase) (Const := FixtureConst)
        fixtureVocabularyModelFamily FixtureObjTy fixtureOnePredDecode
        fixtureVocabularyObjectFintype () () =
      Mettapedia.ProbabilityTheory.ImpreciseProbability.CredalSets.constInterval 1 := by
  apply
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularySimilarityInterval_eq_const_one_of_pointwise_models
  · intro i
    cases i
    exact canary_hol_predicateVocabularyTop_extent_nonzero
  · intro i
...
theorem canary_hol_credalPredicateVocabularySimilarityTopTop_ITV :
    let tv :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularySimilarityITV
          (Base := FixtureBase) (Const := FixtureConst)
          fixtureVocabularyModelFamily FixtureObjTy fixtureOnePredDecode
          fixtureVocabularyObjectFintype () ()
          (1 / 2 : ℝ) fixtureHalfCredibility
...
theorem canary_hol_credalPredicateVocabularyPureExtensionalSimilarityTopTop_interval_one :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularyPureExtensionalSimilarityInterval
        (Base := FixtureBase) (Const := FixtureConst)
        fixtureVocabularyModelFamily FixtureObjTy fixtureOnePredDecode
        fixtureVocabularyObjectFintype () () =
      Mettapedia.ProbabilityTheory.ImpreciseProbability.CredalSets.constInterval 1 := by
  apply
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularyPureExtensionalSimilarityInterval_eq_const_of_pointwise_value_eq
  intro i
  cases i
...
theorem canary_hol_credalPredicateVocabularyPureIntensionalSimilarityTopTop_interval_one :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularyPureIntensionalSimilarityInterval
        (Base := FixtureBase) (Const := FixtureConst)
        fixtureVocabularyModelFamily FixtureObjTy fixtureOnePredDecode () () =
      Mettapedia.ProbabilityTheory.ImpreciseProbability.CredalSets.constInterval 1 := by
  apply
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularyPureIntensionalSimilarityInterval_eq_const_of_pointwise_value_eq
  intro i
  cases i
...
theorem canary_hol_credalPredicateVocabularyPureExtensionalSimilarityTopTop_interval_one_of_mutual :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularyPureExtensionalSimilarityInterval
      ...
      Mettapedia.ProbabilityTheory.ImpreciseProbability.CredalSets.constInterval 1 := by
  apply
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularyPureExtensionalSimilarityInterval_eq_const_one_of_pointwise_mutualExtensional
  · intro i
    cases i
    exact canary_hol_predicateVocabularyTop_extent_nonzero
  · intro i
...
theorem canary_hol_credalPredicateVocabularyPureIntensionalSimilarityTopTop_interval_one_of_mutual :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularyPureIntensionalSimilarityInterval
      ...
      Mettapedia.ProbabilityTheory.ImpreciseProbability.CredalSets.constInterval 1 := by
  apply
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularyPureIntensionalSimilarityInterval_eq_const_one_of_pointwise_mutualIntensional
  · intro i
    cases i
    exact canary_hol_predicateVocabularyTop_intent_nonzero
  · intro i
...
theorem canary_hol_credalPredicateVocabularyPureIntensionalSimilarityTopTop_interval_one_of_sameIntent :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularyPureIntensionalSimilarityInterval
      ...
      Mettapedia.ProbabilityTheory.ImpreciseProbability.CredalSets.constInterval 1 := by
  apply
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularyPureIntensionalSimilarityInterval_eq_const_one_of_pointwise_sameIntent
  · intro i
    cases i
    exact canary_hol_predicateVocabularyTop_intent_nonzero
  · intro i
...
theorem canary_hol_credalPredicateVocabularyPureExtensionalSimilarityTopTop_ITV :
    let tv :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularyPureExtensionalSimilarityITV
          (Base := FixtureBase) (Const := FixtureConst)
          fixtureVocabularyModelFamily FixtureObjTy fixtureOnePredDecode
          fixtureVocabularyObjectFintype () ()
          (1 / 2 : ℝ) fixtureHalfCredibility
...
theorem canary_hol_credalPredicateVocabularyPureIntensionalSimilarityTopTop_ITV :
    let tv :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularyPureIntensionalSimilarityITV
          (Base := FixtureBase) (Const := FixtureConst)
          fixtureVocabularyModelFamily FixtureObjTy fixtureOnePredDecode () ()
          (1 / 2 : ℝ) fixtureHalfCredibility
    tv.lower = 1 ∧ tv.upper = 1 ∧ tv.credibility = 1 / 2 := by
  ...
  dsimp
  constructor
  · rw [Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularyPureIntensionalSimilarityITV_lower]
    simpa [Mettapedia.ProbabilityTheory.ImpreciseProbability.CredalSets.constInterval] using congrArg
      Mettapedia.ProbabilityTheory.ImpreciseProbability.CredalSets.Interval.lower
      hInterval
  constructor
  · rw [Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalPredicateVocabularyPureIntensionalSimilarityITV_upper]
    simpa [Mettapedia.ProbabilityTheory.ImpreciseProbability.CredalSets.constInterval] using congrArg
      Mettapedia.ProbabilityTheory.ImpreciseProbability.CredalSets.Interval.upper
      hInterval
  · simp [
...
theorem fixtureProductRule_monotone_on_unit :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.BinaryRuleMonotoneOnUnit
...
theorem canary_hol_binaryRuleProduct_predicateSimilarityTopBot_two_completion_bounds :
    let I :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaBinaryRuleInterval
        (Base := FixtureBase) (Const := FixtureConst)
...
theorem canary_hol_binaryRuleProduct_predicateSimilarityTopBot_two_completion_ITV :
    let tv :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaBinaryRuleITV
        (Base := FixtureBase) (Const := FixtureConst)
...
theorem canary_hol_finiteRuleProduct_singleton_multiJoin_width_zero :
    let I :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaFiniteRuleInterval
        (Base := FixtureBase) (Const := FixtureConst)
  ...
  dsimp
  rw [
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaFiniteRuleInterval_eq_const_of_subsingleton
      (Base := FixtureBase) (Const := FixtureConst)
      (fun _ : Unit => fixtureHierarchicalState)
      ()
      (fun _ : Fin 2 => fixturePredTopBotIff)
...
theorem canary_hol_productMultiJoin_singleton_width_zero :
    let I :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaProductMultiJoinInterval
        (Base := FixtureBase) (Const := FixtureConst)
        (fun _ : Unit => fixtureHierarchicalState)
        (fun _ : Fin 2 => fixturePredTopBotIff)
    I.width = 0 := by
...
theorem canary_hol_noisyOrMultiJoin_singleton_width_zero :
    let I :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaNoisyOrMultiJoinInterval
        (Base := FixtureBase) (Const := FixtureConst)
        (fun _ : Unit => fixtureHierarchicalState)
        (fun _ : Fin 2 => fixturePredTopBotIff)
    I.width = 0 := by
...
theorem canary_hol_noisyOrMultiJoin_kyburg_join_value_zero :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaFiniteRuleValue
      fixtureHierarchicalState
      (fun _ : Fin 2 => fixturePredTopBotIff)
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.noisyOrMultiJoin = 0 := by
  have hValue :
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaValue
  ...
  have hJoin :
    ...
    simpa [
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaValue_eq_toReal_sentenceProb_kyburg_join]
      using hValue
  rw [
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaFiniteRuleValue_eq_rule_on_kyburg_join]
  simp [Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.noisyOrMultiJoin]
  rw [hJoin]
  norm_num
...
theorem canary_hol_credalHOLFormulaValue_not_topBotIff_eq_one :
  ...
  rw [
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaValue_not_eq_one_sub]
  have hValue :
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaValue
        fixtureHierarchicalState fixturePredTopBotIff = 0 := by
    change
...
theorem canary_hol_noisyOrMultiJoin_formula_not_dual_value :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaFiniteRuleValue.{0,0,0,0}
      fixtureHierarchicalState
      (fun _ : Fin 2 => fixturePredTopBotIff)
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.noisyOrMultiJoin =
        1 -
          Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaFiniteRuleValue.{0,0,0,0}
            ...
            Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.productMultiJoin := by
  exact
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaFiniteRuleValue_noisyOr_eq_one_sub_productMultiJoin_not.{0,0,0,0}
      (Base := FixtureBase) (Const := FixtureConst)
...
theorem canary_hol_credalHOLFormulaInterval_not_endpoint_dual_lower :
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaInterval.{0,0,0,0,0}
  ...
  exact
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaInterval_not_lower_eq_one_sub_upper.{0,0,0,0,0}
      (Base := FixtureBase) (Const := FixtureConst)
...
theorem canary_hol_credalHOLFormulaInterval_not_endpoint_dual_upper :
  ...
  exact
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaInterval_not_upper_eq_one_sub_lower.{0,0,0,0,0}
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureTwoCompletionCredalFamily fixturePredTopBotIff

theorem canary_hol_noisyOrMultiJoin_hull_formula_not_dual_lower :
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaNoisyOrMultiJoinHull.{0,0,0,0,0}
      fixtureTwoCompletionCredalFamily
      (fun _ : Fin 2 => fixturePredTopBotIff)).lower =
        1 -
          (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaProductMultiJoinHull.{0,0,0,0,0}
            fixtureTwoCompletionCredalFamily
            (fun k : Fin 2 =>
              (.not ((fun _ : Fin 2 => fixturePredTopBotIff) k) : ClosedFormula FixtureConst))).upper := by
  exact
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaNoisyOrMultiJoinHull_lower_eq_one_sub_product_not_upper.{0,0,0,0,0}
      (Base := FixtureBase) (Const := FixtureConst)
...
theorem canary_hol_noisyOrMultiJoin_hull_formula_not_dual_upper :
  ...
  exact
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaNoisyOrMultiJoinHull_upper_eq_one_sub_product_not_lower.{0,0,0,0,0}
      (Base := FixtureBase) (Const := FixtureConst)
      fixtureTwoCompletionCredalFamily (fun _ : Fin 2 => fixturePredTopBotIff)
...
theorem fixtureTriProductRule_monotone_on_unit :
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.FiniteRuleMonotoneOnUnit
...
theorem canary_hol_finiteRuleTriProduct_predicateSimilarityTopBot_two_completion_bounds :
  ...
  have hRuleFalse :
    ...
    unfold Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaFiniteRuleValue
      fixtureTriProductRule
    change
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaValue
        (fixtureTwoCompletionCredalFamily false) fixturePredTopBotIff *
  ...
  have hRange :
    ...
    · intro hr
      ...
      · exact ⟨true, by
          ...
          rw [hRuleTrue, ← h1]⟩
  constructor
  · unfold Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaFiniteRuleInterval
    dsimp [Mettapedia.ProbabilityTheory.ImpreciseProbability.CredalSets.IntervalAddSemantics.intervalOf]
    rw [hRange]
    simp
  · unfold Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaFiniteRuleInterval
...
theorem canary_hol_finiteRuleTriProduct_predicateSimilarityTopBot_two_completion_ITV :
    let tv :=
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge.credalHOLFormulaFiniteRuleITV
        (Base := FixtureBase) (Const := FixtureConst)
        fixtureTwoCompletionCredalFamily
        (fun _ : Fin 3 => fixturePredTopBotIff)
        fixtureTriProductRule
...
end Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCanary
