...
namespace Mettapedia.PLN.Bridges.HOL.PLNWorldModelHOLCompletenessCore

open Mettapedia.Logic.HOL
open Mettapedia.PLN.WorldModel.PLNWorldModel
open Mettapedia.PLN.Evidence.EvidenceClass
open Mettapedia.PLN.Evidence.EvidenceQuantale
open Mettapedia.PLN.Bridges.HOL.PLNWorldModelHOLCore
...
abbrev HOLQuery (Const : Ty Base → Type v) := Mettapedia.Logic.HOL.HOLQuery Const
...
theorem multiset_strength_le_of_pointwise
  ...
  exact
    Mettapedia.PLN.Bridges.HOL.PLNWorldModelHOLCore.queryStrength_le_of_pointwise.{u, v, w}
...
theorem multiset_strength_le_of_singletonStrengthLE
    ...
    BinaryWorldModel.queryStrength (State := HOLState Base Const) (Query := HOLQuery Const) W φ ≤
      BinaryWorldModel.queryStrength (State := HOLState Base Const) (Query := HOLQuery Const) W ψ := by
  exact
    Mettapedia.PLN.Bridges.HOL.PLNWorldModelHOLCore.multiset_strength_le_of_singletonStrengthLE.{u, v, w}
...
end Mettapedia.PLN.Bridges.HOL.PLNWorldModelHOLCompletenessCore
