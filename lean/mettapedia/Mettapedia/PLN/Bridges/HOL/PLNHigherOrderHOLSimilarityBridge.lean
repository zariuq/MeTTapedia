...
namespace Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge
...
noncomputable def predicateInheritanceStrength
    ...
    (σ : Ty Base)
    (p q : Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.UnaryPredicate
      (Base := Base) (Const := Const) σ) : ℝ :=
  by
    classical
    exact
      if (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateInterpretation
...
theorem predicateInheritanceStrength_eq_one_iff_inherits
  ...
  · intro hOne
    ...
    · simpa [Mettapedia.KR.ConceptGeometry.AbstractInheritance.Interpretation.inherits_iff] using hCond
    · norm_num at hOne
  · intro hInh
    have hCond :
        (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateInterpretation
      ...
      simpa [Mettapedia.KR.ConceptGeometry.AbstractInheritance.Interpretation.inherits_iff] using hInh
...
theorem predicateSimilarityStrength_comm
  ...
  exact Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim_comm _ _
...
theorem predicateSimilarityStrength_eq_zero_of_not_inherits_left
  ...
  unfold predicateSimilarityStrength
  rw [hpqStrength]
  simp [Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim]
  ...
  · intro hsim
    have hBoth :
        predicateInheritanceStrength (Base := Base) (Const := Const) M σ p q = 1 ∧
          predicateInheritanceStrength (Base := Base) (Const := Const) M σ q p = 1 := by
      have hTwo :=
        (Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim_eq_one_iff
          (predicateInheritanceStrength (Base := Base) (Const := Const) M σ p q)
          (predicateInheritanceStrength (Base := Base) (Const := Const) M σ q p)
...
theorem holProvable_predicateIffFormula_implies_similarityStrength_one
  ...
  exact
    predicateSimilarityStrength_eq_one_of_mutualInherits
      ...
      p
      q
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.holProvable_predicateIffFormula_implies_mutualInherits
...
theorem predicateFullInheritanceStrength_eq_one_of_source_similarity
    ...
    [Fintype
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.UnaryPredicate
        (Base := Base) (Const := Const) σ)]
    (p q r : Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.UnaryPredicate
      (Base := Base) (Const := Const) σ)
    (hpExtent :
      ((Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateInterpretation
    ...
    (hsim :
      predicateSimilarityStrength (Base := Base) (Const := Const) M σ p q = 1)
    (hqr :
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateFullInheritanceStrength
  ...
  have hqrModels :
    ...
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateFullInheritanceStrength_eq_one_iff_models_predicateImpFormula
      (Base := Base) (Const := Const) M σ q r hqExtent hrIntent).1 hqr
  exact
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateFullInheritanceStrength_eq_one_iff_models_predicateImpFormula
      (Base := Base) (Const := Const) M σ p r hpExtent hrIntent).2 <|
      Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.models_predicateImpFormula_trans
...
noncomputable def predicateVocabularyPureExtensionalStrength
    ...
    [Fintype
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.PredicateObject
        (Base := Base) (Const := Const) M σ)]
    (p q : Pred) : ℝ :=
  Mettapedia.KR.ConceptGeometry.ExtensionalIntensionalDivergence.pureExtensionalStrength
...
noncomputable def predicateVocabularyPureIntensionalStrength
    ...
    [Fintype Pred]
    (p q : Pred) : ℝ :=
  Mettapedia.KR.ConceptGeometry.ExtensionalIntensionalDivergence.pureIntensionalStrength
    (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyInterpretation
      (Base := Base) (Const := Const) M σ decode) p q
...
theorem predicateVocabularyPureExtensionalStrength_nonneg
  ...
  exact
    Mettapedia.KR.ConceptGeometry.ExtensionalIntensionalDivergence.pureExtensionalStrength_nonneg
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyInterpretation
        (Base := Base) (Const := Const) M σ decode) p q
...
theorem predicateVocabularyPureExtensionalStrength_le_one
  ...
  exact
    Mettapedia.KR.ConceptGeometry.ExtensionalIntensionalDivergence.pureExtensionalStrength_le_one
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyInterpretation
        (Base := Base) (Const := Const) M σ decode) p q
...
theorem predicateVocabularyPureIntensionalStrength_nonneg
    ...
    0 ≤ predicateVocabularyPureIntensionalStrength
      (Base := Base) (Const := Const) M σ decode p q := by
  exact
    Mettapedia.KR.ConceptGeometry.ExtensionalIntensionalDivergence.pureIntensionalStrength_nonneg
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyInterpretation
        (Base := Base) (Const := Const) M σ decode) p q
...
theorem predicateVocabularyPureIntensionalStrength_le_one
    ...
    predicateVocabularyPureIntensionalStrength
      (Base := Base) (Const := Const) M σ decode p q ≤ 1 := by
  exact
    Mettapedia.KR.ConceptGeometry.ExtensionalIntensionalDivergence.pureIntensionalStrength_le_one
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyInterpretation
        (Base := Base) (Const := Const) M σ decode) p q
...
theorem predicateVocabularyPureExtensionalStrength_eq_one_iff
  ...
  exact
    Mettapedia.KR.ConceptGeometry.ExtensionalIntensionalDivergence.pureExtensionalStrength_eq_one_iff
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyInterpretation
...
theorem predicateVocabularyPureIntensionalStrength_eq_one_iff
  ...
  exact
    Mettapedia.KR.ConceptGeometry.ExtensionalIntensionalDivergence.pureIntensionalStrength_eq_one_iff
      (Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyInterpretation
...
theorem predicateVocabularyPureExtensionalSimilarityStrength_nonneg
  ...
  unfold predicateVocabularyPureExtensionalSimilarityStrength
  exact
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim_nonneg _ _
  ...
  have hQP :
    ...
    ⟨predicateVocabularyPureExtensionalStrength_nonneg
      ...
      predicateVocabularyPureExtensionalStrength_le_one
        (Base := Base) (Const := Const) M σ decode q p⟩
  unfold predicateVocabularyPureExtensionalSimilarityStrength
  rw [Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim_eq_one_iff _ _ hPQ hQP]
  constructor
  · rintro ⟨hpq, hqp⟩
    exact
      ⟨(predicateVocabularyPureExtensionalStrength_eq_one_iff
...
theorem predicateVocabularySimilarityStrength_nonneg
  ...
  exact
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim_nonneg _ _
      ⟨Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyFullInheritanceStrength_nonneg
            (Base := Base) (Const := Const) M σ decode p q,
       Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyFullInheritanceStrength_le_one
            (Base := Base) (Const := Const) M σ decode p q⟩
      ⟨Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyFullInheritanceStrength_nonneg
            (Base := Base) (Const := Const) M σ decode q p,
       Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyFullInheritanceStrength_le_one
...
theorem predicateVocabularySimilarityStrength_eq_one_iff_models_predicateIffFormula
  ...
  · intro hsim
    have hPQunit :
        0 ≤ Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyFullInheritanceStrength
            (Base := Base) (Const := Const) M σ decode p q ∧
          Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyFullInheritanceStrength
            (Base := Base) (Const := Const) M σ decode p q ≤ 1 :=
      ⟨Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLInheritanceBridge.predicateVocabularyFullInheritanceStrength_nonneg
...
end Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge
