...
namespace Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge
...
open Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLProbabilisticBridge
...
@[simp] theorem credalHOLFormulaITV_width
  ...
  simp [Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV.width,
    Interval.width]
...
theorem twoInh2Sim_binaryRuleMonotoneOnUnit :
    BinaryRuleMonotoneOnUnit
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim := by
  intro a₁ a₂ b₁ b₂ ha₁_nonneg ha₂_le_one hb₁_nonneg hb₂_le_one ha hb
  exact Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim_mono_on_unit
    ha₁_nonneg ha₂_le_one hb₁_nonneg hb₂_le_one ha hb

theorem twoInh2Sim_zero_zero_nonneg :
    0 ≤ Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim 0 0 := by
  norm_num [Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim]

theorem twoInh2Sim_one_one_le_one :
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim 1 1 ≤ 1 := by
  norm_num [Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim]
...
noncomputable def modusPonensAsFinite2
    (c : ℝ) : (Fin 2 → ℝ) → ℝ :=
  fun xs => Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.modusPonens (xs 0) (xs 1) c
...
theorem modusPonensAsFinite2_mapsUnitToUnit
  ...
  exact
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.modusPonens_mem_unit
      (xs 0) (xs 1) c
      ⟨hnonneg 0, hle 0⟩
      ⟨hnonneg 1, hle 1⟩
      hc
...
theorem symmetricModusPonensAsFinite2_mapsUnitToUnit
  ...
  intro xs hnonneg hle
  exact
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.symmetricModusPonens_mem_unit
      (xs 0) (xs 1) c
      ⟨hnonneg 0, hle 0⟩
      ⟨hnonneg 1, hle 1⟩
      hc
...
theorem sim2inhAsFinite3_mapsConstrainedToUnit
  ...
  exact
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.sim2inh_mem_unit
      (xs 0) (xs 1) (xs 2)
      ⟨hnonneg 0, hle 0⟩
      ⟨hSource_pos, hle 1⟩
      ⟨hnonneg 2, hle 2⟩
...
theorem credalPredicateVocabularySimilarityFamilyValue_nonneg
  ...
  letI := hObj i
  exact
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularySimilarityStrength_nonneg
        (Base := Base) (Const := Const) (Ms i) σ decode p q
...
theorem credalPredicateVocabularySimilarityFamilyValue_le_one
  ...
  letI := hObj i
  exact
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularySimilarityStrength_le_one
        (Base := Base) (Const := Const) (Ms i) σ decode p q
...
theorem credalPredicateVocabularyPureExtensionalSimilarityFamilyValue_nonneg
  ...
  letI := hObj i
  exact
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularyPureExtensionalSimilarityStrength_nonneg
      (Base := Base) (Const := Const) (Ms i) σ decode p q
...
theorem credalPredicateVocabularyPureExtensionalSimilarityFamilyValue_le_one
  ...
  letI := hObj i
  exact
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularyPureExtensionalSimilarityStrength_le_one
      (Base := Base) (Const := Const) (Ms i) σ decode p q
...
theorem credalPredicateVocabularyPureIntensionalSimilarityFamilyValue_nonneg
  ...
  exact
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularyPureIntensionalSimilarityStrength_nonneg
      (Base := Base) (Const := Const) (Ms i) σ decode p q
...
theorem credalPredicateVocabularyPureIntensionalSimilarityFamilyValue_le_one
  ...
  unfold credalPredicateVocabularyPureIntensionalSimilarityFamilyValue
  exact
    Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLSimilarityBridge.predicateVocabularyPureIntensionalSimilarityStrength_le_one
      (Base := Base) (Const := Const) (Ms i) σ decode p q
...
noncomputable def credalQFMCapacitySim2InhHull
  ...
  valid := by
    ...
    exact
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.sim2inh_mixed_mono
...
noncomputable def credalQFMCapacityModusPonensHull
  ...
  valid := by
    exact
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.modusPonens_mono_of_background_le
        (credalQFMCapacityEndpointInterval_lower_nonneg
          endpoint hEndpoint_nonneg hEndpoint_le_one 1)
        hcLower
        (credalQFMCapacityEndpointInterval
    ...
    have hPremiseLower :
      ...
      · exact le_trans
          ...
          (credalQFMCapacityEndpointInterval_upper_le_one
            endpoint hEndpoint_nonneg hEndpoint_le_one 1)
    exact
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.symmetricModusPonens_mono_of_background_le
        hPremiseLower
        hc.1
        (by linarith [hc.2])
        hcLower
  ...
  · apply csSup_le
    ...
    · rintro r ⟨k, rfl⟩
      have hcValue :
        ...
        Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.symmetricModusPonens_background_le_of_le
          (by linarith [hc.2])
          hcLower
          (credalQFMCapacityEndpointInterval_lower_le_value
            endpoint hEndpoint_nonneg hEndpoint_le_one 0 k)
...
noncomputable def credalPredicateQFMForAllTwoInh2SimInterval
  ...
  credalPredicateQFMForAllFiniteRuleInterval
    ...
    (directedPredicateEndpointPair (Base := Base) (Const := Const)
      σ forward reverse)
    (binaryRuleAsFinite2 Mettapedia.PLN.RuleFamilies.FirstOrder.PLNInferenceRules.twoInh2Sim)
...
end Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge
