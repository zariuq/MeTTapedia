...
namespace Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge

open Mettapedia.Logic.HOL
open Mettapedia.Logic.HOL.Probabilistic
open Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLCredalBridge
...
noncomputable def deductionAsFinite5 (xs : Fin 5 → ℝ) : ℝ :=
  Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.simpleDeductionStrengthFormula
...
theorem deductionAsFinite5_mem_normalized_allocationJointTypedITV
    ...
    (hpB_small : xs 1 ≤ 0.99)
    (hFeas :
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.DeductionBranchFeasibility
        (xs 0) (xs 1) (xs 2) (xs 3) (xs 4))
    (h_consist :
    ...
    let joint :=
      Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.deductionAllocationJointTypedITV
  ...
  simpa [deductionAsFinite5] using
    Mettapedia.PLN.RuleFamilies.FirstOrder.PLNDeduction.simpleDeductionStrengthFormula_mem_normalized_allocationJointTypedITV
      (xs 0) (xs 1) (xs 2) (xs 3) (xs 4)
...
theorem collapsedDeductionCanaryITV_width :
  ...
  norm_num [Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV.width,
...
end Mettapedia.PLN.Bridges.HOL.PLNHigherOrderHOLDeductionBridge
