...
This PLN-facing bridge unifies modal query-encoder shapes already present in
the temporal event-calculus and deontic/governance layers.
...
namespace Mettapedia.PLN.Bridges.Logic.ModalQueryEncoding
...
end Mettapedia.PLN.Bridges.Logic.ModalQueryEncoding
