...
namespace Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelFOLCompleteness
...
abbrev FOLQuery (L : Language.{u}) := Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelFOL.FOLQuery L
...
theorem singletonStrengthLE_singleton_iff_imp {L : Language.{u}}
  ...
  · intro himp
    ...
    · have hψ : folSatisfies S ψ := himp hφ
      rw [Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelFOL.queryStrength_singleton_of_satisfies
            (S := S) (φ := φ) hφ]
      rw [Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelFOL.queryStrength_singleton_of_satisfies
            (S := S) (φ := ψ) hψ]
    · rw [Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelFOL.queryStrength_singleton_of_not_satisfies
            (S := S) (φ := φ) hφ]
      exact zero_le
...
end Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelFOLCompleteness
