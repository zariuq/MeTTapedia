...
namespace Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelNeighborhood
...
abbrev KPointedKripke := Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripke.PointedKripke
...
theorem singleton_consequence_schema_parallel (φ ψ : ModalQuery) :
  ...
  exact ⟨pointwiseImplies_iff_singletonStrengthLE φ ψ,
    Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripke.pointwiseImplies_iff_singletonStrengthLE φ ψ⟩
...
theorem multiset_lift_schema_parallel (φ ψ : ModalQuery) :
  ...
  · intro Wk hsing
    exact Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripke.multiset_strength_le_of_singletonStrengthLE
      (W := Wk) (φ := φ) (ψ := ψ) hsing

end Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelNeighborhood
