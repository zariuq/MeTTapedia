...
import Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelNeighborhoodCompleteness
...
namespace Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripkeNeighborhoodCanonical
...
open Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripkeNeighborhoodEmbedding

abbrev ModalQuery := Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripke.ModalQuery
abbrev PointedKripke := Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripke.PointedKripke
abbrev PointedNeighborhood := Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelNeighborhood.PointedNeighborhood
...
theorem pointed_satisfies_iff (pk : PointedKripke) (φ : ModalQuery) :
  ...
  simpa [Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelNeighborhood.PointedNeighborhood.satisfies,
    Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripke.PointedKripke.satisfies,
...
theorem singletonStrengthLEOn_canonical_iff_kripke
    ...
    (∀ pk : PointedKripke,
      ...
      ↔ Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripke.singletonStrengthLE φ ψ :=
...
theorem parallel_strength_le_of_provable_imp_canonical
  ...
  refine ⟨?_, ?_⟩
  · exact
      Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripkeCompleteness.multiset_strength_le_of_provable_imp
        (S := S) (𝓢 := 𝓢) (C := C)
...
theorem parallel_governance_ob_pe_strength_le_of_provable_canonical
  ...
  refine ⟨?_, ?_⟩
  · exact
      Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripkeCompleteness.multiset_ob_pe_strength_le_of_provable
        (S := S) (𝓢 := 𝓢) (C := C)
        (W := Wk) (φ := φ) hW hprov
  · exact
...
theorem parallel_strength_le_of_provable_imp_KT_EMT_canonical
  ...
  refine ⟨?_, ?_⟩
  · exact
      Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripkeCompleteness.multiset_strength_le_of_provable_imp_KT
        (W := Wk) (φ := φ) (ψ := ψ) hWKT hprovKT
  · exact
      Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelNeighborhoodCompleteness.multiset_strength_le_of_provable_imp_EMT
...
theorem parallel_strength_le_of_provable_imp_KD_ED_canonical
  ...
  refine ⟨?_, ?_⟩
  · exact
      Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripkeCompleteness.multiset_strength_le_of_provable_imp_KD
        (W := Wk) (φ := φ) (ψ := ψ) hWKD hprovKD
  · exact
      Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelNeighborhoodCompleteness.multiset_strength_le_of_provable_imp_ED
...
theorem parallel_governance_rexist_strength_le_KT_EMT_canonical
  ...
  refine ⟨?_, ?_⟩
  · exact
      Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripkeCompleteness.multiset_rexist_strength_le_of_provable_KT
...
theorem parallel_governance_ob_pe_strength_le_KD_ED_canonical
  ...
  refine ⟨?_, ?_⟩
  · exact
      Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripkeCompleteness.multiset_ob_pe_strength_le_of_provable_KD
        (W := Wk) (φ := φ) hWKD hprovKD
  · simpa [governanceModalityToModalQuery] using
      (Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelNeighborhoodCompleteness.multiset_strength_le_of_provable_imp_ED
        (W := mapState canonicalEmbedding Wk) (φ := □φ) (ψ := ◇φ) hWED hprovED)

end Mettapedia.PLN.Bridges.Logic.WorldModel.PLNWorldModelKripkeNeighborhoodCanonical
