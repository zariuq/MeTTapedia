...
Port of the retired standalone Datalog world-model bridge onto LP types.
...
namespace Mettapedia.PLN.Bridges.Logic.LPWorldModelBridge
...
end Mettapedia.PLN.Bridges.Logic.LPWorldModelBridge
