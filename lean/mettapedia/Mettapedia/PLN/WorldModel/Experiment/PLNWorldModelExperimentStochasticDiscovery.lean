...
namespace Mettapedia.PLN.WorldModel.Experiment.PLNWorldModelExperimentStochasticDiscovery
...
noncomputable def bernoulliDiscoveryQuery
  ...
  { channel := fun _ => Mettapedia.PLN.WorldModel.BayesNet.PLNBayesNetInference.bernoulliPMF s hs
...
end Mettapedia.PLN.WorldModel.Experiment.PLNWorldModelExperimentStochasticDiscovery
