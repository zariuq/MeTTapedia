...
import Mettapedia.PLN.WorldModel.BayesNet.PLNBayesNetInference
...
namespace Mettapedia.PLN.WorldModel.Experiment.PLNWorldModelExperimentStochasticRegression
...
noncomputable def strongChannel : StochasticChannel H O
  | false => Mettapedia.PLN.WorldModel.BayesNet.PLNBayesNetInference.bernoulliPMF pHalf pHalf_le_one
  | true => Mettapedia.PLN.WorldModel.BayesNet.PLNBayesNetInference.bernoulliPMF pHalf pHalf_le_one
...
noncomputable def prior : Prior H :=
  Mettapedia.PLN.WorldModel.BayesNet.PLNBayesNetInference.bernoulliPMF pHalf pHalf_le_one
...
end Mettapedia.PLN.WorldModel.Experiment.PLNWorldModelExperimentStochasticRegression
