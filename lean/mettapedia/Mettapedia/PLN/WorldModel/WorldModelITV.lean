...
namespace Mettapedia.PLN.WorldModel.PLNWorldModel
...
structure ITVSemantics (Ctx : Type*) where
  eval : Ctx → BinaryEvidence → Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV
...
noncomputable def toTruthTowerSemantics {Ctx : Type*}
    ...
    Mettapedia.PLN.TruthValues.PLNTruthTower.ITVSemantics where
...
noncomputable def typedEval {Ctx : Type*}
    ...
    Mettapedia.PLN.TruthValues.PLNTruthTower.TypedITV
...
noncomputable def bayesCredibleNormalApprox (level : ℝ) (hlevel : 0 < level ∧ level < 1) :
  ...
  eval := fun ctx e => Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV.fromBayesCredibleNormalApprox e ctx level hlevel
...
noncomputable def bayesCredibleExactInvCDF (level : ℝ) (hlevel : 0 < level ∧ level < 1) :
    ITVSemantics BinaryContext where
  eval := fun ctx e => Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV.fromBayesCredibleExactInvCDF e ctx level hlevel
...
noncomputable def walleyIDMPredictive : ITVSemantics IDMPredictiveContext where
  eval := fun ctx e => Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV.fromWalleyIDMPredictive e ctx.s ctx.s_pos
...
noncomputable def queryTypedITVWalley
    ...
    Mettapedia.PLN.TruthValues.PLNTruthTower.TypedITV
      (Mettapedia.PLN.TruthValues.PLNTruthTower.walleyBinaryITVSemantics ctx.s) :=
  Mettapedia.PLN.TruthValues.PLNTruthTower.TypedITV.fromWalleyBinary
    ctx.s ctx.s_pos
...
theorem queryTypedITVWalley_width_add_credibility
  ...
  Mettapedia.PLN.TruthValues.PLNTruthTower.TypedITV.walleyBinary_width_add_credibility
    ctx.s ctx.s_pos
    (BinaryWorldModel.evidence (State := State) (Query := Query) W q)
...
def WMITVJudgment
    (sem : ITVSemantics Ctx) (ctx : Ctx)
    (W : State) (q : Query) (itv : Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV) : Prop :=
...
def WMITVJudgmentCtx
    (sem : ITVSemantics Ctx) (ctx : Ctx)
    (Γ : Set State) (W : State) (q : Query) (itv : Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV) : Prop :=
...
noncomputable def queryITV (sem : ITVSemantics Ctx) (ctx : Ctx) (W : State)
    (q : Sigma Query) : Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV :=
...
noncomputable def queryITVAt (sem : ITVSemantics Ctx) (ctx : Ctx) (W : State)
    {s : Srt} (q : Query s) : Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV :=
...
def WMITVJudgmentSigma
    (sem : ITVSemantics Ctx) (ctx : Ctx)
    (W : State) (q : Sigma Query) (itv : Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV) : Prop :=
...
def WMITVJudgmentCtxSigma
    (sem : ITVSemantics Ctx) (ctx : Ctx)
    (Γ : Set State) (W : State) (q : Sigma Query) (itv : Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV) : Prop :=
...
def WMITVThresholdJudgmentSigma
    (sem : ITVSemantics Ctx) (ctx : Ctx)
    (W : State) (q : Sigma Query)
    (coord : Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV → ℝ) (tau : ℝ) : Prop :=
...
theorem WMQueryEqSigma.to_queryITV_coord
    ...
    (hEq : WMQueryEqSigma (State := State) (Srt := Srt) (Query := Query) q₁ q₂)
    (sem : ITVSemantics Ctx) (ctx : Ctx) (W : State)
    (coord : Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV → ℝ) :
...
theorem WMQueryEqSigma.to_queryITV_threshold
    ...
    (hEq : WMQueryEqSigma (State := State) (Srt := Srt) (Query := Query) q₁ q₂)
    (sem : ITVSemantics Ctx) (ctx : Ctx) (W : State)
    (coord : Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV → ℝ) (tau : ℝ)
...
theorem WMRewriteRuleSigma.applyITVThreshold_bayes95
    {r : WMRewriteRuleSigma State Srt Query} {W : State}
    (ctx : BinaryContext) (coord : Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV → ℝ) (tau : ℝ)
    (hSide : r.side) (hW : WMJudgment W)
...
theorem WMRewriteRuleSigma.applyITVThreshold_walleyIDM
    {r : WMRewriteRuleSigma State Srt Query} {W : State}
    (ctx : IDMPredictiveContext) (coord : Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV → ℝ) (tau : ℝ)
    (hSide : r.side) (hW : WMJudgment W)
...
end Mettapedia.PLN.WorldModel.PLNWorldModel
