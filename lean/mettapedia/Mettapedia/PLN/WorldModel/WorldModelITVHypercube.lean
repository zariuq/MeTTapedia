...
namespace Mettapedia.PLN.WorldModel.PLNWorldModelITVHypercube
...
noncomputable def queryITVOfInterval
    ...
    (W : State) (q : Query) : Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV :=
...
noncomputable def queryITVSigmaOfInterval
    (i : WMIntervalSemantics) (ctx : CtxOfInterval i)
    (W : State) (q : Sigma Query) : Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV :=
...
noncomputable def queryITVAtVertexAt
    (v : WMVertex) (ctx : CtxOfVertex v)
    (W : State) {s : Srt} (q : Query s) : Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV :=
...
theorem WMQueryEqSigma.to_WMITVJudgmentSigmaOfInterval
    ...
    (hEq : WorldModelSigma.WMQueryEqSigma
      (State := State) (Srt := Srt) (Query := Query) q₁ q₂)
    (i : WMIntervalSemantics) (ctx : CtxOfInterval i)
    {W : State} {itv : Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV}
...
end Mettapedia.PLN.WorldModel.PLNWorldModelITVHypercube
