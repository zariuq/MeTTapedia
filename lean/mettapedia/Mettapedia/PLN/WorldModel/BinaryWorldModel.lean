...
noncomputable def queryWTV (κ : ℝ≥0∞) (W : State) (q : Query) : Mettapedia.PLN.TruthValues.PLNWeightTV.WTV :=
...
noncomputable def propWTV (κ : ℝ≥0∞) (W : State) (a : Atom) : Mettapedia.PLN.TruthValues.PLNWeightTV.WTV :=
  BinaryEvidence.toWTV κ (propEvidence (State := State) (Atom := Atom) W a)

noncomputable def linkWTV (κ : ℝ≥0∞) (W : State) (a b : Atom) : Mettapedia.PLN.TruthValues.PLNWeightTV.WTV :=
...
noncomputable def queryWTV (κ : ℝ≥0∞) (W : State) (q : Sigma Query) : Mettapedia.PLN.TruthValues.PLNWeightTV.WTV :=
...
noncomputable def queryWTVAt (κ : ℝ≥0∞) (W : State) {s : Srt} (q : Query s) :
    Mettapedia.PLN.TruthValues.PLNWeightTV.WTV :=
  queryWTV κ W ⟨s, q⟩
