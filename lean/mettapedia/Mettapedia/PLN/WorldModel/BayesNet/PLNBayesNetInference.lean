...
import Mettapedia.PLN.WorldModel.BayesNet.PLNBayesNetWorldModel
...
namespace Mettapedia.PLN.WorldModel.BayesNet.PLNBayesNetInference

open scoped Classical BigOperators ENNReal

open Mettapedia.PLN.Evidence.EvidenceQuantale
open Mettapedia.PLN.WorldModel.BayesNet.PLNBayesNetWorldModel
...
end Mettapedia.PLN.WorldModel.BayesNet.PLNBayesNetInference

/-! ## BoolBayesNet → BayesianNetwork -/

namespace Mettapedia.PLN.WorldModel.BayesNet.PLNBayesNetWorldModel.BoolBayesNet
...
noncomputable def cptOfState (W : CPTState (bn := bn)) :
  ...
  { cpt := fun v pa =>
      ...
      Mettapedia.PLN.WorldModel.BayesNet.PLNBayesNetInference.bernoulliPMF
...
end Mettapedia.PLN.WorldModel.BayesNet.PLNBayesNetWorldModel.BoolBayesNet
