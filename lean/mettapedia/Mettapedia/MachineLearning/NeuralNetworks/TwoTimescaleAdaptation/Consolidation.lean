...
theorem scalarLedger_discount_fixture :
...
theorem orthogonalConsolidations_commute_fixture :
...
theorem obliqueConsolidations_order_matters_fixture :
    ¬ CurvatureConsolidationsCommute 1
  ...
  · rw [curvatureConsolidations_commute_iff 1 _ _ one_ne_zero]
    intro hcommute
    exact obliqueTasks_curvature_interference_fixture.1
      (sub_eq_zero.mpr hcommute.eq.symm)
  · exact obliqueTasks_curvature_interference_fixture.2
...
theorem halfStep_periodRetention_fixture :
...
theorem reflectedPeriodConsolidation_retention_failure_fixture :
...
theorem reflectedPeriodConsolidation_breaks_capabilityBudget_fixture :
...
#print axioms obliqueConsolidations_order_matters_fixture
...
#print axioms reflectedPeriodConsolidation_retention_failure_fixture
