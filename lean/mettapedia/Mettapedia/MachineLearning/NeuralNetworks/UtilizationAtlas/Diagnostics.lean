...
/-- Ordered source fragments of the canonical v3 diagnostic schema. -/
def utilizationAtlasDepthProbeSchemaFragments : List String :=
  ["{",
...
def utilizationAtlasDepthProbeSchemaPayload : String :=
  String.join utilizationAtlasDepthProbeSchemaFragments
