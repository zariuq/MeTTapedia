...
theorem measure_start_inter_wordSuccessorTupleMap_wordAnchorFiber_perm_eq
  ...
  exact
    measure_start_inter_anchorFiberSelectionMapList_perm_eq_of_idx_eq_enum
      ...
      i
      (hidx := Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiHard.wordVisitIndex_getElem_wordAnchorFiberList
        (k := k) a ys i)
      σ' c j
...
theorem measure_start_inter_preimage_wordTupleFixedComplementSet_perm_eq
  ...
  have hcoord_perm :
    ...
    have hidx_left :
      ...
      Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiHard.wordVisitIndex_getElem_wordAnchorFiberList
        (k := k) a ys i (σ' t)
    have hidx_right :
