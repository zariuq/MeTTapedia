...
This file generalizes `Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti` from binary (`Bool`) observations to
...
namespace Mettapedia.ProbabilityTheory.Exchangeability.CategoricalDeFinetti
...
See `Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti` for the binary-specific formalization
and `Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceDirichlet` for the corresponding k-ary Bayesian update.
-/

end Mettapedia.ProbabilityTheory.Exchangeability.CategoricalDeFinetti
