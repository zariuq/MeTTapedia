...
theorem startRestricted_rowSucc_permInvariant
    ...
    (hSuff : ∀ (i b : Fin k) (N : ℕ), Mettapedia.ProbabilityTheory.Exchangeability.CarrierTransportBridge.CarrierSuffHyp i b N)
  ...
  apply startRestrictedRowSuccessorPermInvariant_offDiagonal_of_extension_transport
    (k := k) μ hμ P hExt
  · intro i' b' n' n'' N' hbi'
    exact Mettapedia.ProbabilityTheory.Exchangeability.CarrierTransportBridge.carrierTransportEquivGeneral i' b' hbi' n' n'' (hSuff i' b' N')
  · exact hbi
