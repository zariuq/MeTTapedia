...
theorem plnStrength_eq_improper_mean (n_pos n_neg : ℕ) (h : n_pos + n_neg ≠ 0) :
  ...
  Mettapedia.PLN.Evidence.EvidenceCounts.plnStrength_eq_improper_mean n_pos n_neg h

/-- Main νPLN connection: **proven** in `Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti.nupln_master_chain` and
