...
import Mettapedia.ProbabilityTheory.Moments.MomentSequences
...
namespace Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti

open MeasureTheory Finset BigOperators ENNReal
open scoped BigOperators
open Mettapedia.ProbabilityTheory.Exchangeability
open Mettapedia.ProbabilityTheory.Moments.MomentSequences
...
theorem hausdorff_moment_exists (m : ℕ → ℝ)
  ...
  simpa using
    (Mettapedia.ProbabilityTheory.Moments.HausdorffMoment.hausdorff_moment_exists m hbnd hcm hzero)
...
theorem nupln_master_chain {Ω : Type*} [MeasurableSpace Ω]
  ...
  · exact (Mettapedia.PLN.Bridges.ProbabilityTheory.EvidenceBeta.pln_is_bayes_optimal_for_exchangeable).2
...
end Mettapedia.ProbabilityTheory.Exchangeability.DeFinetti
