...
now lives separately in `Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiEvidenceBasis`.
...
namespace Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiCarrierTransport
...
end Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiCarrierTransport
