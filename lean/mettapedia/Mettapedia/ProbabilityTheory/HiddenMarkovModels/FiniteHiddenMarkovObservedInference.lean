...
namespace Mettapedia.ProbabilityTheory.HiddenMarkovModels.FiniteHiddenMarkovObservedInference
...
theorem backwardMessage_eq_sum_wordProbAux_observationWeight
  ...
  | [] => by
      simp [backwardMessage, Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiHard.wordProbAux]
  | y :: ys => by
      let n := ys.length
        ...
        ∑ xs : Fin n → Fin latent,
          wordProb (k := latent) θ.latentParam (List.ofFn (Fin.cons x xs)) *
            observationWeight θ (List.ofFn (Fin.cons x xs)) (y :: ys) := by
              refine Finset.sum_congr rfl ?_
              intro xs hxs
              simp [Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiHard.wordProb, Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiHard.wordProbNN,
                mul_assoc, mul_left_comm, mul_comm]
...
@[simp] theorem forwardMessage_singleton
  ...
  simp [forwardMessage, Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiHard.wordProb, Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiHard.wordProbNN,
    Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiHard.wordProbAux, observationWeight]
            ...
            wordProb (k := latent) θ.latentParam
              ...
              ∑ xs : Fin n → Fin latent,
                ...
                have hlast : (List.ofFn xs ++ [u]).getLast (by simp) = u := by
                  simp
                rw [Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiSequenceKernel.wordProb_append_singleton_of_ne_nil
...
theorem wordProbAux_append_terminal
  ...
  | [], zs => by
      simp [Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiHard.wordProbAux]
  | b :: xs, zs => by
      simp only [Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiHard.wordProbAux, List.cons_append, ENNReal.coe_mul]
...
theorem wordProb_append_terminal
  ...
  | [], zs => by
      simp [Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiHard.wordProb, Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiHard.wordProbNN,
        Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiHard.wordProbAux]
  | a :: xs, zs => by
      simp only [Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiHard.wordProb, Mettapedia.ProbabilityTheory.Exchangeability.MarkovDeFinettiHard.wordProbNN,
...
end Mettapedia.ProbabilityTheory.HiddenMarkovModels.FiniteHiddenMarkovObservedInference
