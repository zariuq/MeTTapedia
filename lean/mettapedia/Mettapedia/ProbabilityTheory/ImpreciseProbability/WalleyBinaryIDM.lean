...
namespace Mettapedia.ProbabilityTheory.ImpreciseProbability.WalleyBinaryIDM
...
theorem lowerProb_credalSetOfEvidence_eq_itv_lower
    ...
    lowerProb (credalSetOfEvidence e s hs) trueGamble =
      (Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV.fromWalleyIDMPredictive e s hs).lower := by
  unfold credalSetOfEvidence
  rw [lowerProb_trueGamble_eq]
  rw [Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV.fromWalleyIDMPredictive_lower]
  rfl

theorem upperProb_credalSetOfEvidence_eq_itv_upper
    (e : BinaryEvidence) (s : ℝ) (hs : 0 < s) :
    upperProb (credalSetOfEvidence e s hs) trueGamble =
      (Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV.fromWalleyIDMPredictive e s hs).upper := by
  unfold credalSetOfEvidence
  rw [upperProb_trueGamble_eq]
  rw [Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV.fromWalleyIDMPredictive_upper]
  rfl
...
theorem credal_envelope_matches_Walley_ITV_bounds
    (e : BinaryEvidence) (s : ℝ) (hs : 0 < s) :
    lowerProb (credalSetOfEvidence e s hs) trueGamble =
        (Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV.fromWalleyIDMPredictive e s hs).lower ∧
      upperProb (credalSetOfEvidence e s hs) trueGamble =
        (Mettapedia.PLN.TruthValues.PLNIndefiniteTruth.ITV.fromWalleyIDMPredictive e s hs).upper :=
  ⟨lowerProb_credalSetOfEvidence_eq_itv_lower e s hs,
    upperProb_credalSetOfEvidence_eq_itv_upper e s hs⟩

end Mettapedia.ProbabilityTheory.ImpreciseProbability.WalleyBinaryIDM
