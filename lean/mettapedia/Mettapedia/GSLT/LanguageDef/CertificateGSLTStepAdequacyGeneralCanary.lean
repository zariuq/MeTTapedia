...
namespace Mettapedia.GSLT.LanguageDef.CertificateGSLT.StepAdequacyGeneralCanary
...
private def pairLanguage : LanguageDef :=
  { name := "certificate-gslt-general-adequacy-canary"
    types := [genType]
...
private def orphanLanguage : LanguageDef :=
  { name := "certificate-gslt-general-adequacy-orphan"
    types := [genType]
    terms := [genUnit, genThunk, genPair]
    equations := []
    rewrites := [orphanRule] }
...
private def substLanguage : LanguageDef :=
  { name := "certificate-gslt-general-adequacy-subst"
    types := [genType]
    terms := [genUnit, genThunk, genPair]
    equations := []
    rewrites := [substRule] }
...
private def bagLanguage : LanguageDef :=
  { name := "certificate-gslt-general-adequacy-bag"
    types := [genType]
    terms := [genUnit, genThunk, genPair]
    equations := []
    rewrites := [bagRule] }
...
private def queryLanguage : LanguageDef :=
  { name := "certificate-gslt-general-adequacy-query"
    types := [genType]
    terms := [genUnit, genThunk, genPair]
    equations := []
    rewrites := [queryRule] }
