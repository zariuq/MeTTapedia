  ...
  theorem HasType.ReflectiveSupportSafeAt.availableEquationSetoid_substitute_pointwise
    ...
    | @bvar bound index type lookup available binderImage =>
        have endpoints : sourceTerm.substitute first sourceSafe =
          ...
          apply AvailableOpenPattern.ext
          simp [sourceTerm, AvailableOpenPattern.substitute, AvailableOpenPattern.ofCertificates,
    ...
    | @fvar bound name type lookup available binderImage shape =>
        ...
        have leftEndpoint : sourceTerm.substitute first sourceSafe =
          ...
          apply AvailableOpenPattern.ext
          simp only [sourceTerm, AvailableOpenPattern.substitute,
            AvailableOpenPattern.ofCertificates,
    ...
    | @constructorQuote bound rule arguments membership notBare argumentsTyped
        ...
        have leftEndpoint :
          ...
          apply AvailableOpenPattern.ext
          simp [argumentsTerm, sourceTerm, AvailableOpenPattern.substitute,
            AvailableOpenPattern.ofCertificates,
    ...
    | @lambda bound binder body domain codomain bodyTyped available binderImage
        ...
        have leftEndpoint :
          ...
          apply AvailableOpenPattern.ext
          simp [bodyTerm, sourceTerm, AvailableOpenPattern.substitute, AvailableOpenPattern.ofCertificates,
                AvailableOpenArgument.substitute, AvailableOpenArguments.substitute,
                AvailableOpenElements.substitute, ReflectiveContextSupport.substituteAt]
        have rightEndpoint :
    ...
    | @collection bound collectionType elements rest elementType elementsTyped
        ...
        | none =>
            ...
            have leftEndpoint :
              ...
              apply AvailableOpenPattern.ext
              simp [elementsTerm, sourceTerm, AvailableOpenPattern.substitute, AvailableOpenPattern.ofCertificates,
                AvailableOpenArgument.substitute, AvailableOpenArguments.substitute,
                AvailableOpenElements.substitute,
                ReflectiveContextSupport.substituteAt]
            have rightEndpoint :
                ...
                | @lambda bound binder body domain codomain bodyTyped
                    available binderImage bodySafe =>
                      ...
                      have leftEndpoint :
                        ...
                        apply AvailableOpenArgument.ext
                        simp [pack, sourceArgument, bodyTerm, AvailableOpenPattern.substitute, AvailableOpenPattern.ofCertificates,
                AvailableOpenArgument.substitute, AvailableOpenArguments.substitute,
                AvailableOpenElements.substitute,
                          ReflectiveContextSupport.substituteAt]
                      have rightEndpoint :
    ...
    | @cons bound argument arguments parameter parameters expected
        ...
        have leftEndpoint :
          ...
          simp [leftHead, sourceArgument, argumentTerm, tailTerm, sourceSpine,
            AvailableOpenPattern.substitute, AvailableOpenPattern.ofCertificates, AvailableOpenArgument.substitute, AvailableOpenArguments.substitute, AvailableOpenArguments.ofCertificates, AvailableOpenElements.substitute, AvailableOpenElements.ofCertificates]
        have rightEndpoint :
