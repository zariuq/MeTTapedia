...
namespace Mettapedia.GSLT.LanguageDef.ProofGSLT.ConstructibleDualityCanary
...
private def evidenceCore : LanguageDef :=
  { name := "proof-gslt-evidence-database"
    types := [evidenceType]
...
end Mettapedia.GSLT.LanguageDef.ProofGSLT.ConstructibleDualityCanary
