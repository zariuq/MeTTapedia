import Mettapedia.GSLT.LanguageDef.ProofGSLTOpen

/-!
# Derivation-valued interpretations of proof GSLTs
...
module defines the first non-thin category of proof GSLTs.  Its arrows preserve
