...
/-!
# Affine feature linkage for certificate-GSLT components
...
rule-table joins and proof-theory interpretations: not every CertificateGSLT has an
affine interface.
...
namespace Mettapedia.GSLT.LanguageDef.CertificateGSLT.FeatureLinkage
...
end Mettapedia.GSLT.LanguageDef.CertificateGSLT.FeatureLinkage
