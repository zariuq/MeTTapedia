...
namespace Mettapedia.GSLT.LanguageDef.CertificateGSLT.StepPresentationCanary
...
private def truthPresentation : Presentation :=
  { language := LanguageDef.empty "certificate-gslt-truth-fixture"
    calculus :=
...
end Mettapedia.GSLT.LanguageDef.CertificateGSLT.StepPresentationCanary
