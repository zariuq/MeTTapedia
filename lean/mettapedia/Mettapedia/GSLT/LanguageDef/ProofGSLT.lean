...
A proof GSLT begins with a validated finite proof-theoretic presentation.  Its
...
/-- The exact authored calculus-GSLT document underlying a proof-GSLT object.
...
/-- Proof-GSLT derivability is reachability in the GSLT derived from the
...
/-- The rule-retaining view supports the first honest category of proof GSLTs.
...
abbrev presentation (object : RuleRetaining) : ValidatedPresentation :=
  object.toProofGSLT.presentation

/-- A strict proof-GSLT arrow retains every source rule lookup exactly.
...
/-- Transport a Type-valued derivation along a strict proof-GSLT arrow. -/
...
/-- Strict proof-GSLT arrows preserve the meaning of every accepted DAG.
