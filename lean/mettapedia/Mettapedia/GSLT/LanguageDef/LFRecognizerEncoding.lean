...
theorem shift_rule_count : shiftRules.length = 12 := by rfl

theorem ctxidx_rule_count : ctxidxRules.length = 5 := by rfl

theorem resolve_rule_count : resolveRules.length = 8 := by rfl

theorem parser_rule_count : parserRules.length = 45 := by rfl
