...
namespace Mettapedia.GSLT.LanguageDef.ProofGSLT.StepAdequacy
...
private def stepLanguage : LanguageDef :=
  { name := "proof-gslt-step-adequacy-fixture"
    types := [genType]
...
end Mettapedia.GSLT.LanguageDef.ProofGSLT.StepAdequacy
