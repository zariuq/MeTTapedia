...
namespace Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSpec
...
theorem SignatureWellFormedPrefix.convDecl_prefix_restrict_of_church_rosser
    ...
    (hSig : SignatureWellFormedPrefix (pre ++ post))
    (hCR :
      Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.DeclChurchRosser
        (envOfSpecs (pre ++ post)))
    {t u : PureTm n}
...
theorem DeclSpecObligations.redDecl_step_preserves_type_of_injective
  ...
  exact Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.redDecl_step_preserves_type_of_injective
    (E := envOfSpecs specs)
...
theorem DeclSpecObligations.redStarDecl_preserves_type_of_injective
  ...
  exact Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.redStarDecl_preserves_type_of_injective
    (E := envOfSpecs specs)
    (piInjective := piInjective)
    (sigmaInjective := sigmaInjective)
    (hWf := envOfSpecs_wellFormed_of_specObligations specs hObligations)
...
theorem DeclSpecObligations.redDecl_step_preserves_type_of_all_none
    ...
    (hr : RedDecl (envOfSpecs specs) t t') :
    HasTypeDecl (envOfSpecs specs) Γ t' A := by
  exact Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.redDecl_step_preserves_type_of_no_values
    (E := envOfSpecs specs)
...
theorem DeclSpecObligations.redStarDecl_preserves_type_of_all_none
    ...
    (hs : RedStarDecl (envOfSpecs specs) t u) :
    HasTypeDecl (envOfSpecs specs) Γ u A := by
  exact Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.redStarDecl_preserves_type_of_no_values
    (E := envOfSpecs specs)
    (hNone := valueOf_envOfSpecs_eq_none_of_all_none specs hNone)
    (hWf := envOfSpecs_wellFormed_of_specObligations specs hObligations)
    (ht := ht)
...
theorem DeclSpecObligations.redStarDecl_confluence_of_all_none
  ...
  exact Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.redStarDecl_confluence_of_no_values
    (E := envOfSpecs specs)
    (hNone := valueOf_envOfSpecs_eq_none_of_all_none specs hNone)
    h₁ h₂
...
theorem DeclSpecObligations.church_rosser_convDecl_of_all_none
    ...
    ∃ u,
      ...
      RedStarDecl (envOfSpecs specs) t u := by
  exact Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.church_rosser_convDecl_of_no_values
    (E := envOfSpecs specs)
    (hNone := valueOf_envOfSpecs_eq_none_of_all_none specs hNone)
    h
...
theorem DeclSpecObligations.pi_injectivity_decl_of_all_none
  ...
  exact Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.pi_injectivity_decl_of_no_values
    (E := envOfSpecs specs)
    (hNone := valueOf_envOfSpecs_eq_none_of_all_none specs hNone)
    h
...
theorem DeclSpecObligations.sigma_injectivity_decl_of_all_none
    ...
    ConvDecl (envOfSpecs specs) A A' ∧ ConvDecl (envOfSpecs specs) B B' := by
  exact Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.sigma_injectivity_decl_of_no_values
    (E := envOfSpecs specs)
    (hNone := valueOf_envOfSpecs_eq_none_of_all_none specs hNone)
    h
...
theorem DeclSpecObligations.redDecl_step_preserves_type_of_church_rosser
    ...
    HasTypeDecl (envOfSpecs specs) Γ t' A := by
  exact
    Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.redDecl_step_preserves_type_of_church_rosser
      (E := envOfSpecs specs)
      (hCR := hCR)
      (hWf := envOfSpecs_wellFormed_of_specObligations specs hObligations)
      (ht := ht)
...
theorem DeclSpecObligations.redStarDecl_preserves_type_of_church_rosser
    ...
    HasTypeDecl (envOfSpecs specs) Γ u A := by
  exact
    Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.redStarDecl_preserves_type_of_church_rosser
      (E := envOfSpecs specs)
      (hCR := hCR)
      (hWf := envOfSpecs_wellFormed_of_specObligations specs hObligations)
      (ht := ht)
...
theorem DeclSpecObligations.redStarDecl_confluence_of_church_rosser
    ...
    ∃ u,
      ...
      RedStarDecl (envOfSpecs specs) t₂ u := by
  exact
    Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.redStarDecl_confluence_of_church_rosser
      (E := envOfSpecs specs)
      hCR h₁ h₂
...
theorem DeclSpecObligations.decl_sound_confluent_and_injectivity_of_church_rosser
  ...
  exact Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.decl_sound_confluent_and_injectivity_of_church_rosser
      (E := envOfSpecs specs)
      hCR
...
theorem DeclSpecObligations.declSpecChurchRosserPackage_of_church_rosser
  ...
  · intro n A A' B B' hConv
    exact
      Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.pi_injectivity_decl_of_church_rosser
        (E := envOfSpecs specs)
        hCR hConv
  · intro n A A' B B' hConv
    exact
      Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.sigma_injectivity_decl_of_church_rosser
        (E := envOfSpecs specs)
        hCR hConv
...
def defEqByNormalizationDeclOfAllNone?
  ...
  Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.defEqByNormalizationDeclOfNoValues?
    (E := envOfSpecs specs)
    (hNone := valueOf_envOfSpecs_eq_none_of_all_none specs hNone)
    A B
...
def SignatureWellFormed.defEqByNormalizationDeclOfAllNone?
    ...
    (A B : PureTm n) :
    Option (DefEqDeclWitness (envOfSpecs specs) A B) :=
  Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSpec.defEqByNormalizationDeclOfAllNone?
...
theorem DeclSpecObligations.defEqByNormalizationDeclOfAllNone?_sound
  ...
  simpa [defEqByNormalizationDeclOfAllNone?] using
    Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.defEqByNormalizationDeclOfNoValues?_sound
      (E := envOfSpecs specs)
      (hNone := valueOf_envOfSpecs_eq_none_of_all_none specs hNone)
      (w := w)
      h
...
theorem DeclSpecObligations.defEqByNormalizationDeclOfAllNone?_ne_none_implies_conv
    ...
    ConvDecl (envOfSpecs specs) A B := by
  simpa [defEqByNormalizationDeclOfAllNone?] using
    Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.defEqByNormalizationDeclOfNoValues?_ne_none_implies_conv
      (E := envOfSpecs specs)
      (hNone := valueOf_envOfSpecs_eq_none_of_all_none specs hNone)
      h
...
theorem DeclSpecObligations.defEqByNormalizationDeclOfAllNone_not_complete
  ...
  simpa [defEqByNormalizationDeclOfAllNone?] using
    Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.defEqByNormalizationDeclOfNoValues_not_complete
      (E := envOfSpecs specs)
      (hNone := valueOf_envOfSpecs_eq_none_of_all_none specs hNone)
...
theorem DeclSpecObligations.decl_sound_confluent_and_conversion_of_all_none
    ...
    (∀ {A B : PureTm n},
      ...
      ConvDecl (envOfSpecs specs) A B) := by
  rcases
      Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics.decl_sound_confluent_and_conversion_of_no_values
        (E := envOfSpecs specs)
        (hNone := valueOf_envOfSpecs_eq_none_of_all_none specs hNone)
        (hWf := envOfSpecs_wellFormed_of_specObligations specs hObligations)
...
end Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSpec
