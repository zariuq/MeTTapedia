...
namespace Mettapedia.Languages.MeTTa.Pure.Intrinsic.Assembly
...
def mettaIntrinsicPureTyped : TypedKernelDef where
  hasType := @HasType
  reduces := @Red
...
theorem mettaIntrinsicPure_subject_reduction
    {n : Nat} {Γ : Ctx n} {t t' A : PureTm n}
    (ht : mettaIntrinsicPureTyped.hasType Γ t A)
    (hr : mettaIntrinsicPureTyped.reduces t t') :
    mettaIntrinsicPureTyped.hasType Γ t' A :=
  mettaIntrinsicPureTyped.subject_reduction ht hr
...
end Mettapedia.Languages.MeTTa.Pure.Intrinsic.Assembly
