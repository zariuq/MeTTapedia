...
namespace Mettapedia.Languages.MeTTa.Pure.Intrinsic.PresentationTypingBridge
...
theorem quotePureCtx_snoc_next
  ...
  have hnext : QuoteCompat ν (k + 1) ρ :=
    Mettapedia.Languages.MeTTa.Pure.Intrinsic.PresentationBoundary.QuoteCompat.mono
      hcompat (by omega)
...
theorem untypedBetaType_quotes
    ...
    quoteTmWith ν 0 emptyEnv
      Mettapedia.Languages.MeTTa.Pure.Intrinsic.PresentationBoundary.untypedBetaType =
        mkApp (mkLam u1) u0 := by
  simp [Mettapedia.Languages.MeTTa.Pure.Intrinsic.PresentationBoundary.untypedBetaType,
...
theorem authored_pattern_does_not_reflect_regular
    ...
    PureHasType [] u0 (quoteTmWith ν 0 emptyEnv
      ...
      ¬ RegularHasType (.nil : Ctx 0) .u0
        Mettapedia.Languages.MeTTa.Pure.Intrinsic.PresentationBoundary.untypedBetaType := by
  rw [untypedBetaType_quotes]
  exact ⟨pattern_accepts_conversion_to_unformed_type,
    Mettapedia.Languages.MeTTa.Pure.Intrinsic.PresentationBoundary.regular_rejects_conversion_to_unformed_type⟩

end Mettapedia.Languages.MeTTa.Pure.Intrinsic.PresentationTypingBridge
