...
namespace Mettapedia.Languages.MeTTa.Pure.Intrinsic
...
def holToPurePhase1TouchSet : List String :=
  ...
  , "Mettapedia/Languages/MeTTa/Pure/Intrinsic/Syntax.lean"
  , "Mettapedia/Languages/MeTTa/Pure/Intrinsic/DeclarationEnv.lean"
  , "Mettapedia/Languages/MeTTa/Pure/Intrinsic/DeclarationSemantics.lean"
...
def holToPureIntegrationContract : HOLToPureIntegrationContract :=
  { sourceLayer := "Mettapedia.Logic.HOL"
    targetKernelLayer := "Mettapedia.Languages.MeTTa.Pure.Intrinsic.DeclarationSemantics"
...
end Mettapedia.Languages.MeTTa.Pure.Intrinsic
