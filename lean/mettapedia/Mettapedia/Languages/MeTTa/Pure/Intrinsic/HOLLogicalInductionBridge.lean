...
import Mettapedia.Languages.MeTTa.Pure.Intrinsic.HOLToPureIntegrationContract
...
namespace Mettapedia.Languages.MeTTa.Pure.Intrinsic.HOLLogicalInductionBridge
...
theorem pure_phase1_closedSyntax_open :
    Mettapedia.Languages.MeTTa.Pure.Intrinsic.holToPureGateStatus
      .closedSyntaxTranslation = true :=
  Mettapedia.Languages.MeTTa.Pure.Intrinsic.holToPure_closedSyntax_open

theorem pure_phase1_declTyped_open :
    Mettapedia.Languages.MeTTa.Pure.Intrinsic.holToPureGateStatus
      .declarationTypedTranslation = true :=
  Mettapedia.Languages.MeTTa.Pure.Intrinsic.holToPure_declTyped_open

theorem pure_phase2_theoremTransport_not_open :
    Mettapedia.Languages.MeTTa.Pure.Intrinsic.holToPureGateStatus
      .closedTheoremTransport = false :=
  Mettapedia.Languages.MeTTa.Pure.Intrinsic.holToPure_closedTheorem_not_open

end Mettapedia.Languages.MeTTa.Pure.Intrinsic.HOLLogicalInductionBridge
