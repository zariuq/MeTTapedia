...
theorem normalForms_eq_of_conv
    ...
    (conversion : Mettapedia.Languages.MeTTa.Pure.Intrinsic.Typing.Conv left right) :
    leftNormal = rightNormal := by
  have normalConversion :
      Mettapedia.Languages.MeTTa.Pure.Intrinsic.Typing.Conv leftNormal rightNormal :=
