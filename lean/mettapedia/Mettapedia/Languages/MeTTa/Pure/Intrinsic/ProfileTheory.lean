...
/-!
# IntrinsicPure Profile-Theory Layer (C1)
...
namespace Mettapedia.Languages.MeTTa.Pure.Intrinsic.ProfileTheory
...
end Mettapedia.Languages.MeTTa.Pure.Intrinsic.ProfileTheory
