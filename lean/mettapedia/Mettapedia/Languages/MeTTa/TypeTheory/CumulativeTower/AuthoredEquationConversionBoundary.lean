...
/-!
# Authored equation facts do not counterfeit typed computation
...
The paired result below is the design boundary.  Authored facts are genuinely
...
namespace AuthoredEquationConversionBoundary
...
open AuthoredEquationStructuralAdmission
...
theorem generated_equation_oslf
  ...
  exact AuthoredFactsOSLFSemantics.Equation.generated_member_oslf
...
theorem beta_not_derivable_after_authored_equations (source : SourceDocument) :
    ¬ Nonempty
...
theorem beta_not_oslf_after_authored_equations (source : SourceDocument) :
    ¬ (gsltOSLF
  ...
  exact beta_not_derivable_after_authored_equations source
...
theorem intrinsic_beta_strict_after_authored_equations
  ...
  ⟨⟨betaIntrinsic⟩, beta_not_oslf_after_authored_equations source⟩

#print axioms generated_equation_oslf
#print axioms beta_not_derivable_after_authored_equations
#print axioms beta_not_oslf_after_authored_equations
#print axioms intrinsic_beta_strict_after_authored_equations

end AuthoredEquationConversionBoundary
