import Mettapedia.Languages.MeTTa.TypeTheory.CumulativeTower.IntrinsicMILNativeListSearch
...
def encodeAuthoredList : List Pattern → Pattern
  | [] => MILCheckedNativeListPrograms.nil
  | head :: tail => MILCheckedNativeListPrograms.cons head
