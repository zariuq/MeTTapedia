...
private theorem old_liftRen_eq (rnm : Ren n m) :
    Mettapedia.Languages.MeTTa.Pure.Intrinsic.Renaming.liftRen rnm =
      liftRen rnm := by
  funext index
...
@[simp] theorem erase_rename (rnm : Ren n m) (term : Tower.Tm n) :
  ...
  | fst pair ihPair =>
      simp only [Presentation.rename, erase,
        Mettapedia.Languages.MeTTa.Pure.Intrinsic.Renaming.rename, ihPair]
  | snd pair ihPair =>
      simp only [Presentation.rename, erase,
        Mettapedia.Languages.MeTTa.Pure.Intrinsic.Renaming.rename, ihPair]
  | refl term ihTerm =>
      simp only [Presentation.rename, erase,
        Mettapedia.Languages.MeTTa.Pure.Intrinsic.Renaming.rename, ihTerm]
...
@[simp] theorem erase_subst (sigma : Sub Tower.Head n m)
  ...
  | fst pair ihPair =>
      simp only [Presentation.subst, erase,
        Mettapedia.Languages.MeTTa.Pure.Intrinsic.Substitution.subst, ihPair]
  | snd pair ihPair =>
      simp only [Presentation.subst, erase,
        Mettapedia.Languages.MeTTa.Pure.Intrinsic.Substitution.subst, ihPair]
  | refl term ihTerm =>
      simp only [Presentation.subst, erase,
        Mettapedia.Languages.MeTTa.Pure.Intrinsic.Substitution.subst, ihTerm]
...
theorem conv_erases {left right : Tower.Tm n}
  ...
  | rel left right step =>
      exact Mettapedia.Languages.MeTTa.Pure.Intrinsic.Confluence.redStar_implies_conv
        (step_erases step)
...
theorem not_conv_pi_sigma (piDomain : Tower.Tm n)
  ...
  rcases Mettapedia.Languages.MeTTa.Pure.Intrinsic.Confluence.redStar_sigma_head
...
theorem pure_id_components_of_conv
    {carrier left right carrier' left' right' : Syntax.PureTm n}
    (conversion : Mettapedia.Languages.MeTTa.Pure.Intrinsic.Typing.Conv
      (.id carrier left right) (.id carrier' left' right')) :
    Mettapedia.Languages.MeTTa.Pure.Intrinsic.Typing.Conv carrier carrier' ∧
      Mettapedia.Languages.MeTTa.Pure.Intrinsic.Typing.Conv left left' ∧
      Mettapedia.Languages.MeTTa.Pure.Intrinsic.Typing.Conv right right' := by
  rcases Mettapedia.Languages.MeTTa.Pure.Intrinsic.Confluence.church_rosser_conv
  ...
  exact ⟨
    Relation.EqvGen.trans _ _ _
      (Mettapedia.Languages.MeTTa.Pure.Intrinsic.Confluence.redStar_implies_conv
        carrierFirst)
