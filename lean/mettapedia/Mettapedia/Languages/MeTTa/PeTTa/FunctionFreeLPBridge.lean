...
namespace Mettapedia.Languages.MeTTa.PeTTa.FunctionFreeLPBridge
...
private theorem ground_match_joint (n : Nat) :
  ...
  | zero =>
    ...
    · intro pats hle hpats
      cases pats with
      | nil => simp [matchArgs]
      | cons _ _ => exact absurd hle (by simp_wf)
...
end Mettapedia.Languages.MeTTa.PeTTa.FunctionFreeLPBridge
