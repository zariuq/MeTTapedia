...
structure CheckedIngress
    ...
    (waist : CheckedNativeWaist.{uGoal, uEvidence, uArtifact} definition)
...
variable {waist : CheckedNativeWaist.{uGoal, uEvidence, uArtifact} definition}
...
open Mettapedia.Languages.MeTTa.TypeTheory.CumulativeTower.MILLearnedProofRelevantAdmission
