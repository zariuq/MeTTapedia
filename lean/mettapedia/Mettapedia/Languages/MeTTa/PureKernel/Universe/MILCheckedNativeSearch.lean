...
open MILCheckedNativePresentation
...
theorem wrong_middle_has_no_native_search_plan :
  ...
  rintro ⟨plan⟩
  exact MILCheckedNativePresentation.concrete_wrong_middle_has_no_native_program
    ⟨plan.checked⟩
