...
def arrow (domain codomain : PureTm n) : PureTm n :=
  .pi domain
    (Mettapedia.Languages.MeTTa.PureKernel.Renaming.rename
      Mettapedia.Languages.MeTTa.PureKernel.Renaming.wk codomain)
...
@[simp] theorem rename_arrow
    (rnm : Mettapedia.Languages.MeTTa.PureKernel.Renaming.Ren n m)
    (domain codomain : PureTm n) :
    Mettapedia.Languages.MeTTa.PureKernel.Renaming.rename rnm
        (arrow domain codomain) =
      arrow
        (Mettapedia.Languages.MeTTa.PureKernel.Renaming.rename rnm domain)
        (Mettapedia.Languages.MeTTa.PureKernel.Renaming.rename rnm codomain) := by
  simp [arrow, Mettapedia.Languages.MeTTa.PureKernel.Renaming.rename,
    Mettapedia.Languages.MeTTa.PureKernel.Renaming.rename_comp]
  apply Mettapedia.Languages.MeTTa.PureKernel.Renaming.rename_ext
  intro index
  rfl
  ...
  · apply RegularHasType.lam_intro
    ...
    · have application :
        ...
        · simpa [arrow, Context.lookup,
            Mettapedia.Languages.MeTTa.PureKernel.Renaming.rename] using
        ...
        · have variableTyping :=
          ...
          simpa [Mettapedia.Languages.MeTTa.PureKernel.Renaming.rename] using
            variableTyping
        · exact .u0_type _
      simpa [Mettapedia.Languages.MeTTa.PureKernel.Substitution.inst0,
        Mettapedia.Languages.MeTTa.PureKernel.Substitution.subst] using
        application
...
theorem selfApplication_not_hasType :
  ...
  have innerDomainWeakened :
      Mettapedia.Languages.MeTTa.PureKernel.Typing.Conv
        (Mettapedia.Languages.MeTTa.PureKernel.Renaming.rename
          Mettapedia.Languages.MeTTa.PureKernel.Renaming.wk innerDomain)
        (arrow .u0 .u0) := by
    simpa [Mettapedia.Languages.MeTTa.PureKernel.Renaming.rename] using
      Mettapedia.Languages.MeTTa.PureKernel.Typing.conv_rename
        Mettapedia.Languages.MeTTa.PureKernel.Renaming.wk innerParts.1
