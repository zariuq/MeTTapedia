...
This module closes one exact-image part of the Prime hosted-presentation seam.
...
the learned presentation.  It is not a special grandparent evaluator, and it
...
namespace MILCheckedNativePresentation
...
presentation.  Checking, interpretation, and native construction remain three
separate fields. -/
...
end MILCheckedNativePresentation
