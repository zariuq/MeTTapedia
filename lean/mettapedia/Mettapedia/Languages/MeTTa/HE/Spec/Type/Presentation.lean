...
/-!
# Presentation-preserving spec type substitutions
...
namespace Mettapedia.Languages.MeTTa.HE.Spec.Type.Presentation
...
end Mettapedia.Languages.MeTTa.HE.Spec.Type.Presentation
