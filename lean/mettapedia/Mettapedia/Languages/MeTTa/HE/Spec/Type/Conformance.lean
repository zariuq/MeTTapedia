...
/-!
# specification type-boundary conformance

This downstream module relates the executable-independent spec type and
...
namespace Mettapedia.Languages.MeTTa.HE.Spec.Type.Conformance
...
end Mettapedia.Languages.MeTTa.HE.Spec.Type.Conformance
