import Mettapedia.Languages.Prolog.Core
import Mettapedia.Languages.Prolog.Eval
import Mettapedia.Languages.Prolog.RuntimeErrorSpec
import Mettapedia.Languages.Prolog.FixtureCorpus
...
Mettapedia.Logic.LP           ← pure Horn clauses, SLD resolution (existing)
  ↑ extended by
Mettapedia.Languages.Prolog       ← Prolog built-ins + operational semantics (this module)
  ↑ instantiated by
