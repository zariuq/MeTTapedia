import Mettapedia.Languages.ProcessCalculi.RhoCalculus.Costed.RuntimeProperties
...
theorem runtimeCostFrontier_wellWrapped
  ...
  · change some (deduplicatePublicTransitions
    ...
    exact runtimeCostCandidatesFromConfig_wellWrapped
      (RawCostTerm.normalizeConfig_forall_wellFormed term_ok) candidate_member
  · simp at result
...
theorem no_free_redex (name : RawCostName)
  ...
  simp [runtimeCostFrontier, runtimeCostCandidates, supported,
