import Mettapedia.Languages.ProcessCalculi.RhoCalculus.Costed.Conservation
import Mettapedia.Languages.ProcessCalculi.RhoCalculus.Costed.Located
import Mettapedia.Languages.ProcessCalculi.RhoCalculus.Costed.Normalization
...
theorem runtimeCostFrontier_sound
  ...
  exact costStep_sound_runtime (RawCostTerm.normalizeConfig_canonical term)
    (RawCostTerm.normalizeConfig_forall_wellFormed supported) candidate
