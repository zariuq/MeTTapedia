import Mettapedia.Languages.ProcessCalculi.RhoCalculus.Costed.ScopedErasure
...
/-- Initialization plus step preservation covers the complete target of a
declarative path. -/
theorem preserves_binderSafe
  ...
  | fire step rest induction =>
      exact induction (step.preserves_binderSafe sourceSafe)
