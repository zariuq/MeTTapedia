...
/-- A well-formed source term starts with empty provenance and its budgeted
...
/-- Public well-formed sources satisfy whole-prefix path refinement. -/
...
private theorem refinementExampleTerm_supported :
    refinementExampleTerm.wellFormed = true := by decide
