...
/-!
# Bridge Algebra Interface Refinement
...
design boundary explicitly so the runtime, CeTTa interface, and Lean story all
...
namespace BridgeAlgebraInterfaceRefinement
...
/-- Frozen structural carrier used by the read-side bridge interface. -/
...
end BridgeAlgebraInterfaceRefinement
