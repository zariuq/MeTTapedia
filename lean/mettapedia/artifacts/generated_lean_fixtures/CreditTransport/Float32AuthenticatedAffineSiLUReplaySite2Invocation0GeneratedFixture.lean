...
namespace GeneratedAuthenticatedAffineSiLUReplaySite2Invocation0Fixture
...
-- Affine sidecar SHA-256: 6b62357c704c2ee8a079577f93ad9baf72b647c73db6cc36e47e378174234de4
-- The imported affine theorem checks arithmetic; endpoint hashes bind it to the trace.
-- Source invocation indices: 0
-- Hidden affine-SiLU site: 2 (error_dependent_hidden_transition)
...
def replay0 : Float32AffineSiLUReplay 64 64 where
  affine := GeneratedAuthenticatedAffineReplaySite2Invocation0Fixture.replay0
  ...
  radius := ((28157778940417913583 : ℚ) / 18446744073709551616)

theorem replay0_is_accepted : replay0.check = true := by
  refine replay0.check_of_observed_radius_and_affine_budget
    ((6402325 : ℚ) / 4194304) GeneratedAuthenticatedAffineReplaySite2Invocation0Fixture.replay0_is_accepted ?_ ?_ ?_ ?_ ?_ ?_
  · norm_num [replay0]
  · norm_num [replay0, GeneratedAuthenticatedAffineReplaySite2Invocation0Fixture.replay0,
  ...
  · intro row
    fin_cases row
    · norm_num [replay0, GeneratedAuthenticatedAffineReplaySite2Invocation0Fixture.replay0,
        GeneratedAuthenticatedAffineReplaySite2Invocation0Fixture.replay0Output,
        Float32AffineReplay.ofRows]
    · norm_num [replay0, GeneratedAuthenticatedAffineReplaySite2Invocation0Fixture.replay0,
        GeneratedAuthenticatedAffineReplaySite2Invocation0Fixture.replay0Output,
        Float32AffineReplay.ofRows]
...
end GeneratedAuthenticatedAffineSiLUReplaySite2Invocation0Fixture
