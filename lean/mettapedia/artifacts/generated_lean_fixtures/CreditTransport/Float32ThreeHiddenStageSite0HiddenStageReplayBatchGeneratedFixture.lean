...
import Mettapedia.MachineLearning.NeuralNetworks.CreditTransport.Float32ThreeHiddenStageSite0AffineSiLUReplayBatchGeneratedFixture
...
namespace GeneratedThreeHiddenStageSite0HiddenStageReplayBatchFixture
...
-- affine-SiLU batch SHA-256: c43543d3deb21f5392b909055b3a980abe8183ae4adcabcca565f400388be1b2
...
def hiddenReplay0 : Float32HiddenStageReplay 1 1 where
  affineSiLU := GeneratedThreeHiddenStageSite0AffineSiLUReplayBatchFixture.replay0
...
theorem hiddenReplay0_is_accepted : hiddenReplay0.check = true := by
  ...
  refine ⟨(Float32AffineSiLUReplay.check_eq_true_iff
      GeneratedThreeHiddenStageSite0AffineSiLUReplayBatchFixture.replay0).mp
      GeneratedThreeHiddenStageSite0AffineSiLUReplayBatchFixture.replay0_is_accepted, ?_⟩
  intro row
  fin_cases row
...
def hiddenReplay1 : Float32HiddenStageReplay 1 1 where
  affineSiLU := GeneratedThreeHiddenStageSite0AffineSiLUReplayBatchFixture.replay1
...
theorem hiddenReplay1_is_accepted : hiddenReplay1.check = true := by
  ...
  refine ⟨(Float32AffineSiLUReplay.check_eq_true_iff
      GeneratedThreeHiddenStageSite0AffineSiLUReplayBatchFixture.replay1).mp
      GeneratedThreeHiddenStageSite0AffineSiLUReplayBatchFixture.replay1_is_accepted, ?_⟩
  intro row
  fin_cases row
...
end GeneratedThreeHiddenStageSite0HiddenStageReplayBatchFixture
