...
namespace GeneratedThreeHiddenStageSite2AffineSiLUReplayBatchFixture
...
-- Affine sidecar SHA-256: ea39cfbc89e2d4a3e93ef96c9799f3255b23c2cd6798dc8abe31358e1fd62783
...
theorem affineReplay0_is_accepted : affineReplay0.check = true := by
  norm_num [Float32AffineReplay.check, Float32AffineReplay.Valid,
    ...
    affineReplay0, word0, sharedWeight, sharedBias,
...
theorem affineReplay1_is_accepted : affineReplay1.check = true := by
  norm_num [Float32AffineReplay.check, Float32AffineReplay.Valid,
    Float32AffineReplay.totalAbsoluteErrorRat,
    Float32AffineReplay.idealOutputRat,
    affineReplay1, word0, sharedWeight, sharedBias,
    FiniteFloat32Word.toRat, float32Exponent, float32Mantissa,
    rowMajorIndex]
...
end GeneratedThreeHiddenStageSite2AffineSiLUReplayBatchFixture
