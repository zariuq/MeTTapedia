...
import Mettapedia.MachineLearning.NeuralNetworks.CreditTransport.Float32ThreeHiddenStageSite1AffineSiLUReplayBatchGeneratedFixture
...
namespace GeneratedThreeHiddenStageSite1HiddenStageReplayBatchFixture
...
-- affine-SiLU batch SHA-256: 2f3ad1533b91f42eb267228884c4bc1d700f8b455a030731e702090f59992fde
...
def hiddenReplay0 : Float32HiddenStageReplay 1 1 where
  affineSiLU := GeneratedThreeHiddenStageSite1AffineSiLUReplayBatchFixture.replay0
...
theorem hiddenReplay0_is_accepted : hiddenReplay0.check = true := by
  ...
  refine ⟨(Float32AffineSiLUReplay.check_eq_true_iff
      GeneratedThreeHiddenStageSite1AffineSiLUReplayBatchFixture.replay0).mp
      GeneratedThreeHiddenStageSite1AffineSiLUReplayBatchFixture.replay0_is_accepted, ?_⟩
  intro row
  fin_cases row
...
def hiddenReplay1 : Float32HiddenStageReplay 1 1 where
  affineSiLU := GeneratedThreeHiddenStageSite1AffineSiLUReplayBatchFixture.replay1
...
theorem hiddenReplay1_is_accepted : hiddenReplay1.check = true := by
  ...
  refine ⟨(Float32AffineSiLUReplay.check_eq_true_iff
      GeneratedThreeHiddenStageSite1AffineSiLUReplayBatchFixture.replay1).mp
      GeneratedThreeHiddenStageSite1AffineSiLUReplayBatchFixture.replay1_is_accepted, ?_⟩
  intro row
  fin_cases row
...
end GeneratedThreeHiddenStageSite1HiddenStageReplayBatchFixture
