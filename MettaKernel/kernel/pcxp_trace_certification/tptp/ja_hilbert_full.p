...
fof(rule_pm2_61iii, axiom, ! [V_PH, V_PS, V_CH, V_TH] : (((proved(imp(neg(V_PH),imp(neg(V_PS),imp(neg(V_CH),V_TH)))) & proved(imp(V_PH,V_TH)) & proved(imp(V_PS,V_TH)) & proved(imp(V_CH,V_TH))) => proved(V_TH)))).
