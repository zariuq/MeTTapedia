#!/usr/bin/env python3
"""Mutate exactly one rule in the first generated DTT conversion DAG."""
...
def main() -> None:
    ...
    if marker_index < 0:
        raise ValueError("first generated DTT DAG witness marker is absent")
